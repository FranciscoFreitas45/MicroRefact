...
public void setPatient(Patient patient){
 patientrequestimpl.setPatient(patient,this.Long);
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/"+ appointmentId).concat("/setPatient"));
...
public void setSlot(Slot slot){
 slotrequestimpl.setSlot(slot,this.Long);
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/"+ appointmentId).concat("/setSlot"));
