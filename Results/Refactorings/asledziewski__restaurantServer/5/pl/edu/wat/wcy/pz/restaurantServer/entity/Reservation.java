...
public String toString(){
    return "Reservation{" + "reservationId=" + reservationId + ", date=" + date + ", dateDays='" + dateDays + '\'' + ", dateTime='" + dateTime + '\'' + ", rTableId=" + rTableId + ", rTableNumber=" + rTableNumber + ", attendees=" + attendees + ", userId=" + userId + ", status='" + status + '\'' + '}';
}
