...
public void setCertificados(List<Certificado> certificados){
 certificadorequestimpl.setCertificados(certificados,this.pk_id_profesor);
...
public List<Certificado> getCertificados(){
  this.certificados = certificadorequestimpl.getCertificados(this.pk_id_profesor);
...
public List<Inscripcion> getInscripciones(){
  this.inscripciones = inscripcionrequestimpl.getInscripciones(this.pk_id_profesor);
...
public void setInscripciones(List<Inscripcion> inscripciones){
 inscripcionrequestimpl.setInscripciones(inscripciones,this.pk_id_profesor);
