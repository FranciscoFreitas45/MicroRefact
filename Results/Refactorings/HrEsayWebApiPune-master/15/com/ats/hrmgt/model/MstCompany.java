...
public String toString(){
    return "Company [companyId=" + companyId + ", companyName=" + companyName + ", nameSd=" + nameSd + ", logo=" + logo + ", letterHead=" + letterHead + ", reportHeader=" + reportHeader + ", reportFooter=" + reportFooter + ", longAdd1=" + longAdd1 + ", longAdd2=" + longAdd2 + ", longAdd3=" + longAdd3 + ", shortAddress=" + shortAddress + ", landline1=" + landline1 + ", landline2=" + landline2 + ", faxNo=" + faxNo + ", panNo=" + panNo + ", tanNo=" + tanNo + ", isPfApplicable=" + isPfApplicable + ", pfNo=" + pfNo + ", pfGroupCode=" + pfGroupCode + ", pfCoverageDate=" + pfCoverageDate + ", pfSignatory1=" + pfSignatory1 + ", pfSignatory2=" + pfSignatory2 + ", pfSignatory3=" + pfSignatory3 + ", isEsicApplicable=" + isEsicApplicable + ", esicNo=" + esicNo + ", esicCoverageDate=" + esicCoverageDate + ", esicSignatory1=" + esicSignatory1 + ", esicSignatory2=" + esicSignatory2 + ", esicSignatory3=" + esicSignatory3 + ", ptNo=" + ptNo + ", serviceTaxNo=" + serviceTaxNo + ", vatNo=" + vatNo + ", gstNo=" + gstNo + ", cstNo=" + cstNo + ", gstNumber=" + gstNumber + ", isSealingLimitApplicable=" + isSealingLimitApplicable + ", cpName=" + cpName + ", cpDesignation=" + cpDesignation + ", cpMobile=" + cpMobile + ", cmpBankAccount=" + cmpBankAccount + ", cpEmail1=" + cpEmail1 + ", cpEmail2=" + cpEmail2 + ", managerUnderAct=" + managerUnderAct + ", managerAddress=" + managerAddress + ", professionalFees=" + professionalFees + ", isParentCompany=" + isParentCompany + ", delStatus=" + delStatus + ", makerEnterDdatetime=" + makerEnterDdatetime + ", exInt1=" + exInt1 + ", exInt2=" + exInt2 + ", exVar1=" + exVar1 + ", exVar2=" + exVar2 + "]";
}
