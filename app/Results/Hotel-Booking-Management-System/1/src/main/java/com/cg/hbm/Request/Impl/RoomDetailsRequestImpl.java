...
public void setRoomdetails(RoomDetails roomdetails,int room_id){
 restTemplate.put("http://localhost:8088/BookingDetails/{id}/RoomDetails/setRoomdetails",roomdetails,room_id);
 return ;
}


public RoomDetails getRoomdetails(int room_id){
 RoomDetails aux = restTemplate.getForObject("http://localhost:8088/BookingDetails/{id}/RoomDetails/getRoomdetails",RoomDetails.class,room_id);
return aux;
}
