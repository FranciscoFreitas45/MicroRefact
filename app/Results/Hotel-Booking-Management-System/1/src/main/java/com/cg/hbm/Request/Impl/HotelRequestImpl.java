...
public void setHotel(Hotel hotel,int hotel_id){
 restTemplate.put("http://localhost:8084/BookingDetails/{id}/Hotel/setHotel",hotel,hotel_id);
 return ;
}


public Hotel getHotel(int hotel_id){
 Hotel aux = restTemplate.getForObject("http://localhost:8084/BookingDetails/{id}/Hotel/getHotel",Hotel.class,hotel_id);
return aux;
}
