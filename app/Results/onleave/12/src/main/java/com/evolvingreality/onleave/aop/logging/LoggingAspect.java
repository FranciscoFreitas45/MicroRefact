package com.evolvingreality.onleave.aop.logging;
 import com.evolvingreality.onleave.config.Constants;
...
@Pointcut("within(com.evolvingreality.onleave.repository..*) || within(com.evolvingreality.onleave.service..*) || within(com.evolvingreality.onleave.web.rest..*)")
...
public void logAfterThrowing(JoinPoint joinPoint,Throwable e){
    if (env.acceptsProfiles(Constants.SPRING_PROFILE_DEVELOPMENT)) {
        log.error("Exception in {}.{}() with cause = {}", joinPoint.getSignature().getDeclaringTypeName(), joinPoint.getSignature().getName(), e.getCause(), e);
    } else {
