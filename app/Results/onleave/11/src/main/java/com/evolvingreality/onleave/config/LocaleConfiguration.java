package com.evolvingreality.onleave.config;
 import com.evolvingreality.onleave.config.locale.AngularCookieLocaleResolver;
...
@Configuration
public class LocaleConfiguration extends WebMvcConfigurerAdapterimplements EnvironmentAware{
