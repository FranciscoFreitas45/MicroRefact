...
public List<Blog> listRecommendBlogTop(Integer size){
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/listRecommendBlogTop"))
    .queryParam("size",size)
;  List<Blog> aux = restTemplate.getForObject(builder.toUriString(), List<Blog>.class);
