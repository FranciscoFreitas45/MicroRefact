...
@PutMapping
("/deleteInFinal")
public void deleteInFinal(@RequestParam(name = "p") Parade p){
paradeservice.deleteInFinal(p);
}
...
@GetMapping
("/listAcceptedParadeIfSponsor")
public Collection<Parade> listAcceptedParadeIfSponsor(){
  return paradeservice.listAcceptedParadeIfSponsor();
}
