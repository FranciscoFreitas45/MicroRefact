...
public Set<Nakup> getNakup(Long id){
 Set<Nakup> aux = restTemplate.getForObject("http://3/Uzivatel/{id}/Nakup/getNakup",Set<Nakup>.class,id);
return aux;
}


public void setNakup(Set<Nakup> nakup,Long id){
 restTemplate.put("http://3/Uzivatel/{id}/Nakup/setNakup",nakup,id);
 return ;
}
