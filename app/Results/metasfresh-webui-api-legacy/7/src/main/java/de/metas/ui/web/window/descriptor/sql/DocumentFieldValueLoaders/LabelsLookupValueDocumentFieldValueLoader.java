...
import lombok.Value;
@Value
public class LabelsLookupValueDocumentFieldValueLoader implements DocumentFieldValueLoader{
...
@Override
public LookupValuesList retrieveFieldValue(ResultSet rs,boolean isDisplayColumnAvailable,String adLanguage,LookupDescriptor lookupDescriptor){
