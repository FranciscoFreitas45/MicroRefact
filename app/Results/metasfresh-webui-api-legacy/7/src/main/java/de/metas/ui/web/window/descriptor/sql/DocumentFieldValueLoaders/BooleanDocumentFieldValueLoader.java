...
import lombok.Value;
@Value
public class BooleanDocumentFieldValueLoader implements DocumentFieldValueLoader{
...
@Override
public Boolean retrieveFieldValue(ResultSet rs,boolean isDisplayColumnAvailable,String adLanguage,LookupDescriptor lookupDescriptor_NOTUSED){
