...
public LookupValue concat(LookupValue lookupValue1,LookupValue lookupValue2){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/concat"))

.queryParam("lookupValue1",lookupValue1);
.queryParam("lookupValue2",lookupValue2);
