...
public SqlDocumentFieldDataBindingDescriptor castOrNull(DocumentFieldDataBindingDescriptor descriptor){
...
SqlDocumentFieldDataBindingDescriptor aux = restTemplate.getForObject(builder.toUriString(),SqlDocumentFieldDataBindingDescriptor.class);
return aux;
}
...
public boolean isVirtualColumn(){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/isVirtualColumn"))
