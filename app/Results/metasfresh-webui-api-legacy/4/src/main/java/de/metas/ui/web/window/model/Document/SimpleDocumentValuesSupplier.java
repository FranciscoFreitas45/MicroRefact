...
public class SimpleDocumentValuesSupplier implements DocumentValuesSupplier{
...
public String toString(){
    return MoreObjects.toStringHelper(this).add("documentIdSupplier", documentIdSupplier).add("version", version).toString();
}
