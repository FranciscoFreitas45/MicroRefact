...
public T convertToValueClass(Object value,DocumentFieldWidgetType widgetType,Class<T> targetType,LookupValueByIdSupplier lookupDataSource){
...
public Optional<LookupDataSource> createLookupDataSource(){
    return getLookupDescriptor().map(LookupDataSourceFactory.instance::getLookupDataSource);
}
