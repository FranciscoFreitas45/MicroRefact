...
public boolean isSupportZoomInto(){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/isSupportZoomInto"))
...
public boolean isAllowShowPassword(){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/isAllowShowPassword"))
