...
public Hotel getHotel(int hotel_id){
 Hotel aux = restTemplate.getForObject("http://127.0.0.1:8084/RoomDetails/{id}/Hotel/getHotel",Hotel.class,hotel_id);
return aux;
}


public void setHotel(Hotel hotel,int hotel_id){
 restTemplate.put("http://127.0.0.1:8084/RoomDetails/{id}/Hotel/setHotel",hotel,hotel_id);
 return ;
}
