...
@Transactional
public class JformOrderMainServiceImpl extends CommonServiceImplimplements JformOrderMainServiceI{
...
public void updateMain(JformOrderMainEntity jformOrderMain,List<JformOrderCustomerEntity> jformOrderCustomerList,List<JformOrderTicketEntity> jformOrderTicketList){
    ...
    if (jformOrderCustomerList != null) {
        // && jformOrderCustomerList.size() > 0
    ...
    if (jformOrderTicketList != null) {
        // && jformOrderTicketList.size() > 0
        // update-end--Author:XueLin  Date:20171030 for：[#2391] 【功能demo】一对多的效果demo，主子表效果
