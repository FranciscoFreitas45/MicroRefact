...
public Map<String,Object> mapConvert(Map map){
...
public Map<String,Object> convertFKMap(Map<String,Object> fieldMap,Map<String,Object> mainMap,List<Map<String,Object>> fkFieldList){
    if (fkFieldList != null) {
...
@SuppressWarnings("unchecked")
public Map<String,List<Map<String,Object>>> mapConvertMore(Map map,String tableName){
...
@SuppressWarnings("unchecked")
public Map attributeMapFilter(Map map,String[] filterName){
