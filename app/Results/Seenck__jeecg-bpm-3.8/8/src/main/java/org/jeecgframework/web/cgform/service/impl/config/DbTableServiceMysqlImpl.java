...
public String createChangeTableSql(CgFormHeadEntity table){
...
public String createAddColumnSql(CgFormFieldEntity column,CgFormFieldEntity agoColumn){
...
public String updateTableSQL(CgFormHeadEntity cgFormHead,JdbcTemplate jdbcTemplate){
    String sql = "select column_name,data_type,column_comment,numeric_precision,numeric_scale,character_maximum_length," + "is_nullable nullable from information_schema.columns where table_name = ?  and table_schema = ?;";
...
public String createDropColumn(String fieldName){
    return " DROP COLUMN " + fieldName + ",";
}


public String getFieldType(CgFormFieldEntity cloumn){
    String result = "";
...
public String createUpdateColumnSql(CgFormFieldEntity newColumn,CgFormFieldEntity agoColumn){
    return " MODIFY COLUMN " + getColumnPorperty(newColumn, agoColumn, true);
}


public String getColumnPorperty(CgFormFieldEntity column,CgFormFieldEntity agoColumn,boolean isUpdate){
    String result = " " + DbTableUtil.translatorToDbField(column.getFieldName()) + " " + getFieldType(column) + " ";
