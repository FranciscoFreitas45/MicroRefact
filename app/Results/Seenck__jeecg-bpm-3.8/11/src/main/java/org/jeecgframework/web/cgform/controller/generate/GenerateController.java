...
public boolean hasDirs(File dir){
    try {
...
public void dogenerate(CgFormHeadEntity cgFormHead,GenerateEntity generateEntity,CreateFileProperty createFileProperty,HttpServletRequest request,HttpServletResponse response){
    // step.1 准备好智能表单的配置
    ...
    try {
        ...
        if (tableexist) {
            ...
            if (modeEnum != null) {
                ...
                } else // update-begin--Author:zhoujf  Date:20180503 for：TASK #2500 【代码生成器】代码生成器开发一通用模板生成功能
                if ("ext-common".equals(modeEnum.getVersion())) {
...
public void getCgformConfig(CgFormHeadEntity cgFormHead,GenerateEntity generateEntity){
...
public String[] getCgformButtonSql(CgformButtonSqlEntity cbs){
...
public String[] getForeignkeys(List<CgFormFieldEntity> colums){
