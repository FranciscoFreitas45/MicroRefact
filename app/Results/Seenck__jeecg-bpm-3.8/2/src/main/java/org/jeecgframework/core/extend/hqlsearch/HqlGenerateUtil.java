...
public class HqlGenerateUtil {
 ...
 private  String SQL_RULES_COLUMN;


public void installHql(CriteriaQuery cq,Object searchObj,Map<String,String[]> parameterMap){
...
public boolean itIsNotAllEmpty(Object param){
...
public void addRuleToCriteria(TSDataRule tsDataRule,String aliasName,Class propertyType,CriteriaQuery cq){
...
public String invokeFindType(Class clazz,String field_name){
    String type = null;
    Field field;
    try {
...
public boolean getSuperDeclaredField(Class clazz,String fieldName){
...
public String getSql(List<QueryCondition> list,String tab,Class claszz){
...
public Map<String,TSDataRule> getRuleMap(){
    Map<String, TSDataRule> ruleMap = new HashMap<String, TSDataRule>();
    // (List<TSDataRule>) ContextHolderUtils
...
public void installHqlJoinAlias(CriteriaQuery cq,Object searchObj,Map<String,TSDataRule> ruleMap,Map<String,String[]> parameterMap,String alias){
...
public boolean isHaveRuleData(Map<String,TSDataRule> ruleMap,String aliasName){
...
public String invokeFindColumn(Class clazz,String field_name){
    String column = null;
    Field field;
    try {
...
public boolean judgedIsUselessField(String name){
    return "class".equals(name) || "ids".equals(name) || "page".equals(name) || "rows".equals(name) || "sort".equals(name) || "order".equals(name);
}


public CriteriaQuery getDataAuthorConditionHql(CriteriaQuery cq,Object searchObj){
