...
public void setCurPage(Integer curPage){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setCurPage"))
...
public void ge(String keyname,Object keyvalue){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/ge"))
...
public void le(String keyname,Object keyvalue){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/le"))
