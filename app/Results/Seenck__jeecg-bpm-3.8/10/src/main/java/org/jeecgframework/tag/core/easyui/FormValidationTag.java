...
public void submitLoading(StringBuffer sb){
...
public int doEndTag(){
    ...
    try {
        ...
        // update--end--author:zhangjiaqiang Date:20170424 for:修订页面加载数据
        if (dialog) {
            if (callback != null && callback.contains("@Override")) {
                // 复写默认callback
...
public String toString(){
    ...
    builder.append("FormValidationTag [formid=").append(formid).append(", refresh=").append(refresh).append(", callback=").append(callback).append(", beforeSubmit=").append(beforeSubmit).append(", btnsub=").append(btnsub).append(", btnreset=").append(btnreset).append(", layout=").append(layout).append(", usePlugin=").append(usePlugin).append(", dialog=").append(dialog).append(", action=").append(action).append(", tabtitle=").append(tabtitle).append(", tiptype=").append(tiptype).append(", styleClass=").append(styleClass).append(", cssTheme=").append(cssTheme).append(",sysTheme=").append(SysThemesUtil.getSysTheme(ContextHolderUtils.getRequest()).getStyle()).append(",brower_type=").append(ContextHolderUtils.getSession().getAttribute("brower_type")).append("]");
