...
@Transactional
public class TSCompanyPositionServiceImpl extends CommonServiceImplimplements TSCompanyPositionServiceI{


public void doDelBus(TSCompanyPositionEntity t){
// -----------------sql增强 start----------------------------
// -----------------sql增强 end------------------------------
// -----------------java增强 start---------------------------
// -----------------java增强 end-----------------------------
...
public Map<String,Object> populationMap(TSCompanyPositionEntity t){
...
public void doAddBus(TSCompanyPositionEntity t){
// -----------------sql增强 start----------------------------
// -----------------sql增强 end------------------------------
// -----------------java增强 start---------------------------
// -----------------java增强 end-----------------------------
...
public void doUpdateBus(TSCompanyPositionEntity t){
// -----------------sql增强 start----------------------------
// -----------------sql增强 end------------------------------
// -----------------java增强 start---------------------------
// -----------------java增强 end-----------------------------
