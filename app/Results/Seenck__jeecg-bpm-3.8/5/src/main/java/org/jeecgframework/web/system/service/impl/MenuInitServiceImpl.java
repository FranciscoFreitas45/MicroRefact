...
import DTO.TSFunction;
import DTO.TSOperation;
@Service("menuInitService")
@Transactional
public class MenuInitServiceImpl extends CommonServiceImplimplements MenuInitService{

 private  String KEY_SPLIT;

 private  String MENU_TYPE_ID;

 private  String MENU_TYPE_CSS;
...
public void initMenu(){
    ...
    // 菜单map,key为菜单匹配规则的字符串
    Map<String, TSFunction> functionMap = new HashMap<String, TSFunction>();
    // 菜单操作按钮map,key为菜单操作按钮匹配规则的字符串
    Map<String, TSOperation> operationMap = new HashMap<String, TSOperation>();
    // 设置菜单map
