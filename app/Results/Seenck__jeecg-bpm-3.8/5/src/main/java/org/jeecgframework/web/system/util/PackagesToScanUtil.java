...
public class PackagesToScanUtil {
 ...
 private  String SUB_PACKAGE_SCREEN__SUFFIX;

 private  String SUB_PACKAGE_SCREEN__SUFFIX_RE;


public void findAndAddClassesInPackageByFile(String packageName,String[] packArr,String packagePath,boolean recursive,Set<Class<?>> classes){
    // 获取此包的目录 建立一个File
...
public void findAndAddClassesInPackageByJarFile(String packageName,String[] packArr,URL url,String packageDirName,boolean recursive,Set<Class<?>> classes){
    // 如果是jar包文件
    // 定义一个JarFile
