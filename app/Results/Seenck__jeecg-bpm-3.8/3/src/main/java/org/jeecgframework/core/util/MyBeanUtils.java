...
public void copyMap2Bean(Object bean,Map properties,String defaultValue){
...
public void copyBean2Map(Map map,Object bean){
...
public void convert(Object dest,Object orig){
...
public void copyMap2Bean_Nobig(Object bean,Map properties){
    // Do nothing unless both arguments have been specified
    if ((bean == null) || (properties == null)) {
        return;
    }
...
public void copyBean2Bean(Object dest,Object orig){
    convert(dest, orig);
}
