...
import DTO.TSInterfaceEntity;
@Service("tSInterfaceService")
@Transactional
public class TSInterfaceServiceImpl extends CommonServiceImplimplements TSInterfaceServiceI{


public void doDelBus(TSInterfaceEntity t){
// -----------------sql增强 start----------------------------
// -----------------sql增强 end------------------------------
// -----------------java增强 start---------------------------
// -----------------java增强 end-----------------------------
...
public Map<String,Object> populationMap(TSInterfaceEntity t){
...
public void doAddBus(TSInterfaceEntity t){
// -----------------sql增强 start----------------------------
// -----------------sql增强 end------------------------------
// -----------------java增强 start---------------------------
// -----------------java增强 end-----------------------------
...
public void doUpdateBus(TSInterfaceEntity t){
// -----------------sql增强 start----------------------------
// -----------------sql增强 end------------------------------
// -----------------java增强 start---------------------------
// -----------------java增强 end-----------------------------
