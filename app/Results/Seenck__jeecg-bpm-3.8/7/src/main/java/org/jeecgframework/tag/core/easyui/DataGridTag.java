    ...
    for (DataGridColumn column : columnList) {
        ...
        if ((column.isFrozenColumn() && frozen == 0) || (!column.isFrozenColumn() && frozen == 1)) {
            ...
            if (StringUtils.isNotEmpty(column.getExtendParams())) {
                ...
                // 声明一个替换扩展参数中的editor:'combobox'的变量
            ...
            // update-end--Author:chenjin  Date:20160811 for：TASK #1259 【论坛bug】论坛bug确认是否存在问题，存在进行处理,行编辑模式下，增加combobox
                ...
                if (column.isImage()) {
                    ...
                    sb.append(" html = '<a class=\"ace_button fa fa-download\" style=\"padding:3px 5px;\" target=\"_blank\" href=\"systemController/downloadFile.do?filePath='+value+'\">" + // update-end-- author:gj_shaojc date:20180608 for:TASK #2760 【online表单】列表字段下载 文本乱码
                ...
                } else // author:xugj-----start-----date:20160512 ---- for: TASK #1080 【UI标签改造】t:dgCol 显示内容长度控制
                if (column.getShowLen() != null) {
                    ...
                    sb.append(column.getShowLen());
                    sb.append(")+'...';}}");
                } else // author:xugj-----end-----date:20160512 ---- for: TASK #1080 【UI标签改造】t:dgCol 显示内容长度控制
                // update--begin--author:zhangjiaqiang Date:20170815 for:TASK #2273 【demo】datagrid 多表头demo
