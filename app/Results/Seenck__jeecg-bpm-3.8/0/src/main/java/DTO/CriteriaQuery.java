...
public void in(String keyname,Object[] keyvalue){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/in"))
...
public void notEq(String keyname,Object keyvalue){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/notEq"))
...
public void setProjection(Property property){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setProjection"))
...
public void addOrder(String ordername,SortDirection ordervalue){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/addOrder"))
...
public void createAlias(String name,String value){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/createAlias"))
