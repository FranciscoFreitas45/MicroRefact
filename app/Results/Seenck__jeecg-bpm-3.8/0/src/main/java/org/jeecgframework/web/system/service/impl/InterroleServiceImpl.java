...
@Transactional
public class InterroleServiceImpl extends CommonServiceImplimplements InterroleServiceI{


public void doDelBus(InterroleEntity t){
// -----------------sql增强 start----------------------------
// -----------------sql增强 end------------------------------
// -----------------java增强 start---------------------------
// -----------------java增强 end-----------------------------
...
public Map<String,Object> populationMap(InterroleEntity t){
...
public void doAddBus(InterroleEntity t){
// -----------------sql增强 start----------------------------
// -----------------sql增强 end------------------------------
// -----------------java增强 start---------------------------
// -----------------java增强 end-----------------------------
...
public void doUpdateBus(InterroleEntity t){
// -----------------sql增强 start----------------------------
// -----------------sql增强 end------------------------------
// -----------------java增强 start---------------------------
// -----------------java增强 end-----------------------------
