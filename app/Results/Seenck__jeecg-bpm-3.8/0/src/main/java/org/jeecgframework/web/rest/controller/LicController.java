...
public void saveJeecgServer(HttpServletRequest request,HttpServletResponse response){
    // IP
...
public void getLicenseKey(HttpServletRequest request,HttpServletResponse response){
