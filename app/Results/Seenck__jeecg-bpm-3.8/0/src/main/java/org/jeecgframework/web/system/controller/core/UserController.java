...
@ResponseBody
public AjaxJson delInterfaceUser(String userid){
...
public void saveUserOrgList(HttpServletRequest request,TSUser user){
...
public void saveRoleUser(TSUser user,String roleidstr){
...
@ResponseBody
public AjaxJson delete(TSUser user,String deleteType,HttpServletRequest req){
...
public void saveInterfaceRoleUser(TSUser user,String roleidstr){
    String[] roleids = roleidstr.split(",");
    for (int i = 0; i < roleids.length; i++) {
