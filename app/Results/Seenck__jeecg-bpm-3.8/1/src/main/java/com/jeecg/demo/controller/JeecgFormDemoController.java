...
@ResponseBody
public void getEasyUIGrid(TSUser user,HttpServletRequest request,HttpServletResponse response,DataGrid dataGrid){
...
public AjaxJson saveFiles(HttpServletRequest request,HttpServletResponse response,TSDocument document){
    ...
    TSType tsType = systemService.getType("files", "附件", tsTypegroup);
    // 文件ID
    String documentId = oConvertUtils.getString(request.getParameter("documentId"));
    // 文件标题
...
public void getImgByurl(HttpServletResponse response,HttpServletRequest request){
...
@ResponseBody
public List<Map<String,String>> cityselect(HttpServletRequest req){
    logger.info("----省市区联动-----");
