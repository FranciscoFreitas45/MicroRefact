...
public void setWe_space_name(String we_space_name){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_space_name"))

.queryParam("we_space_name",we_space_name)
;
restTemplate.put(builder.toUriString(),null);
}
...
public boolean isAllGroupViewPrivacy(){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/isAllGroupViewPrivacy"))
...
public boolean isAllGroupEditPrivacy(){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/isAllGroupEditPrivacy"))
...
public void setWe_upload_imgName(String we_upload_imgName){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_upload_imgName"))

.queryParam("we_upload_imgName",we_upload_imgName)
;
restTemplate.put(builder.toUriString(),null);
}
...
public boolean isUploadImgName(){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/isUploadImgName"))
...
public boolean doUpdate(){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/doUpdate"))
...
public void setWe_view_data(String we_view_data){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_view_data"))

.queryParam("we_view_data",we_view_data)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWe_edit_data(String we_edit_data){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_edit_data"))

.queryParam("we_edit_data",we_edit_data)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWe_view_name(String we_view_name){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_view_name"))

.queryParam("we_view_name",we_view_name)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWe_edit_name(String we_edit_name){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_edit_name"))

.queryParam("we_edit_name",we_edit_name)
;
restTemplate.put(builder.toUriString(),null);
}
