...
public String diffContent(Model model,int wikiIdx,int wikiRev,int wikiBakRev){
    int wikiBaseRev = 0;
    WeWiki weWiki = null;
...
public String replace(Model model,int wikiIdx,int wikiRev,int wikiBakRev){
    /*
		=================================================
		 |                    | WE_BAK_IDX       |     |
...
public String list(Model model,int wikiIdx){
    // 위키 리스트
