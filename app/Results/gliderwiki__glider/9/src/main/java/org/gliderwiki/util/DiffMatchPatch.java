...
public String[] diff_halfMatchI(String longtext,String shorttext,int i){
...
public LinkedList<Diff> diff_bisectSplit(String text1,String text2,int x,int y,long deadline){
...
public LinkedList<Diff> diff_compute(String text1,String text2,boolean checklines,long deadline){
...
public String diff_linesToCharsMunge(String text,List<String> lineArray,Map<String,Integer> lineHash){
    int lineStart = 0;
    int lineEnd = -1;
    String line;
...
public LinkedList<Diff> diff_bisect(String text1,String text2,long deadline){
    // Cache the text lengths to prevent multiple calls.
    int text1_length = text1.length();
    int text2_length = text2.length();
...
public void diff_charsToLines(LinkedList<Diff> diffs,List<String> lineArray){
    StringBuilder text;
    for (Diff diff : diffs) {
...
public int diff_cleanupSemanticScore(String one,String two){
...
public double match_bitapScore(int e,int x,int loc,String pattern){
...
public LinkedList<Diff> diff_main(String text1,String text2,boolean checklines,long deadline){
    // Check for null inputs.
