...
public int sendActiveKey(String email,String activeKey,HttpServletRequest request){
    int result = 0;
    String emailMsgTxt = "안녕하세요. 글라이더 위키 입니다. <br><br>" + "글라이더 위키의 Active Key 를 전송하여 드립니다. <br><br>" + "Active Key : " + activeKey + "<br><br>Active Key는 글라이더 위키의 Install 시점에 입력해야 합니다.<br><br>" + "기타 설치 관련 문의는 아래의 메일주소로 해주시기 바랍니다.<br><br>" + "문의 메일 : performizer@gmail.com<br><br>" + "본 메일은 발신 전용이므로 반드시 위의 문의 메일 주소를 통해 문의 주시기 바랍니다. ";
    // 제목
    String emailTitle = "GLiDER Wiki™ 의  Active Key 정보입니다..";
    try {
