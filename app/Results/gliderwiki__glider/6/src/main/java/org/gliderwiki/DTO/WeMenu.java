...
public void setWe_menu_depth(Integer we_menu_depth){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_menu_depth"))

.queryParam("we_menu_depth",we_menu_depth)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWe_menu_type(String we_menu_type){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_menu_type"))

.queryParam("we_menu_type",we_menu_type)
;
restTemplate.put(builder.toUriString(),null);
}
