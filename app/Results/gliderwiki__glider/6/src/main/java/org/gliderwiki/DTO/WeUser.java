...
public void setWe_user_auth_yn(String we_user_auth_yn){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_user_auth_yn"))

.queryParam("we_user_auth_yn",we_user_auth_yn)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWe_user_id(String we_user_id){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_user_id"))

.queryParam("we_user_id",we_user_id)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWe_user_auth(String we_user_auth){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_user_auth"))

.queryParam("we_user_auth",we_user_auth)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWe_user_key(String we_user_key){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_user_key"))

.queryParam("we_user_key",we_user_key)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWe_user_join_date(Date we_user_join_date){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_user_join_date"))

.queryParam("we_user_join_date",we_user_join_date)
;
restTemplate.put(builder.toUriString(),null);
}
