...
public int sendSimpleMail(String toAddr,String title,String message,HttpServletRequest request){
...
public boolean pingCheck(String url,int timeout){
    InetAddress target = InetAddress.getByName(url);
    return target.isReachable(timeout);
}


public int sendMailSSL(String host,String port,String hostMailId,String hostPassword,String targetId,String title,String content,String charset){
...
public int sendMailTLS(String host,String port,String hostMailId,String hostPassword,String targetId,String title,String content,String charset){
