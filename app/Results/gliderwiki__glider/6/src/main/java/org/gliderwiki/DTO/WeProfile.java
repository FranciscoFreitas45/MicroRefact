...
public void setWe_user_email(String we_user_email){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_user_email"))

.queryParam("we_user_email",we_user_email)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWe_grade(Integer we_grade){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_grade"))

.queryParam("we_grade",we_grade)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWe_noti_checked(String we_noti_checked){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_noti_checked"))

.queryParam("we_noti_checked",we_noti_checked)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWe_visit_date(Date we_visit_date){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_visit_date"))

.queryParam("we_visit_date",we_visit_date)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWe_point(Integer we_point){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_point"))

.queryParam("we_point",we_point)
;
restTemplate.put(builder.toUriString(),null);
}
