...
public List<WeSpaceJoin> getUserSpaceJoinList(WeSpaceJoin joinDomain,int type){
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/getUserSpaceJoinList"))
    .queryParam("joinDomain",joinDomain)
    .queryParam("type",type)
;  List<WeSpaceJoin> aux = restTemplate.getForObject(builder.toUriString(), List<WeSpaceJoin>.class);
