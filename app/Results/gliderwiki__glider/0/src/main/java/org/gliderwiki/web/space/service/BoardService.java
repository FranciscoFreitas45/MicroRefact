...
public int create(WeBbs weBbs){
    WeBbs newWeBbs = new WeBbs(weBbs.getWe_space_idx(), weBbs.getWe_user_ip(), weBbs.getWe_bbs_title(), weBbs.getWe_bbs_text(), weBbs.getWe_ins_user(), weBbs.getWe_ins_name());
    try {
