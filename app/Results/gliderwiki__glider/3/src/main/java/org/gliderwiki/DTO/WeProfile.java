...
public void setWe_away_yn(String we_away_yn){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_away_yn"))

.queryParam("we_away_yn",we_away_yn)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWe_tech_yn(String we_tech_yn){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWe_tech_yn"))

.queryParam("we_tech_yn",we_tech_yn)
;
restTemplate.put(builder.toUriString(),null);
}
