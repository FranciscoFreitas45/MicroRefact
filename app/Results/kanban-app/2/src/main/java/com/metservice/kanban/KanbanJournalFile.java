...
public class KanbanJournalFile {
 ...
 private  List<KanbanJournalItem> journalItems;
...
public void writeItem(CSVWriter writer,KanbanJournalItem item){
    String[] row = new String[] { item.getId().toString(), item.getDate().toString(), item.getText(), item.getUserName() };
