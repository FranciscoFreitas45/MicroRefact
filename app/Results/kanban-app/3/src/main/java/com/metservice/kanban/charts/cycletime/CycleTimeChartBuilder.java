...
public void sortByDateOfCompletion(List<WorkItem> selectedWorkItems){
...
public List<CycleTimeColumn> convertFromWorkItemToCycleTimeColumns(Collection<WorkItem> listOfItems){
