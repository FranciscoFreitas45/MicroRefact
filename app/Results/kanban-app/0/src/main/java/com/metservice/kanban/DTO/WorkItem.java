package com.metservice.kanban.DTO;
 import com.metservice.kanban.DTO.DateUtils.parseIsoDate;
...
import com.metservice.kanban.DTO.WorkingDayUtils;
...
public boolean isTopLevel(){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/isTopLevel"))
...
public void setAverageCaseEstimate(int averageCaseEstimate){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setAverageCaseEstimate"))

.queryParam("averageCaseEstimate",averageCaseEstimate)
;
...
public void setWorstCaseEstimate(int worstCaseEstimate){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWorstCaseEstimate"))

.queryParam("worstCaseEstimate",worstCaseEstimate)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setMustHave(boolean mustHave){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setMustHave"))

.queryParam("mustHave",mustHave)
;
restTemplate.put(builder.toUriString(),null);
}
