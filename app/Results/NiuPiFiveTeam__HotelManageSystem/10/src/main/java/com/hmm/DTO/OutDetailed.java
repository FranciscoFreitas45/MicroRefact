...
public void setGoodsName(String goodsName){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/"+ id).concat("/setGoodsName"))
...
public void setGoodsNo(String goodsNo){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/"+ id).concat("/setGoodsNo"))
...
public void setOutStorage(OutStorage outStorage){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/"+ id).concat("/setOutStorage"))
