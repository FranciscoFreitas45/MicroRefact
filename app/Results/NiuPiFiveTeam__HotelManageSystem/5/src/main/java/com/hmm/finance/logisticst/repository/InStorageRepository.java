...
public void setInStorageId(String id,String inStorageId);

public void setProcessStatus(String id,ProcessStatus processStatus);

public void setEmployee(String id,Employee employee);
