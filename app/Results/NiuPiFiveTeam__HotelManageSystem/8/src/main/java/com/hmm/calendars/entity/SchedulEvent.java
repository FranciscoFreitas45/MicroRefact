...
@Column(name = "emp_idOBPL")
 private Integer emp_idOBPL;
...
public Employee getEmploy(){
  this.employ = employeerequest.getEmploy(this.emp_idOBPL);
return this.employ;
}}
...
this.emp_idOBPL = employ.getEmploy() ;
employeerequest.setEmploy(employ,this.emp_idOBPL);
 this.employ = employ;
}
