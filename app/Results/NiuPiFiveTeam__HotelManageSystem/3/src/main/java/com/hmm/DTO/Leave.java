...
this.emp_idRVZP = employ.getEmploy() ;
employeerequest.setEmploy(employ,this.emp_idRVZP);
 this.employ = employ;
}
...
public Employee getEmploy(){
  this.employ = employeerequest.getEmploy(this.emp_idRVZP);
return this.employ;
}}
