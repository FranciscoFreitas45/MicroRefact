...
public String buildStr(UpstreamServer upstreamServer,Integer proxyType){
    ...
    return // 
    "<tr><td>" + upstreamServer.getServer() + ":" + upstreamServer.getPort() + "</td>" + "<td>weight=" + upstreamServer.getWeight() + // 
    "</td>" + "<td>fail_timeout=" + upstreamServer.getFailTimeout() + // 
    "s</td>" + "<td>max_fails=" + upstreamServer.getMaxFails() + // 
    "</td>" + "<td>" + status + // 
    "</td>" + monitorStatus + "</tr>";
}
