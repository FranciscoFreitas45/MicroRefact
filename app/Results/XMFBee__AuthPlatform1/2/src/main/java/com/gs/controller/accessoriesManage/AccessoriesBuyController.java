...
import com.gs.DTO.IncomingOutgoing;
@Controller
...
public Pager4EasyUI<AccessoriesBuy> queryByPagerDisable(HttpSession session,String pageNumber,String pageSize){
    if (SessionUtil.isLogin(session)) {
...
public ControllerResult addAccBuy(HttpSession session,AccessoriesBuy accessoriesBuy,String accName,String outgoingId){
    if (SessionUtil.isLogin(session)) {
...
public Pager4EasyUI<AccessoriesBuy> blurredQuery(HttpSession session,HttpServletRequest request,String pageNumber,String pageSize){
    if (SessionUtil.isLogin(session)) {
        String roles = "公司超级管理员,公司普通管理员,汽车公司采购人员,系统超级管理员,系统普通管理员";
        if (RoleUtil.checkRoles(roles)) {
...
public Pager4EasyUI<AccessoriesBuy> queryByPager(HttpSession session,String pageNumber,String pageSize){
    if (SessionUtil.isLogin(session)) {
        String roles = "公司超级管理员,公司普通管理员,汽车公司采购人员,系统超级管理员,系统普通管理员";
        if (RoleUtil.checkRoles(roles)) {
