...
public Pager4EasyUI<MaintainRecord> queryByBackstage(HttpSession session,String pageNumber,String pageSize){
...
public Pager4EasyUI<MaintainRecord> queryByOwner(HttpSession session,String pageNumber,String pageSize){
...
public Pager4EasyUI<MaintainRecord> queryByPagerDisable(HttpSession session,String pageNumber,String pageSize){
    if (SessionUtil.isLogin(session)) {
...
public Pager4EasyUI<MaintainRecord> queryByPagerRemindNo(HttpSession session,String pageNumber,String pageSize){
    if (SessionUtil.isLogin(session)) {
...
public Pager4EasyUI<MaintainRecord> queryByPagerSuccess(HttpSession session,String pageNumber,String pageSize){
    if (SessionUtil.isLogin(session)) {
        String roles = "公司超级管理员,公司普通管理员,汽车公司接待员";
        if (RoleUtil.checkRoles(roles)) {
...
public Pager4EasyUI<MaintainRecord> queryByPagerRemindYes(HttpSession session,String pageNumber,String pageSize){
    if (SessionUtil.isLogin(session)) {
        String roles = "系统超级管理员,系统普通管理员,公司超级管理员,公司普通管理员,汽车公司接待员";
        if (RoleUtil.checkRoles(roles)) {
            logger.info("提车提醒分布查看维修保养记录");
...
public Pager4EasyUI<MaintainRecord> queryByPager(HttpSession session,String pageNumber,String pageSize){
    if (SessionUtil.isLogin(session)) {
        String roles = "系统超级管理员,系统普通管理员,公司超级管理员,公司普通管理员,汽车公司接待员,汽车公司总技师,汽车公司技师";
        if (RoleUtil.checkRoles(roles)) {
