...
public String newStatus(String oldStatus){
...
public String[] idsStr2ids(String idsStr,String split){
...
public ControllerResult updateStatus(String permissionId,String permissionStatus,HttpSession session){
    // 无用
    // TODO 系统超级管理员可以更改
    if (SessionUtil.isLogin(session)) {
        String roles = "系统超级管理员,系统普通管理员";
...
public Pager4EasyUI recycleByPager(int pageNumber,int pageSize,HttpSession session){
    // 无用 但是
    // TODO 系统所有管理员可以查看
    if (SessionUtil.isLogin(session)) {
        String roles = "系统超级管理员,系统普通管理员";
...
public ControllerResult updateStatuses(String permissionIdsStr,String permissionStatus,HttpSession session){
    // 无用
    // TODO 系统超级管理员
    if (SessionUtil.isLogin(session)) {
        String roles = "系统超级管理员,系统普通管理员";
...
public Pager4EasyUI queryByPager(int pageNumber,int pageSize,HttpSession session){
    // TODO 系统所有管理员可以查看
    if (SessionUtil.isLogin(session)) {
