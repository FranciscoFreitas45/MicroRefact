...
public Pager4EasyUI curRecords(String pageNo,String pageSize,HttpSession session){
...
public Pager4EasyUI records(String pageNo,String pageSize,HttpSession session){
    if (SessionUtil.isLogin(session)) {
        // TODO 需要公司人员登录才能指派员工
        String roles = "公司超级管理员,公司普通管理员,汽车公司接待员,汽车公司总技师,汽车公司技师,汽车公司学徒,汽车公司销售人员,汽车公司财务人员,汽车公司采购人员,汽车公司库管人员,汽车公司人力资源管理部,系统超级管理员,系统普通管理员";
        if (RoleUtil.checkRoles(roles)) {
...
@ResponseBody
// 可能不会使用到
@RequestMapping("queryRecrodAccByPager")
public Pager4EasyUI accInfos(String pageNo,String pageSize,String recordId,HttpSession session){
    if (SessionUtil.isLogin(session)) {
        String roles = "公司超级管理员,公司普通管理员,汽车公司接待员,汽车公司总技师,汽车公司技师,汽车公司学徒,汽车公司销售人员,汽车公司财务人员,汽车公司采购人员,汽车公司库管人员,汽车公司人力资源管理部,系统超级管理员,系统普通管理员";
        if (RoleUtil.checkRoles(roles)) {
            Pager pager = new Pager();
...
public Pager4EasyUI recordDetails(int pageNo,int pageSize,String recordId,HttpSession session){
    if (SessionUtil.isLogin(session)) {
        String roles = "公司超级管理员,公司普通管理员,汽车公司接待员,汽车公司总技师,汽车公司技师,汽车公司学徒,汽车公司销售人员,汽车公司财务人员,汽车公司采购人员,汽车公司库管人员,汽车公司人力资源管理部,系统超级管理员,系统普通管理员";
        if (RoleUtil.checkRoles(roles)) {
            User user = (User) session.getAttribute("user");
...
public ControllerResult insert(String recordId,String userId,HttpSession session){
    // TODO 公司管理员可以
    if (SessionUtil.isLogin(session)) {
...
@ResponseBody
// 用于页面显示员工工单,员工通过这个页面会点击查询该工单所需要的零件
@RequestMapping("userWorksByPager")
public Pager4EasyUI userWorks(String pageNo,String pageSize,HttpSession session){
    if (SessionUtil.isLogin(session)) {
        String roles = "公司超级管理员,公司普通管理员,汽车公司接待员,汽车公司总技师,汽车公司技师,汽车公司学徒,汽车公司销售人员,汽车公司财务人员,汽车公司采购人员,汽车公司库管人员,汽车公司人力资源管理部,系统超级管理员,系统普通管理员";
        if (RoleUtil.checkRoles(roles)) {
            User user = (User) session.getAttribute("user");
