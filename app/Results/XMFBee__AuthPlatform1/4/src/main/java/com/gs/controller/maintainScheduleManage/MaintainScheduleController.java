...
public List<MaintainSchedule> queryScheduleByRecord(HttpSession session,String recordId){
...
public Pager4EasyUI<MaintainSchedule> queryByPagerDisable(HttpSession session,String pageNumber,String pageSize){
    if (SessionUtil.isLogin(session)) {
