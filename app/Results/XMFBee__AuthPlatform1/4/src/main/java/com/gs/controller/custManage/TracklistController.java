...
public Pager4EasyUI<TrackList> queryName(HttpSession session,String pageNumber,String pageSize,TrackList trackList){
...
public Pager4EasyUI<TrackList> queryByPager(HttpSession session,String pageNumber,String pageSize){
    if (SessionUtil.isLogin(session)) {
        String roles = "系统超级管理员,系统普通管理员,公司超级管理员,公司普通管理员,汽车公司接待员,车主";
        if (RoleUtil.checkRoles(roles)) {
