...
public Pager4EasyUI<MaintainRecord> queryByPagerNull(HttpSession session,String pageNumber,String pageSize){
...
public Pager4EasyUI<MaintainRemind> queryByPagerUser(HttpSession session,String pageNumber,String pageSize){
...
public Pager4EasyUI<MaintainRemind> blurredQuery(HttpSession session,String pageNumber,String pageSize,MaintainRemind maintainRemind){
    if (SessionUtil.isLogin(session)) {
        String roles = "系统超级管理员,系统普通管理员,公司超级管理员,公司普通管理员,汽车公司接待员";
        if (RoleUtil.checkRoles(roles)) {
...
public Pager4EasyUI<MaintainRemind> queryByPager(HttpSession session,String pageNumber,String pageSize){
    if (SessionUtil.isLogin(session)) {
        String roles = "系统超级管理员,系统普通管理员,公司超级管理员,公司普通管理员,汽车公司接待员";
        if (RoleUtil.checkRoles(roles)) {
            logger.info("分页查看维修保养提醒记录");
...
public MaintainRemind queryById(HttpSession session,String remindId){
    if (SessionUtil.isLogin(session)) {
        String roles = "系统超级管理员,系统普通管理员,公司超级管理员,公司普通管理员,汽车公司接待员";
        if (RoleUtil.checkRoles(roles)) {
