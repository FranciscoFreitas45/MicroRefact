...
import br.com.fatecmogidascruzes.Interface.EmployeeWebServiceImpl;
import br.com.fatecmogidascruzes.Interface.EventWebService;
import br.com.fatecmogidascruzes.Interface.EventWebServiceImpl;
...
return  new EmployeeWebServiceImpl(); 
    }



@Bean
public EventWebService eventwebservice(){

return  new EventWebServiceImpl(); 
    }
