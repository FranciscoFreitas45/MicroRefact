...
public SelectionEditDTO from(Selection selection){
    ...
    if (null != selection.getRegistrationStartDate()) {
        if (null != selection.getRegistrationStartTime()) {
            selectionEditDTO.setStartDateTime(LocalDateTime.of(selection.getRegistrationStartDate(), selection.getRegistrationStartTime()));
        } else {
            selectionEditDTO.setStartDateTime(LocalDateTime.of(selection.getRegistrationStartDate(), LocalTime.of(0, 0)));
        }
    }
    if (null != selection.getRegistrationEndDate()) {
        if (null != selection.getRegistrationEndTime()) {
            selectionEditDTO.setEndDateTime(LocalDateTime.of(selection.getRegistrationEndDate(), selection.getRegistrationEndTime()));
        } else {
            selectionEditDTO.setEndDateTime(LocalDateTime.of(selection.getRegistrationEndDate(), LocalTime.of(23, 59)));
        }
    }
