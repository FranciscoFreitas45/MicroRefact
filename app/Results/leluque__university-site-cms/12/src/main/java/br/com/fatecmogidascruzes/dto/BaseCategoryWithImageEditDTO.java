...
public BaseCategoryWithImageEditDTO from(BaseCategoryWithImage baseCategoryWithImage){
    ...
    expenseCategoryEditDTO.setImageAlternativeDescription(baseCategoryWithImage.getImage().getAlternativeDescription());
