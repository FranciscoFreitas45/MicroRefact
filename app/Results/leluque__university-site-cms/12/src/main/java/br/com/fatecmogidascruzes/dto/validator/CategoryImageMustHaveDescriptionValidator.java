...
public class CategoryImageMustHaveDescriptionValidator implements ConstraintValidator<CategoryImageMustHaveDescription, BaseCategoryWithImageEditDTO>{


@Override
public boolean isValid(BaseCategoryWithImageEditDTO baseCategoryWithImageDTO,ConstraintValidatorContext context){
    if ((null == baseCategoryWithImageDTO.getImageAlternativeDescription() || baseCategoryWithImageDTO.getImageAlternativeDescription().trim().isEmpty())) {
