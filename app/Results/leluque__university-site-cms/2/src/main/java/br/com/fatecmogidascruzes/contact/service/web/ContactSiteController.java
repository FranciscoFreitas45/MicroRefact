...
public ContactSiteController(HttpSession httpSession, UserService userService, EmailService emailService, ReCaptchaService reCaptchaService) {
    super(httpSession, userService);
    this.emailService = emailService;
    this.reCaptchaService = reCaptchaService;
}
@RequestMapping("/new")
public ModelAndView newContact(ContactDTO contactDTO,RedirectAttributes redirectAttributes){
...
@RequestMapping("/send")
public ModelAndView send(String recaptchaResponse,ContactDTO contactDTO,BindingResult binding,RedirectAttributes redirectAttributes,HttpServletRequest request){
    ...
    try {
        ...
        emailService.sendContactEmail(contactDTO.getEmail(), contactDTO.getPhone(), contactDTO.getName(), contactDTO.getMessage());
