...
@Override
public void doFilter(ServletRequest originalRequest,ServletResponse originalResponse,FilterChain chain) throws IOException{
    ...
    if (!request.getRequestURI().startsWith("/doSignIn")) {
        ...
        try {
            ...
            String captchaVerifyMessage = reCaptchaService.verifyRecaptcha(ip, request.getParameter("g-recaptcha-response"));
