...
public ModelAndView recoveryPassword(String username){
...
public ModelAndView doRecoveryPassword(String username){
    ModelAndView modelAndView = new ModelAndView("/recoveryPassword");
    try {
...
public ModelAndView changePassword(String hash,PasswordEditDTO passwordEditDTO,RedirectAttributes redirectAttributes){
    ModelAndView modelAndView = new ModelAndView("/changePassword");
    modelAndView.addObject("message", redirectAttributes.getFlashAttributes().get("message"));
    try {
        if (null == passwordEditDTO || null == passwordEditDTO.getHashString() || passwordEditDTO.getHashString().trim().isEmpty()) {
...
public ModelAndView doChangePassword(PasswordEditDTO passwordEditDTO,BindingResult binding,RedirectAttributes redirectAttributes){
