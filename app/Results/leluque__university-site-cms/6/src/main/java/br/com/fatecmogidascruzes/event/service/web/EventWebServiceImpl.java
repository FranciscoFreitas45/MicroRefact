...
public void saveEvent(EventEditDTO eventEditDTO){
    ...
    if (null != eventEditDTO.getHashString() && !eventEditDTO.getHashString().trim().isEmpty()) {
        Optional<Event> eventOptional = this.eventService.getByHash(FriendlyId.toUuid(eventEditDTO.getHashString()));
    ...
    if (null != eventEditDTO.getImage()) {
        if (!eventEditDTO.getImage().isEmpty()) {
            ...
            try {
                File newImage = fileService.saveImage(eventEditDTO.getImage(), eventEditDTO.getImageAlternativeDescription());
    ...
    if (null != eventEditDTO.getBigImage()) {
        if (!eventEditDTO.getBigImage().isEmpty()) {
            ...
            try {
                File newImage = fileService.saveImage(eventEditDTO.getBigImage(), eventEditDTO.getBigImageAlternativeDescription());
