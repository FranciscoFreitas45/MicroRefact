...
public void setData_Value(int id,Double data_Value);

public void setArea_NId(int id,int area_NId);

public void setSubgroup_Val_NId(int id,int subgroup_Val_NId);

public void setIUNId(int id,String IUNId);

public void setSource_NId(int id,int source_NId);
