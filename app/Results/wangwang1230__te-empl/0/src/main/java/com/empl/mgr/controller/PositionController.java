...
public JSONReturn deletePosition(long id,HttpSession httpSession){
...
public JSONReturn findPositionById(long id,HttpSession httpSession){
...
public JSONReturn findPositionPage(int page,long deptId,String searchValue,HttpSession httpSession){
...
public JSONReturn addPosition(long deptId,String name,String desc,HttpSession httpSession){
...
public JSONReturn modifyPosition(long id,long deptId,String name,String desc,HttpSession httpSession){
...
public JSONReturn findPositionListInfo(int page,long deptId,String searchValue,HttpSession httpSession){
