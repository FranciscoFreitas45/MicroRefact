...
public JSONReturn mdoifyPass(String password,HttpSession httpSession){
...
public JSONReturn login(String name,String pass,String verify,HttpServletRequest request){
