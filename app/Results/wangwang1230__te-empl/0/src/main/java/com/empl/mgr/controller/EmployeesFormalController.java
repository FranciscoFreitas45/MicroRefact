...
public JSONReturn findCanTrainingList(long emplId,HttpSession httpSession){
...
public JSONReturn findEmployeesInternshipList(int serType,String serVal,long department,long position,int page,HttpSession httpSession){
    return employeesService.findEmployeesList(serType, serVal, department, position, page, acctName(httpSession), EmployeesState.EMPL_FORMAL);
}
...
public JSONReturn findEmployeesInternshipPage(int serType,String serVal,long department,long position,int page,HttpSession httpSession){
    return employeesService.findEmployeesPage(serType, serVal, department, position, page, acctName(httpSession), EmployeesState.EMPL_FORMAL);
}
...
public JSONReturn departure(long id,String note,HttpSession httpSession){
