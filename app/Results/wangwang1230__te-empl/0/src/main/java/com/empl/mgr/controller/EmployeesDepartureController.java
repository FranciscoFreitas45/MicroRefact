...
public JSONReturn findEmployeesInternshipList(int serType,String serVal,long department,long position,int page,HttpSession httpSession){
    return employeesService.findEmployeesList(serType, serVal, department, position, page, acctName(httpSession), EmployeesState.EMPL_DEPARTURE, EmployeesState.EMPL_ELIMINATE);
}
...
public JSONReturn findDepartureNote(long emplId,HttpSession httpSession){
...
public JSONReturn findEmployeesInternshipPage(int serType,String serVal,long department,long position,int page,HttpSession httpSession){
    return employeesService.findEmployeesPage(serType, serVal, department, position, page, acctName(httpSession), EmployeesState.EMPL_DEPARTURE, EmployeesState.EMPL_ELIMINATE);
}
...
public JSONReturn destroy(long emplId,HttpSession httpSession){
...
public JSONReturn enrollEmployees(long emplId,String note,HttpSession httpSession){
