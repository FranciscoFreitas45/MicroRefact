...
public JSONReturn modifyDepartment(long deptId,String name,String desc,HttpSession httpSession){
...
public JSONReturn addDepartment(String name,String desc,HttpSession httpSession){
...
public JSONReturn findDeptEmplList(long deptId,HttpSession httpSession){
...
public JSONReturn setPrincipal(long deptId,long emplId,HttpSession httpSession){
...
public JSONReturn deleteDepartment(long deptId,HttpSession httpSession){
...
public JSONReturn findDepartmentList(int page,String searchValue,HttpSession httpSession){
