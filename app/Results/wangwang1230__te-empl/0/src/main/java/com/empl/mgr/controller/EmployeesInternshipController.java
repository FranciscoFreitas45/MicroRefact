...
public JSONReturn saveEmployeesInfo(String data,HttpSession httpSession){
    EmployeesInfoDto dto = (EmployeesInfoDto) JSONObject.toBean(JSONObject.fromObject(data), EmployeesInfoDto.class);
...
public JSONReturn modifyEmployeesInfo(String data,HttpSession httpSession){
    EmployeesInfoDto dto = (EmployeesInfoDto) JSONObject.toBean(JSONObject.fromObject(data), EmployeesInfoDto.class);
...
public JSONReturn findEmployeesInternshipList(int serType,String serVal,long department,long position,int page,HttpSession httpSession){
    return employeesService.findEmployeesList(serType, serVal, department, position, page, acctName(httpSession), EmployeesState.EMPL_INTERNSHIP);
}
...
public JSONReturn findEmployeesInternshipPage(int serType,String serVal,long department,long position,int page,HttpSession httpSession){
    return employeesService.findEmployeesPage(serType, serVal, department, position, page, acctName(httpSession), EmployeesState.EMPL_INTERNSHIP);
}
...
public JSONReturn eliminate(long emId,String note,HttpSession httpSession){
...
public JSONReturn enroll(long emId,HttpSession httpSession){
