...
public JSONReturn findRolePage(int page,String searchVal){
    // TODO Auto-generated method stub
    return JSONReturn.buildSuccess(PageUtils.calculatePage(page, roleDao.findRoleCount(searchVal), PageConstant.PAGE_LIST));
}
...
public JSONReturn findRoleList(int page,String searchVal,String acctName){
    ...
    for (RoleListDto dto : dtoList) dto.setTime(DateTimeUtil.conversionTime(dto.getData(), TimeFormatConstant.YYYY_MM_DD));
