...
public Map<String,String> doDelete(String jobName,String jobGroup){
...
public Map<String,String> doResume(String jobName,String jobGroup){
...
public Map<String,String> doPause(String jobName,String jobGroup){
...
public Map<String,String> resumeFromBreakPoint(String jobName,String jobGroup){
    logger.info("========>jobController-->doResume<========");
    logger.info("========>恢复Job：" + jobName + "<========");
