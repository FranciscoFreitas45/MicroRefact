...
public void process(ResultItems resultItems,Task task){
    ...
    try {
        for (TableNamesCreditReference tableName : getNames) {
            if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_ACCOUNT_BAK.getMapKey())) {
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_ASSET_HANDLE.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersAssetHandle> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersAssetHandle());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_BASIC.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersBasic> entityLis = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersBasic());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_CC_DETAIL.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersCcDetail> entityLis = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersCcDetail());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_COMPENSATORY.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersCompensatory> entityLis = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersCompensatory());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_GENERAL.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersGeneral> entityLis = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersGeneral());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_GUARANTEE.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersGuarantee> entityLis = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersGuarantee());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_HL_DETAIL.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersHlDetail> entityLis = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersHlDetail());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_OL_DETAIL.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersOlDetail> entityLis = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersOlDetail());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_PUBLIC_CIVIL.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersPublicCivil> entityLis = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersPublicCivil());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_PUBLIC_ENFORCEMENT.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersPublicEnforcement> entityLis = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersPublicEnforcement());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_PUBLIC_ISP.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersPublicIsp> entityLis = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersPublicIsp());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_PUBLIC_SANCTION.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersPublicSanction> entityLis = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersPublicSanction());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_PUBLIC_TAX.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersPublicTax> entityLis = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersPublicTax());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesCreditReference.T_CREEPERS_QUERY_LOG.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersQueryLog> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersQueryLog());
