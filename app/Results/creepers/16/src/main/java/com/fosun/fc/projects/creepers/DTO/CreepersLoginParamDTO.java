...
public void setCaptchaKey(String captchaKey){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setCaptchaKey"))

.queryParam("captchaKey",captchaKey)
;
...
public void setLoginNameKey(String loginNameKey){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setLoginNameKey"))

.queryParam("loginNameKey",loginNameKey)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setPasswordKey(String passwordKey){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setPasswordKey"))

.queryParam("passwordKey",passwordKey)
;
restTemplate.put(builder.toUriString(),null);
}
