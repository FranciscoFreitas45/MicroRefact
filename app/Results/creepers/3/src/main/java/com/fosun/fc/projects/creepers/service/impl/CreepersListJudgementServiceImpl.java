...
public Page<CreepersListJudgementDTO> findListJudgementList(Map<String,Object> searchParams,int pageNumber,int pageSize,String sortType){
    ...
    Page<CreepersListJudgementDTO> listJudgementDTOPage = new PageImpl<CreepersListJudgementDTO>(new ArrayList<CreepersListJudgementDTO>(creepersListJudgementDTOList), pageable, listJudgementPage.getTotalElements());
