...
public Page<CreepersListPatentDTO> queryListPatentList(Map<String,Object> searchParams,int pageNumber,int pageSize,String sortType){
    ...
    Page<CreepersListPatentDTO> resultPage = new PageImpl<CreepersListPatentDTO>(new ArrayList<CreepersListPatentDTO>(creepersListPatentDTOList), pageable, listPatentPage.getTotalElements());
    return resultPage;
}
