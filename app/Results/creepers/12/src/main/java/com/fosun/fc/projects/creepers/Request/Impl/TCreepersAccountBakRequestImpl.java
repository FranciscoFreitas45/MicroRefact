...
public void setTCreepersAccountBak(TCreepersAccountBak TCreepersAccountBak,Long id){
 restTemplate.put("http://20/TCreepersAssetHandle/{id}/TCreepersAccountBak/setTCreepersAccountBak",TCreepersAccountBak,id);
 return ;
}


public TCreepersAccountBak getTCreepersAccountBak(Long id){
 TCreepersAccountBak aux = restTemplate.getForObject("http://20/TCreepersAssetHandle/{id}/TCreepersAccountBak/getTCreepersAccountBak",TCreepersAccountBak.class,id);
return aux;
}
