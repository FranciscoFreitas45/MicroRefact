...
public class AdministrationSactionProcessor extends BaseCreepersListProcessorimplements PageProcessor{
 ...
 private  String REGEX_URL_PUBLICITY;

 private  String ACCESS_URL_PUBLICITY;

 private  String ACCESS_URL_PUBLICITY_DETAIL;
 ...
 private  String SYMBOL_COLON_SLASH;
 ...
 private  String JSON_KEY_FULL_NAME;

 private  String JSON_KEY_TIME;

 private  String JSON_KEY_RECORD_SOURCE;

 private  String JSON_KEY_DATATYPE;
    ...
    try {
        if (page.getUrl().regex(BASE_URL + REGEX_URL_PUBLICITY).match()) {
            ...
            for (int i = 0; i < jsonArr.size(); i++) {
                ...
                logger.info(CreepersConstant.TCreepersSactionColumn.PROVINCE.getValue() + SYMBOL_COLON_EN + province);
                map.put(CreepersConstant.TCreepersSactionColumn.MODIFY_DT.getValue(), modifyTime);
                logger.info(CreepersConstant.TCreepersSactionColumn.MODIFY_DT.getValue() + SYMBOL_COLON_EN + modifyTime);
            ...
            int totalPageCount = null == json.getString(JSON_KEY_TOTAL_PAGE_COUNT) ? 0 : Integer.parseInt(json.getString(JSON_KEY_TOTAL_PAGE_COUNT));
...
public void main(String[] args){
    ...
    Spider.create(new AdministrationSactionProcessor()).setDownloader(new HttpRequestDownloader()).thread(1).addRequest(request).run();
}
