...
public void process(ResultItems resultItems,Task task){
    ...
    // 数据入库
    List<Map<String, String>> resultList = resultItems.get(CreepersConstant.TableNamesOthers.T_CREEPERS_PROXY_LIST.getMapKey());
    ...
    try {
        if (!CommonMethodUtils.isEmpty(resultList)) {
            ...
            for (TCreepersProxyList entity : entityList) {
                ...
                List<TCreepersProxyList> proxyList = creepersProxyListDao.queryByIpAndPort(entity.getIp(), entity.getPort());
                ...
                try {
                    ...
                    StringBuffer errorMessage = new StringBuffer("creepersProxyListDao .saveAndFlush(entity)  FALSE!!! \n");
