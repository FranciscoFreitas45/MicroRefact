...
public CreepersJobDTO findJob(String jobName){
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/findJob"))
    .queryParam("jobName",jobName)
;  CreepersJobDTO aux = restTemplate.getForObject(builder.toUriString(), CreepersJobDTO.class);
