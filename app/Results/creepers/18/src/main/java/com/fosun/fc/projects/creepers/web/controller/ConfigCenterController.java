...
public String queryList(Model model,int pageNumber,int pageSize,String sortType,CreepersConfigDTO configDTO){
    ...
    Page<CreepersConfigDTO> resultList = creepersConfigServiceImpl.queryForListByRequestType(searchParams, pageNumber, pageSize, sortType);
    model.addAllAttributes(BeanMapper.toMap(configDTO));
