...
public class CreepersShangBiaoRestController extends CreepersBaseRestController{


@SuppressWarnings({ "rawtypes", "unchecked" })
@RequestMapping(value = "/shangbiao/query", method = RequestMethod.GET, produces = MediaTypes.JSON_UTF_8)
public ResponseEntity<JsonResult<Map>> queryByMerNo(HttpServletRequest request,HttpServletResponse response){
    ...
    jsonResult = creepersListServiceImpl.processByMerName(BaseConstant.TaskListType.TRADE_MARK_LIST.getValue(), merName);
