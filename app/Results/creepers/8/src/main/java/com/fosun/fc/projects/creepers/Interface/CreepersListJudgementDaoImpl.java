...
public class CreepersListJudgementDaoImpl implements CreepersListJudgementDao{
...
;  List<TCreepersListJudgement> aux = restTemplate.getForObject(builder.toUriString(), List<TCreepersListJudgement>.class);
