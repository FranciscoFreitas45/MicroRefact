...
public void putTargetUrlList(String targetUrl){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/putTargetUrlList"))
...
public void putNameValuePair(String key,String value){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/putNameValuePair"))
...
public void putOrderUrl(OrderUrlKey order,String url){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/putOrderUrl"))
