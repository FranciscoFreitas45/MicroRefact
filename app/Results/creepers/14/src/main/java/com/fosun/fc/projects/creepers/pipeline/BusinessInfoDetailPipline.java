...
public void process(ResultItems resultItems,Task task){
    ...
    try {
        for (TableNamesBusinessInfo tableName : getNames) {
            if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_ENT_ASSET.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersEntAsset> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersEntAsset());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_ENT_BASIC.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersEntBasic> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersEntBasic());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_ENT_CHANGE.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersEntChange> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersEntChange());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_ENT_EQUITY.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersEntEquity> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersEntEquity());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_ENT_INTEL.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersEntIntel> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersEntIntel());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_ENT_INVEST.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersEntInvest> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersEntInvest());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_ENT_LICENSE.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersEntLicense> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersEntLicense());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_ENT_SHARE.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersEntShare> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersEntShare());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_ENT_SHARE_CHANGE.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersEntShareChange> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersEntShareChange());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_ENT_WARRANT.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersEntWarrant> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersEntWarrant());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_ENT_WEB.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersEntWeb> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersEntWeb());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_MER_ABNORMAL.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersMerAbnormal> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersMerAbnormal());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_MER_BASIC.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersMerBasic> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersMerBasic());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_MER_BRANCH.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersMerBranch> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersMerBranch());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_MER_CHANGE.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersMerChange> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersMerChange());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_MER_CHECK.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersMerCheck> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersMerCheck());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_MER_ILLEGAL.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersMerIllegal> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersMerIllegal());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_MER_KEYMAN.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersMerKeyman> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersMerKeyman());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_MER_PENALTY.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersMerPenalty> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersMerPenalty());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_MER_PLEDGE.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersMerPledge> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersMerPledge());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_MER_PROPERTY.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersMerProperty> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersMerProperty());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_MER_SHAREHOLDER.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersMerShareholder> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersMerShareholder());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_MER_UNDO.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersMerUndo> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersMerUndo());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_OTHER_FREEZE.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersOtherFreeze> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersOtherFreeze());
            ...
            } else if (tableName.getMapKey().equals(CreepersConstant.TableNamesBusinessInfo.T_CREEPERS_OTHER_SHARE_CHANGE.getMapKey())) {
                if (CommonMethodUtils.isEmpty(resultItems.get(tableName.getMapKey()))) {
                    continue;
                }
                if (tableName.isList()) {
                    List<TCreepersOtherShareChange> entityList = CommonMethodUtils.mapList(resultItems.get(tableName.getMapKey()), new TCreepersOtherShareChange());
