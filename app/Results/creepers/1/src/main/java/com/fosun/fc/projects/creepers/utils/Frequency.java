...
public Object reflectInvoke(String className,String methodName,Class[] parameterTypes,Object[] parameterValues){
    Class<?> clazz = null;
    Object object = null;
    try {
...
@SuppressWarnings("rawtypes")
public void frequency(String className,String methodName,Class[] parameterTypes,Object[] parameterValues,String maxTimeInterVal,String maxTimes,String redisKey,String errorContent){
    String maxTI = StringUtils.isBlank(PropertiesUtil.getApplicationValue(maxTimeInterVal)) ? "0" : PropertiesUtil.getApplicationValue(maxTimeInterVal);
    String maxTs = StringUtils.isBlank(PropertiesUtil.getApplicationValue(maxTimes)) ? "0" : PropertiesUtil.getApplicationValue(maxTimes);
