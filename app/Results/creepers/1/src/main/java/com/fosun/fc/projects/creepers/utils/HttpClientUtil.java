...
public class HttpClientUtil {
 ...
 private  Map<String,CloseableHttpClient> clientPostPool;


public HttpRequestBase recvByteSupperManPost(String imgdata){
...
public HttpRequestBase getRequestByMethod(String method,Map<String,String> nameValuePairMap,String url){
...
public void supperManError(String imgid){
...
public String supperManPost(String imageData){
    CloseableHttpClient client = getCloseableHttpClient(BaseConstant.SUPPER_MAN_CLIENT);
    CloseableHttpResponse httpResponse = null;
...
public HttpRequestBase reportErrorSupperManPost(String imgid){
    Map<String, String> nameValuePairMap = new HashMap<String, String>();
    nameValuePairMap.put("username", "20161012");
    nameValuePairMap.put("password", "123456");
...
public CloseableHttpClient getCloseableHttpClient(String name){
