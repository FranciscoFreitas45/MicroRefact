...
public class ChromeGetImgSeleniumDownloader implements Closeable,Downloader{
...
public Page download(Request request,Task task){
    ...
    String imageValue = CommonMethodUtils.imageAnalytical(imagePath, BaseConstant.ImageAnalyticalType.FILE_PATH.getValue(), "http://shixin.court.gov.cn/image.jsp?date=" + sf.format(new Date()) + "%20GMT+0800%20(中国标准时间)");
