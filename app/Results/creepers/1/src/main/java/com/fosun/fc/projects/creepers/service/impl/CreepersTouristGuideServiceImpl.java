...
public class CreepersTouristGuideServiceImpl extends CreepersBaseServiceImplimplements ICreepersTouristGuideService{
...
public void processByParam(CreepersLoginParamDTO param){
    ...
    Spider.create(touristGuideProcessor).addPipeline(touristGuidePipline).addRequest(request).setDownloader(simulateLoginDownloader.setParam(param)).thread(1).run();
}
...
public Map<String,Object> findByParamForMap(CreepersLoginParamDTO param){
    ...
    if (StringUtils.isNotBlank(param.getSearchKeyWord(CreepersConstant.TCreepersTourGuideColumn.GUIDE_NO.getValue())) && StringUtils.isNotBlank(param.getSearchKeyWord(CreepersConstant.TCreepersTourGuideColumn.CARD_NO.getValue())) && StringUtils.isNotBlank(param.getSearchKeyWord(CreepersConstant.TCreepersTourGuideColumn.CERT_NO.getValue()))) {
        list = creepersTourGuideDao.findByGuideNoAndCardNoAndCertNo(param.getSearchKeyWord(CreepersConstant.TCreepersTourGuideColumn.GUIDE_NO.getValue()), param.getSearchKeyWord(CreepersConstant.TCreepersTourGuideColumn.CARD_NO.getValue()), param.getSearchKeyWord(CreepersConstant.TCreepersTourGuideColumn.CERT_NO.getValue()));
        ...
        list = creepersTourGuideDao.findByGuideNoAndCardNo(param.getSearchKeyWord(CreepersConstant.TCreepersTourGuideColumn.GUIDE_NO.getValue()), param.getSearchKeyWord(CreepersConstant.TCreepersTourGuideColumn.CARD_NO.getValue()));
        ...
        list = creepersTourGuideDao.findByGuideNoOrCertNo(param.getSearchKeyWord(CreepersConstant.TCreepersTourGuideColumn.GUIDE_NO.getValue()), param.getSearchKeyWord(CreepersConstant.TCreepersTourGuideColumn.CERT_NO.getValue()));
    } else if ((StringUtils.isBlank(param.getSearchKeyWord(CreepersConstant.TCreepersTourGuideColumn.GUIDE_NO.getValue())) || StringUtils.isBlank(param.getSearchKeyWord(CreepersConstant.TCreepersTourGuideColumn.CARD_NO.getValue()))) && StringUtils.isNotBlank(param.getSearchKeyWord(CreepersConstant.TCreepersTourGuideColumn.CERT_NO.getValue()))) {
    ...
    try {
        ...
        param.setErrorInfo("CreepersTouristGuideServiceImpl findByParamForMap error:" + e.getCause().getClass() + e.getCause().getMessage());
