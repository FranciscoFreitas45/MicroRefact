...
public class SimulateLoginDownloader extends AbstractDownloader{
 ...
 protected  CreepersLoginParamDTO param;
    ...
    try {
        ...
        if (statusAccept(acceptStatCode, statusCode)) {
            ...
            if (request.getUrl().equals(param.getOrderUrl(BaseConstant.OrderUrlKey.CAPTCHA_URL))) {
                ...
                return page;
            } else if (param.isDoRedirect() && ((statusCode == HttpStatus.SC_MOVED_TEMPORARILY) || (statusCode == HttpStatus.SC_MOVED_PERMANENTLY) || (statusCode == HttpStatus.SC_SEE_OTHER) || (statusCode == HttpStatus.SC_TEMPORARY_REDIRECT))) {
...
public HttpRequestBase getHttpRequest(Request request,Site site,Map<String,String> headers){
...
public HttpRequestBase getRequestByMethod(Request request){
...
public String getHtmlCharset(HttpResponse httpResponse,byte[] contentBytes){
    String charset;
    // charset
...
public boolean statusAccept(Set<Integer> acceptStatCode,int statusCode){
    return acceptStatCode.contains(statusCode);
}


public Page handleResponse(Request request,String charset,HttpResponse httpResponse,Task task){
