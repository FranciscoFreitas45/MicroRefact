...
public String list(int pageNumber,int pageSize,String sortType,Model model,String name){
    ...
    Page<CreepersTaxEvasionDTO> resultList = (Page<CreepersTaxEvasionDTO>) creepersTaxEvasionServiceImpl.findList(searchParams, pageNumber, pageSize, sortType);
...
public String queryInfo(int pageNumber,int pageSize,String sortType,Model model,String name){
    ...
    logger.info("========>查询参数：" + searchParams + "<========");
    Page<CreepersTaxEvasionDetailDTO> resultList = creepersTaxEvasionDetailServiceImpl.findList(searchParams, pageNumber, pageSize, sortType);
    model.addAttribute("resultList", resultList);
