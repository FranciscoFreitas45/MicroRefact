...
@Override
public Page<CreepersListTradeMarkDTO> queryListTradeMarkList(Map<String,Object> searchParams,int pageNumber,int pageSize,String sortType){
    ...
    Page<CreepersListTradeMarkDTO> resultPage = new PageImpl<CreepersListTradeMarkDTO>(new ArrayList<CreepersListTradeMarkDTO>(creepersListTradeMarkDTOList), pageable, listTradeMarkPage.getTotalElements());
    return resultPage;
}
