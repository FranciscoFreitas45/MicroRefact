...
import com.fosun.fc.projects.creepers.Interface.DishonestyAllProcessorImpl;
...
@Bean
public DishonestyAllProcessor dishonestyallprocessor(){

return  new DishonestyAllProcessorImpl(); 
    }
