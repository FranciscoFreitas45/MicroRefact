...
public Doctor getDoctor(Long userId){
 Doctor aux = restTemplate.getForObject("http://1/PatientWaitingAppointment/{id}/Doctor/getDoctor",Doctor.class,userId);
return aux;
}


public void setDoctor(Doctor doctor,Long userId){
 restTemplate.put("http://1/PatientWaitingAppointment/{id}/Doctor/setDoctor",doctor,userId);
 return ;
}
