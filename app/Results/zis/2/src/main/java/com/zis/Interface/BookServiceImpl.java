...
public BookinfoDetail findBookInfoDetailByBookId(Integer bookId){
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/findBookInfoDetailByBookId"))
    .queryParam("bookId",bookId)
;  BookinfoDetail aux = restTemplate.getForObject(builder.toUriString(), BookinfoDetail.class);
