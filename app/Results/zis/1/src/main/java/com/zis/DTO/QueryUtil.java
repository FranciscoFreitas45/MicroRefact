...
public QueryUtil<T> ne(String name,Object value){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/ne"))
...
public QueryUtil<T> desc(String name){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/desc"))
