...
public void init(){
    ...
    SSLContext sc = SSLContexts.custom().useTLS().loadTrustMaterial(trustStore, new AllTrustingTrustStrategy()).setSecureRandom(new java.security.SecureRandom()).build();
