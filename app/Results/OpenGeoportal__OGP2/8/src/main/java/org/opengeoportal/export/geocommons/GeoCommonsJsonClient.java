...
import org.opengeoportal.DTO.MetadataRetriever;
import org.opengeoportal.DTO.MetadataRetriever;
import org.opengeoportal.DTO.MetadataRetriever;
import org.opengeoportal.DTO.MetadataRetriever;
import org.opengeoportal.DTO.MetadataRetriever;
...
public CreateFileDataSetRequestJson createFileDataSetRequestObject(String layerId){
...
public String testUtf8(String s){
    try {
...
public CreateStreamDataSetRequestJson createStreamDataSetRequestObject(String layerId){
...
public CreateMapRequestJson createMapRequestObject(String basemap,String extent,String title,String description){
    ...
    // tags should be collated from layers in map
    createMapRequestJson.setTags(cleanString(this.getTagString(), 500));
    // System.out.println(this.getTagString());
    createMapRequestJson.setTitle(cleanString(title));
    // aggregate layer titles
    createMapRequestJson.setDescription(cleanString(description));
...
public String isoToUtf8(String s){
...
public void initializeClient(String username,String password){
    ...
    if (!(username.isEmpty() && password.isEmpty())) {
        ...
        final Registry<AuthSchemeProvider> authSchemeRegistry = RegistryBuilder.<AuthSchemeProvider>create().register("basic", new BasicSchemeFactory()).build();
...
public CreateUserRequestJson createUserRequestObject(String full_name,String login,String password,String password_confirmation,String email){
...
public void addLayerToMap(String mapId,DataSetStatus dataSetStatus){
    ...
    String url = this.serverName + "/maps/" + mapId + "/layers.json";
    ...
    String ogpLayerName = /*layerInfoMap.getWorkspaceName().trim() + ":" +*/
    layerInfoMap.getName().trim();
...
public Metadata createLayerInfoObject(String layerId){
    ...
    layerInfo.setBounds(Double.toString(layerInfoMap.getMinX()), Double.toString(layerInfoMap.getMinY()), Double.toString(layerInfoMap.getMaxX()), Double.toString(layerInfoMap.getMaxY()));
