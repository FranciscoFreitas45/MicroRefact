...
public Envelope parseLonLatEnvelope(Node lonLatEnvelopeNode){
...
public RectifiedGrid parseRectifiedGrid(Node rgNode){
...
public List<String> parseSupportedFormats(Node formatNode){
...
public List<String> parseSupportedInterpolations(Node interpNode){
    return OgpXmlUtils.getChildValuesList(interpNode, "interpolationMethod");
}


public List<String> parseKeywords(Node keywordsNode){
...
public List<String> parseSupportedCrs(Node crsNode){
