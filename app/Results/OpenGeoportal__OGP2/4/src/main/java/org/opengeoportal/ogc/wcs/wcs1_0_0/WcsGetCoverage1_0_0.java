...
public Boolean supports(List<String> supportedList,String testValue){
...
public String createWcsGetCoverageRequest(String layerName,CoverageOffering1_0_0 coverageOffering,BoundingBox bounds,int epsgCode,String outputFormat){
    ...
    String getCoverageRequest = "service=WCS&version=" + VERSION + "&request=GetCoverage&coverage=" + layerName + "&bbox=" + OgpUtils.referencedEnvelopeToString(result) + "&crs=" + coverageOffering.getSupportedCRSs().get(0) + "&format=" + outputFormat;
...
public String generateSize(RectifiedGrid rgrid){
