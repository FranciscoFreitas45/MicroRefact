...
import org.opengeoportal.DTO.ProxyConfigRetriever;
...
public void setBaseQuery(String format,String bbox,String srs,int height,int width){
...
public void downloadLayerImages(ImageRequest imageRequest){
    setBaseQuery(imageRequest.getFormat(), imageRequest.getBbox(), imageRequest.getSrs(), imageRequest.getHeight(), imageRequest.getWidth());
...
public UUID registerRequest(String sessionId,ImageRequest imageRequest){
...
public void populateImageRequest(ImageRequest imageRequest){
...
public void populateLayerUrl(LayerImage layerImage){
