...
public class Wfs1_1DownloadMethod extends AbstractDownloadMethodimplements PerLayerDownloadMethod{
...
public String createDownloadRequest(){
    ...
    // we are filtering the bounds based on WGS84
    int epsgCode = 4326;
...
public OwsInfo getWfsDescribeLayerInfo(){
    ...
    try {
        ...
        // check content type before doing any parsing of xml?
        logger.info(this.httpRequester.getContentType());
