...
public class WmsDownloadMethod extends AbstractDownloadMethodimplements PerLayerDownloadMethod{
...
The currently recognized format options are:
    ...
    String getFeatureRequest = "SERVICE=WMS&VERSION=1.1.1&REQUEST=GetMap&SRS=epsg:" + epsgCode + "&BBOX=" + bounds.toString() + "&LAYERS=" + layerName + "&HEIGHT=" + requestDimensions.get("height") + "&WIDTH=" + requestDimensions.get("width") + "&FORMAT=" + format;
...
public Map<String,String> calculateDimensions(Double aspectRatio){
    String requestWidth;
