...
public List<WorkflowDTO> findOwnerTasks(String employeeId){
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/findOwnerTasks"))
    .queryParam("employeeId",employeeId)
;  List<WorkflowDTO> aux = restTemplate.getForObject(builder.toUriString(), List<WorkflowDTO>.class);
...
public ProcessInstance getProcessInstanceByTaskId(String taskId){
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/getProcessInstanceByTaskId"))
    .queryParam("taskId",taskId)
;  ProcessInstance aux = restTemplate.getForObject(builder.toUriString(), ProcessInstance.class);
...
public ProcessInstance getProcessInstanceById(String processInstanceId){
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/getProcessInstanceById"))
