...
public void modifyUserInfo(UserInfo modifiedUser){
    repository.setUserInfoById(modifiedUser.getFirstName(), modifiedUser.getLastName(), modifiedUser.getBirthday(), modifiedUser.getEmail(), modifiedUser.getStatus(), modifiedUser.getProfilePhoto(), modifiedUser.getHometown(), modifiedUser.getUserid());
}
