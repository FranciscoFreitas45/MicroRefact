...
public class ChatroomCreationDTO extends BaseDTO{
 ...
 private  List<IStringValidator> ACCESS_METHOD_VALIDATORS;

 private  List<IStringValidator> PRIVILEGE_VALIDATORS;
...
public void registerNumberValidator(INumberValidator newValidator,ValidationScopes scope){
    switch(scope) {
        case RANGE:
