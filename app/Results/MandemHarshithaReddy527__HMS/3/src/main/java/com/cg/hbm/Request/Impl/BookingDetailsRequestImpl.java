...
public void setBookingdetails(BookingDetails bookingdetails,int booking_id){
 restTemplate.put("http://1/Payments/{id}/BookingDetails/setBookingdetails",bookingdetails,booking_id);
 return ;
}


public BookingDetails getBookingdetails(int booking_id){
 BookingDetails aux = restTemplate.getForObject("http://1/Payments/{id}/BookingDetails/getBookingdetails",BookingDetails.class,booking_id);
return aux;
}
