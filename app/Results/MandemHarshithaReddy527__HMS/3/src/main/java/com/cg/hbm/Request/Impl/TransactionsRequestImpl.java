...
public void setTransactions(Transactions transactions,int transaction_id){
 restTemplate.put("http://2/Payments/{id}/Transactions/setTransactions",transactions,transaction_id);
 return ;
}


public Transactions getTransactions(int transaction_id){
 Transactions aux = restTemplate.getForObject("http://2/Payments/{id}/Transactions/getTransactions",Transactions.class,transaction_id);
return aux;
}
