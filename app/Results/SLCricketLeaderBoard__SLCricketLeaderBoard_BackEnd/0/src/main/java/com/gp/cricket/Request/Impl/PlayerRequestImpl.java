...
public void setPlayerId(Player playerId,Integer playerIdv2){
 restTemplate.put("http://1/BallerScore/{id}/Player/setPlayerId",playerId,playerIdv2);
 return ;
}


public Player getPlayerId(Integer playerIdv2){
 Player aux = restTemplate.getForObject("http://1/BallerScore/{id}/Player/getPlayerId",Player.class,playerIdv2);
return aux;
}
