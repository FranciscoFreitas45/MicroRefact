...
public void setClubId(Club clubId,Integer clubIdv2){
 restTemplate.put("http://8/TournamentClub/{id}/Club/setClubId",clubId,clubIdv2);
 return ;
}


public Club getClubId(Integer clubIdv2){
 Club aux = restTemplate.getForObject("http://8/TournamentClub/{id}/Club/getClubId",Club.class,clubIdv2);
return aux;
}
