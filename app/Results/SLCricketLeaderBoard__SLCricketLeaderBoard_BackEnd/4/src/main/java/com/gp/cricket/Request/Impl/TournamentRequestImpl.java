...
public void setTournamentId(Tournament tournamentId,Integer tournamentIdv2){
 restTemplate.put("http://10/TournamentClub/{id}/Tournament/setTournamentId",tournamentId,tournamentIdv2);
 return ;
}


public Tournament getTournamentId(Integer tournamentIdv2){
 Tournament aux = restTemplate.getForObject("http://10/TournamentClub/{id}/Tournament/getTournamentId",Tournament.class,tournamentIdv2);
return aux;
}
