...
public User getUserId(Integer userIdv2){
 User aux = restTemplate.getForObject("http://5/Sponsor/{id}/User/getUserId",User.class,userIdv2);
return aux;
}


public void setUserId(User userId,Integer userIdv2){
 restTemplate.put("http://5/Sponsor/{id}/User/setUserId",userId,userIdv2);
 return ;
}
