...
public Page queryWebsite(WcWebsite webSite){
    ...
    StringBuilder sql = new StringBuilder("	select  " + "WCS_ID,			WCS_WEBSITE_NAME,	" + "		WCS_APP_NAME,			WCS_APP_ID,			WCS_APP_SECRET, " + "WCS_REDIRECT_URL,			WCS_TOKEN, " + "WCS_ADMIN_ID,		WCS_TYPE,	WCS_REGISTOR, " + "WCS_REGISTDATE " + "	from WC_WEBSITE a where 1=1 ");
