...
public Page queryShopMenu(WcShopMenu menu){
    ...
    StringBuilder sql = new StringBuilder(" select a.WSM_ID,a.WSM_NAME,a.WSM_URL,a.WSM_LEVEL,a.WSM_ORDER,a.WSM_DESC,a.WSM_PARENT_ID,a.WSM_REGISTOR,a.WSM_REGIST_DATE, b.WSM_NAME parent_menu " + " from WC_SHOP_MENU a " + " left join WC_SHOP_MENU b on a.WSM_PARENT_ID = b.WSM_ID " + " where 1 = 1 ");
    StringBuilder sqlCnt = new StringBuilder(" select count(*) from WC_SHOP_MENU a where 1 = 1 ");
