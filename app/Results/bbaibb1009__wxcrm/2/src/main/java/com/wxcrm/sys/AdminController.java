...
public String queryAdmin(WcAdmin admin,Model model){
...
public String adminLogin(WcAdmin admin,HttpServletResponse response,HttpSession session,Model model,String usernameCookie,String pwdMd5Cookie,String pwd3desCookie,String rediUriCookie){
    ...
    if (adminResult == null) {
        ...
        // session��ŵ�ǰ�Ĺ���Ա��Ϣ
        session.setAttribute(SysConstant.ADMIN_INFO, adminResult);
...
public String goUrl(Integer menuId1,Integer menuId2,Integer menuId3,String url,HttpSession session){
...
public void adminLogout(HttpServletResponse response,HttpSession session){
    session.invalidate();
...
public String toUpdAdmin(WcAdmin admin_Q,Model model){
...
public String toAddAdmin(WcAdmin admin,Model model){
