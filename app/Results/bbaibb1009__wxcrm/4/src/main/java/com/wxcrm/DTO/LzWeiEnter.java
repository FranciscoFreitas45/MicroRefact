...
public void setWecEnterId(Integer wecEnterId){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWecEnterId"))

.queryParam("wecEnterId",wecEnterId)
;
...
public void setWecStatus(String wecStatus){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWecStatus"))

.queryParam("wecStatus",wecStatus)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWecRegistor(Integer wecRegistor){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWecRegistor"))

.queryParam("wecRegistor",wecRegistor)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWecEnterName_Q(String wecEnterName_Q){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWecEnterName_Q"))

.queryParam("wecEnterName_Q",wecEnterName_Q)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWecCusType(String wecCusType){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWecCusType"))

.queryParam("wecCusType",wecCusType)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWecDefaultMsgDesc(String wecDefaultMsgDesc){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWecDefaultMsgDesc"))

.queryParam("wecDefaultMsgDesc",wecDefaultMsgDesc)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWecSubscribeMsgDesc(String wecSubscribeMsgDesc){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWecSubscribeMsgDesc"))

.queryParam("wecSubscribeMsgDesc",wecSubscribeMsgDesc)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setListKeyWords(List<Map<String,Object>> listKeyWords){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setListKeyWords"))

.queryParam("listKeyWords",listKeyWords)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setWecRegistdate(String wecRegistdate){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWecRegistdate"))

.queryParam("wecRegistdate",wecRegistdate)
;
restTemplate.put(builder.toUriString(),null);
}
