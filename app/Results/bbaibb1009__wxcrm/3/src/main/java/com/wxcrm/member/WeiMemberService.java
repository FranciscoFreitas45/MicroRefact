...
public LzWeiMember getWeiMemberByOpenId(String openid,String appId){
    // TODO Auto-generated method stub
    String sql = " select a.WMB_ID from LZ_WEI_MEMBER a join LZ_WEI_ENTER b on a.WMB_WEC_ID = b.WEC_ID " + " where a.WMB_OPENID = ? and b.WEC_APP_ID = ? ";
    log.error("(((((((((((((((((((((((((((((((((((((((((");
    log.error(sql);
...
public void addWeiMember(LzWeiMember member){
    // TODO Auto-generated method stub
    log.error("�ɹ����һ����¼:" + hibernateDao.add(member));
}
...
public Page queryWeiMember(LzWeiMember member){
    // TODO Auto-generated method stub
    // openid
    String wmbOpenid_Q = member.getWmbOpenid_Q();
    // ��Ա����
    String wmbType_Q = member.getWmbType_Q();
    // ��Ա����
    String wmbName_Q = member.getWmbName_Q();
    // �ֻ���
    String wmbMobule_Q = member.getWmbMobule_Q();
    Integer wecId_Q = member.getWmbWecId_Q();
    if (wecId_Q == null) {
        wecId_Q = 0;
    }
    List<Object> paraList = new ArrayList<Object>();
    StringBuilder sql = new StringBuilder(" select a.WMB_ID,a.WMB_WEC_ID,a.WMB_CARD_ID,a.WMB_OPENID,a.WMB_TYPE,a.WMB_NAME," + "a.WMB_MOBULE,a.WMB_STATUS,a.WMB_DESC,a.WMB_REGISTOR,a.WMB_REGISTDATE,a.WEB_WCS_ID,b.WEC_APP_NAME,c.WCS_WEBSITE_NAME,d.WAD_NAME ");
    StringBuilder sqlCnt = new StringBuilder(" select count(*) ");
    StringBuilder sqlConf = new StringBuilder(" from LZ_WEI_MEMBER a " + " left join LZ_WEI_ENTER b on b.WEC_ID =a.WMB_WEC_ID " + " left join WC_WEBSITE c on c.WCS_ID =a.WEB_WCS_ID  " + " left join WC_ADMIN d on d.WAD_ID = a.WMB_REGISTOR  " + " where 1=1  ");
    if (wecId_Q > 0) {
