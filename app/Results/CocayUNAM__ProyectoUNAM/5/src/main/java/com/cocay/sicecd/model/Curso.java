...
public void setGrupos(List<Grupo> grupos){
 gruporequest.setGrupos(grupos,this.pk_id_curso);
}



public void setCertificados(List<Certificado> certificados){
 certificadorequest.setCertificados(certificados,this.pk_id_curso);
}
...
public List<Certificado> getCertificados(){
  this.certificados = certificadorequest.getCertificados(this.pk_id_curso);
...
public void setFk_id_grupo(Grupo fk_id_grupo){
 gruporequest.setFk_id_grupo(fk_id_grupo,this.pk_id_curso);
}
...
public List<Grupo> getGrupos(){
  this.grupos = gruporequest.getGrupos(this.pk_id_curso);
return this.grupos;
}
...
public Grupo getFk_id_grupo(){
  this.grupos = gruporequest.getFk_id_grupo(this.pk_id_curso);
return this.grupos;
}
