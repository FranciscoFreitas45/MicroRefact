...
public Profesor getFk_id_profesor(int pk_id_profesor){
 Profesor aux = restTemplate.getForObject("http://0/Grupo/{id}/Profesor/getFk_id_profesor",Profesor.class,pk_id_profesor);
return aux;
}


public void setFk_id_profesor(Profesor fk_id_profesor,int pk_id_profesor){
 restTemplate.put("http://0/Grupo/{id}/Profesor/setFk_id_profesor",fk_id_profesor,pk_id_profesor);
 return ;
}
