...
@RequestMapping("/edit")
@Menu(type = "admin", subtype = "sysdic")
public ModelAndView edit(ModelMap map,HttpServletRequest request,String id,String p){
...
@Menu(type = "admin", subtype = "sysdic")
public ModelAndView dicitemupdate(HttpServletRequest request,SysDic dic,String p){
...
@Menu(type = "admin", subtype = "sysdic")
public ModelAndView dicitemsave(HttpServletRequest request,SysDic dic,String p){
    List<SysDic> sysDicList = sysDicRes.findByParentidAndName(dic.getParentid(), dic.getName());
    String msg = null;
...
@RequestMapping("/save")
@Menu(type = "admin", subtype = "sysdic")
public ModelAndView save(HttpServletRequest request,SysDic dic){
...
@Menu(type = "admin", subtype = "sysdic")
public ModelAndView dicitemadd(ModelMap map,HttpServletRequest request,String id,String p){
    map.addAttribute("sysDic", sysDicRes.findById(id));
    map.addAttribute("p", p);
...
@Menu(type = "admin", subtype = "sysdic")
public ModelAndView dicitembatsave(ModelMap map,HttpServletRequest request,SysDic sysDic,String content,String p){
    String msg = "";
...
@Menu(type = "admin", subtype = "sysdic")
public ModelAndView update(HttpServletRequest request,SysDic dic,String p){
    List<SysDic> sysDicList = sysDicRes.findByCodeOrName(dic.getCode(), dic.getName());
    if (sysDicList.size() == 0 || (sysDicList.size() == 1 && sysDicList.get(0).getId().equals(dic.getId()))) {
        SysDic sysDic = sysDicRes.findById(dic.getId());
        sysDic.setName(dic.getName());
...
@Menu(type = "admin", subtype = "sysdic")
public ModelAndView delete(ModelMap map,HttpServletRequest request,String id,String p){
...
@Menu(type = "admin", subtype = "sysdic")
public ModelAndView dicitem(ModelMap map,HttpServletRequest request,String id,String msg){
...
public void reloadSysDicItem(SysDic dic,HttpServletRequest request){
...
@Menu(type = "admin", subtype = "sysdic")
public ModelAndView dicitemedit(ModelMap map,HttpServletRequest request,String id,String p){
...
@Menu(type = "admin", subtype = "sysdic")
public ModelAndView dicitembatadd(ModelMap map,HttpServletRequest request,String id,String p){
    SysDic dic = sysDicRes.findById(id);
    map.addAttribute("sysDic", dic);
    map.addAttribute("root", sysDicRes.findById(dic.getDicid()));
    map.addAttribute("p", p);
...
@Menu(type = "admin", subtype = "sysdic")
public ModelAndView dicitemdelete(ModelMap map,HttpServletRequest request,String id,String p){
    sysDicRes.delete(sysDicRes.findByDicid(id));
    SysDic dic = sysDicRes.findById(id);
