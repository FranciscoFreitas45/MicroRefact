...
@RequestMapping("/save")
@Menu(type = "admin", subtype = "area")
public ModelAndView save(HttpServletRequest request,AreaType area){
...
public ModelAndView update(HttpServletRequest request,AreaType area){
...
@Menu(type = "admin", subtype = "area")
public ModelAndView delete(HttpServletRequest request,AreaType area){
    AreaType areaType = areaRepository.findByIdAndOrgi(area.getId(), super.getOrgi(request));
    if (areaType != null) {
