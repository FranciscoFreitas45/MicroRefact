...
@RequestMapping("/test")
@Menu(type = "setting", subtype = "database", admin = true)
public ModelAndView test(ModelMap map,HttpServletRequest request,Database db){
...
@RequestMapping("/save")
@Menu(type = "setting", subtype = "database", admin = true)
public ModelAndView quickreplysave(ModelMap map,HttpServletRequest request,Database db){
...
@Menu(type = "setting", subtype = "database", admin = true)
public ModelAndView quickreplyupdate(ModelMap map,HttpServletRequest request,Database db){
    if (!StringUtils.isBlank(db.getId())) {
...
@Menu(type = "setting", subtype = "database", admin = true)
public ModelAndView quickreplydelete(ModelMap map,HttpServletRequest request,Database db){
