...
public ModelAndView startentim(ModelMap map,HttpServletRequest request){
...
public ModelAndView stopimserver(ModelMap map,HttpServletRequest request,String confirm){
...
public ModelAndView stop(ModelMap map,HttpServletRequest request,String confirm){
    boolean execute = false;
    if (execute = UKTools.secConfirm(secRes, super.getOrgi(request), confirm)) {
        server.stop();
        UKDataContext.setIMServerStatus(false);
...
public ModelAndView stopentim(ModelMap map,HttpServletRequest request){
...
public ModelAndView save(ModelMap map,HttpServletRequest request,SystemConfig config,BindingResult result,MultipartFile keyfile,MultipartFile loginlogo,MultipartFile consolelogo,MultipartFile favlogo,Secret secret){
...
public ModelAndView index(ModelMap map,HttpServletRequest request,String execute){
