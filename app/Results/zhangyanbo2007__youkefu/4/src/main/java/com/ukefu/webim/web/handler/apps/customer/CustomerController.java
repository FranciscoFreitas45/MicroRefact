...
public ModelAndView add(ModelMap map,HttpServletRequest request,String ekind){
...
public ModelAndView week(ModelMap map,HttpServletRequest request,String q,String ekind){
...
public ModelAndView enterprise(ModelMap map,HttpServletRequest request,String q,String ekind){
    BoolQueryBuilder boolQueryBuilder = QueryBuilders.boolQuery();
...
@Menu(type = "customer", subtype = "customer")
public ModelAndView impsave(ModelMap map,HttpServletRequest request,MultipartFile cusfile,String ekind){
...
@RequestMapping("/save")
@Menu(type = "customer", subtype = "customer")
public ModelAndView save(HttpServletRequest request,CustomerGroupForm customerGroupForm){
...
public ModelAndView index(ModelMap map,HttpServletRequest request,String q,String ekind,String msg){
    BoolQueryBuilder boolQueryBuilder = QueryBuilders.boolQuery();
    if (!StringUtils.isBlank(q)) {
        map.put("q", q);
    }
...
@Menu(type = "customer", subtype = "customer")
public ModelAndView update(HttpServletRequest request,CustomerGroupForm customerGroupForm){
    EntCustomer customer = entCustomerRes.findOne(customerGroupForm.getEntcustomer().getId());
    // 记录 数据变更 历史
    List<PropertiesEvent> events = PropertiesEventUtils.processPropertiesModify(request, customerGroupForm.getEntcustomer(), customer, "id", "orgi", "creater", "createtime", "updatetime");
    if (events.size() > 0) {
...
public ModelAndView personal(ModelMap map,HttpServletRequest request,String q,String ekind){
    BoolQueryBuilder boolQueryBuilder = QueryBuilders.boolQuery();
...
@Menu(type = "customer", subtype = "customer")
public ModelAndView delete(HttpServletRequest request,EntCustomer entCustomer,String p){
    if (entCustomer != null) {
...
@RequestMapping("/imp")
@Menu(type = "customer", subtype = "customer")
public ModelAndView imp(ModelMap map,HttpServletRequest request,String ekind){
    map.addAttribute("ekind", ekind);
...
public ModelAndView today(ModelMap map,HttpServletRequest request,String q,String ekind){
    BoolQueryBuilder boolQueryBuilder = QueryBuilders.boolQuery();
    if (!StringUtils.isBlank(q)) {
        map.put("q", q);
    }
...
public ModelAndView creater(ModelMap map,HttpServletRequest request,String q,String ekind){
    BoolQueryBuilder boolQueryBuilder = QueryBuilders.boolQuery();
...
@Menu(type = "customer", subtype = "customer")
public ModelAndView batdel(ModelMap map,HttpServletRequest request,HttpServletResponse response,String[] ids,String ekind){
    if (ids != null && ids.length > 0) {
