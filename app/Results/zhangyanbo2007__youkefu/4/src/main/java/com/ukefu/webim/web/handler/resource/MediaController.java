...
public void voice(HttpServletResponse response,String id){
...
public void file(HttpServletResponse response,HttpServletRequest request,String id){
...
public ModelAndView upload(ModelMap map,HttpServletRequest request,MultipartFile imgFile){
...
public void index(HttpServletResponse response,String id){
    File file = new File(path, id);
...
@Menu(type = "resouce", subtype = "voice", access = true)
public void voiceplay(HttpServletResponse response,HttpServletRequest request,String type,String id){
...
@RequestMapping("/url")
@Menu(type = "resouce", subtype = "image", access = true)
public void url(HttpServletResponse response,String url){
    byte[] data = new byte[1024];
    int length = 0;
