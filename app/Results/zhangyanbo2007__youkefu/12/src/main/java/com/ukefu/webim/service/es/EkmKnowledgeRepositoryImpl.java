...
public Page<EkmKnowledge> processQuery(BoolQueryBuilder boolQueryBuilder,Pageable page){
...
public Page<EkmKnowledge> findByKnowledge(BoolQueryBuilder boolQueryBuilder,boolean datastatus,List<String> ekmKnowledgeType,String orgi,User user,Pageable pageable){
    ...
    // 审核通过
    boolQueryBuild.must(termQuery("pubstatus", UKDataContext.PubStatusEnum.PASS.toString()));
