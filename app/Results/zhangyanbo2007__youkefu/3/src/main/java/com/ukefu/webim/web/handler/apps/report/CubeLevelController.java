...
public ModelAndView cubeLeveladd(ModelMap map,HttpServletRequest request,String cubeid,String dimid){
...
@RequestMapping("/save")
@Menu(type = "report", subtype = "cubelevel")
public ModelAndView cubeLevelsave(ModelMap map,HttpServletRequest request,CubeLevel cubeLevel,String tableid){
...
@Menu(type = "report", subtype = "cubelevel", admin = true)
public ModelAndView quickreplyupdate(ModelMap map,HttpServletRequest request,CubeLevel cubeLevel,String tableid){
...
@Menu(type = "report", subtype = "cubelevel", admin = true)
public ModelAndView fktableid(ModelMap map,HttpServletRequest request,String tableid){
    if (!StringUtils.isBlank(tableid)) {
