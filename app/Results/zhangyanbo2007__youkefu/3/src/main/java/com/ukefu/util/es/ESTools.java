...
public void mapping(MetadataTable tb,String orgi){
    log.info(tb.getTablename() + " ORGI : " + orgi + " Mapping Not Exists , Waiting Form init ......");
    XContentBuilder builder = jsonBuilder().startObject().startObject(tb.getTablename().toLowerCase()).startObject("properties");
...
public boolean checkMapping(String tb,String orgi){
