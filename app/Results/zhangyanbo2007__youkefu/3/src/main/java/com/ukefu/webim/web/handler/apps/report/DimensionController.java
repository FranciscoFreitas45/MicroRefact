...
public ModelAndView dimensionsave(ModelMap map,HttpServletRequest request,Dimension dimension){
...
@Menu(type = "report", subtype = "dimension", admin = true)
public ModelAndView quickreplyupdate(ModelMap map,HttpServletRequest request,Dimension dimension){
...
@RequestMapping("/add")
@Menu(type = "report", subtype = "dimension")
public ModelAndView dimensionadd(ModelMap map,HttpServletRequest request,String cubeid){
    map.addAttribute("cubeid", cubeid);
    map.addAttribute("fkfieldList", cubeMetadataRes.findByCubeidAndMtype(cubeid, "0"));
