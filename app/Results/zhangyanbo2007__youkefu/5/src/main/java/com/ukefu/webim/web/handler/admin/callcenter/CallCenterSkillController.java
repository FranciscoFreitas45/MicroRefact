...
public ModelAndView skillsave(ModelMap map,HttpServletRequest request,CallCenterSkill skill){
...
@Menu(type = "callcenter", subtype = "callcenterresource", access = false, admin = true)
public ModelAndView skilladd(ModelMap map,HttpServletRequest request,String hostid){
...
public ModelAndView skillextentionsave(ModelMap map,HttpServletRequest request,SkillExtention skillExtention,String hostid,String[] exts){
...
public PbxHost getPbxHost(List<PbxHost> pbxHostList,String hostid){
...
@Menu(type = "callcenter", subtype = "extention", access = false, admin = true)
public ModelAndView skillimp(ModelMap map,HttpServletRequest request,String hostid){
    if (!StringUtils.isBlank(hostid)) {
        map.put("pbxHost", pbxHostRes.findByIdAndOrgi(hostid, super.getOrgi(request)));
...
@Menu(type = "callcenter", subtype = "callcenterresource", access = false, admin = true)
public ModelAndView extentiondelete(ModelMap map,HttpServletRequest request,String id){
...
@Menu(type = "callcenter", subtype = "callcenterresource", access = false, admin = true)
public ModelAndView skillupdate(ModelMap map,HttpServletRequest request,CallCenterSkill skill){
...
@Menu(type = "callcenter", subtype = "extention", access = false, admin = true)
public ModelAndView skillextentiondelete(ModelMap map,HttpServletRequest request,String id,String hostid){
...
@Menu(type = "callcenter", subtype = "callcenterresource", access = false, admin = true)
public ModelAndView skilledit(ModelMap map,HttpServletRequest request,String id,String hostid){
    CallCenterSkill skill = null;
