...
public ModelAndView pbxhostupdate(ModelMap map,HttpServletRequest request,PbxHost pbxHost){
...
@Menu(type = "callcenter", subtype = "pbxhost", access = false, admin = true)
public ModelAndView pbxhostedit(ModelMap map,HttpServletRequest request,String id){
...
@Menu(type = "callcenter", subtype = "pbxhost", access = false, admin = true)
public ModelAndView pbxhostsave(ModelMap map,HttpServletRequest request,PbxHost pbxHost){
    ModelAndView view = request(super.createRequestPageTempletResponse("redirect:/admin/callcenter/pbxhost.html"));
    String msg = null;
...
@Menu(type = "callcenter", subtype = "pbxhost", access = false, admin = true)
public ModelAndView mediadelete(ModelMap map,HttpServletRequest request,String id){
