...
public ModelAndView pbxhostupdate(ModelMap map,HttpServletRequest request,Acl acl){
...
@Menu(type = "callcenter", subtype = "acl", access = false, admin = true)
public ModelAndView aclsave(ModelMap map,HttpServletRequest request,Acl acl){
...
@Menu(type = "callcenter", subtype = "acl", access = false, admin = true)
public ModelAndView acledit(ModelMap map,HttpServletRequest request,String id,String hostid){
...
public ModelAndView acl(ModelMap map,HttpServletRequest request,String hostid){
...
@Menu(type = "callcenter", subtype = "acl", access = false, admin = true)
public ModelAndView acladd(ModelMap map,HttpServletRequest request,String hostid){
    map.put("pbxHost", pbxHostRes.findByIdAndOrgi(hostid, super.getOrgi(request)));
...
@Menu(type = "callcenter", subtype = "acl", access = false, admin = true)
public ModelAndView acldelete(ModelMap map,HttpServletRequest request,String id,String hostid){
