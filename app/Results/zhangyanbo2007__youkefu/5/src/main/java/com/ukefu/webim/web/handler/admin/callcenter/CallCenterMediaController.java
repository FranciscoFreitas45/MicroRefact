...
public ModelAndView play(ModelMap map,HttpServletRequest request,String id,String hostid){
...
public ModelAndView mediaadd(ModelMap map,HttpServletRequest request,String hostid){
...
@Menu(type = "callcenter", subtype = "media", access = false, admin = true)
public ModelAndView mediaedit(ModelMap map,HttpServletRequest request,String id,String hostid){
    map.addAttribute("media", mediaRes.findByIdAndOrgi(id, super.getOrgi(request)));
    map.put("pbxHost", pbxHostRes.findByIdAndOrgi(hostid, super.getOrgi(request)));
...
@Menu(type = "callcenter", subtype = "media", access = false, admin = true)
public ModelAndView mediasave(ModelMap map,HttpServletRequest request,MultipartFile mediafile){
...
@Menu(type = "callcenter", subtype = "media", access = false, admin = true)
public ModelAndView pbxhostupdate(ModelMap map,HttpServletRequest request,MultipartFile mediafile){
    Media media = new Media();
    media.setName(request.getParameter("name"));
    media.setHostid(request.getParameter("hostid"));
...
public ModelAndView media(ModelMap map,HttpServletRequest request,String hostid){
...
@Menu(type = "callcenter", subtype = "media", access = false, admin = true)
public ModelAndView mediadelete(ModelMap map,HttpServletRequest request,String id,String hostid){
