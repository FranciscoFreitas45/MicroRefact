...
public ModelAndView ivr(ModelMap map,HttpServletRequest request,String hostid){
...
@Menu(type = "callcenter", subtype = "callcenterivr", access = false, admin = true)
public ModelAndView ivrmenuadd(ModelMap map,HttpServletRequest request,String id,String hostid,String parentid){
    map.addAttribute("extention", extentionRes.findByIdAndOrgi(id, super.getOrgi(request)));
