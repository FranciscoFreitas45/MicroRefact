...
public ModelAndView routercodeupdate(ModelMap map,HttpServletRequest request,RouterRules router){
...
@Menu(type = "callcenter", subtype = "extention", access = false, admin = true)
public ModelAndView conditionsave(ModelMap map,HttpServletRequest request,RouteItem item){
    if (item != null) {
    }
...
@Menu(type = "callcenter", subtype = "extention", access = false, admin = true)
public ModelAndView extentionsave(ModelMap map,HttpServletRequest request,RouterRules router){
...
@Menu(type = "callcenter", subtype = "extention", access = false, admin = true)
public ModelAndView pbxhostupdate(ModelMap map,HttpServletRequest request,RouterRules router){
...
public ModelAndView design(ModelMap map,HttpServletRequest request,String hostid,String id){
...
@Menu(type = "callcenter", subtype = "callcenterivr", access = false, admin = true)
public ModelAndView conditionadd(ModelMap map,HttpServletRequest request,String id,String hostid,String parentid){
    if (!StringUtils.isBlank(hostid)) {
        map.addAttribute("pbxHost", pbxHostRes.findByIdAndOrgi(hostid, super.getOrgi(request)));
    }
...
@Menu(type = "callcenter", subtype = "callcenterivr", access = false, admin = true)
public ModelAndView actionadd(ModelMap map,HttpServletRequest request,String id,String hostid,String parentid){
    if (!StringUtils.isBlank(hostid)) {
        map.addAttribute("pbxHost", pbxHostRes.findByIdAndOrgi(hostid, super.getOrgi(request)));
    }
...
@Menu(type = "callcenter", subtype = "extention", access = false, admin = true)
public ModelAndView actionsave(ModelMap map,HttpServletRequest request,RouteItem item){
    if (item != null) {
    }
    return request(super.createRequestPageTempletResponse("redirect:/admin/callcenter//router/design.html?hostid=" + item.getHostid() + "&id=" + item.getRouteid()));
}
...
@Menu(type = "callcenter", subtype = "extention", access = false, admin = true)
public ModelAndView routercode(ModelMap map,HttpServletRequest request,String id,String hostid){
    map.addAttribute("routerRules", routerRulesRes.findByIdAndOrgi(id, super.getOrgi(request)));
    map.put("pbxHost", pbxHostRes.findByIdAndOrgi(hostid, super.getOrgi(request)));
...
@Menu(type = "callcenter", subtype = "extention", access = false, admin = true)
public ModelAndView routeredit(ModelMap map,HttpServletRequest request,String id,String hostid){
    map.addAttribute("routerRules", routerRulesRes.findByIdAndOrgi(id, super.getOrgi(request)));
    map.put("pbxHost", pbxHostRes.findByIdAndOrgi(hostid, super.getOrgi(request)));
