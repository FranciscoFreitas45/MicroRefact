...
public interface QualityMissionRepository extends JpaRepository<QualityMission, String>{
...
public Page<QualityMission> findAll(Specification<QualityMission> spec,Pageable page)
;
