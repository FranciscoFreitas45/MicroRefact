...
public class ExifUtils {
 ...
 private  String EXIF_MAGIC_STRING;
...
public Orientation getExifOrientation(ImageReader reader,int imageIndex){
...
public IfdStructure readIFD(byte[] ifd,ByteOrder bo){
...
public Orientation getOrientationFromExif(byte[] exifData){
