...
public ModelAndView area(ModelMap map,HttpServletRequest request,String id,String aiid){
...
public ModelAndView knowledgedelete(HttpServletRequest request,String id,String type,String aiid){
...
public ModelAndView knowledgeadd(ModelMap map,HttpServletRequest request,String type,String aiid){
    map.put("type", type);
    map.put("aiid", aiid);
...
public ModelAndView knowledgeupdate(HttpServletRequest request,Topic topic,String type,String aiid){
...
public ModelAndView knowledgeedit(ModelMap map,HttpServletRequest request,String id,String type,String aiid){
    map.put("type", type);
    if (!StringUtils.isBlank(id)) {
...
public ModelAndView impsave(ModelMap map,HttpServletRequest request,MultipartFile cusfile,String type,String aiid){
...
public ModelAndView knowledgesave(HttpServletRequest request,Topic topic,String type,String aiid){
    if (!StringUtils.isBlank(topic.getTitle())) {
        if (!StringUtils.isBlank(type)) {
            topic.setCate(type);
        } else {
...
public ModelAndView knowledgetypeupdate(HttpServletRequest request,KnowledgeType type,String aiid){
...
@Menu(type = "xiaoe", subtype = "knowledge")
public void expall(ModelMap map,HttpServletRequest request,HttpServletResponse response,String q,String type,String aiid){
...
@Menu(type = "xiaoe", subtype = "knowledgedelete")
public ModelAndView knowledgetypedelete(HttpServletRequest request,String id,String type,String aiid){
...
@Menu(type = "xiaoe", subtype = "knowledge")
public ModelAndView imp(ModelMap map,HttpServletRequest request,String type,String aiid){
...
public ModelAndView knowledgetypesave(HttpServletRequest request,KnowledgeType type,String aiid){
...
@Menu(type = "xiaoe", subtype = "knowledge")
public void expids(ModelMap map,HttpServletRequest request,HttpServletResponse response,String[] ids,String aiid){
...
public ModelAndView areaupdate(HttpServletRequest request,KnowledgeType type,String aiid){
    KnowledgeType temp = knowledgeTypeRes.findByIdAndOrgi(type.getId(), super.getOrgi(request));
    if (temp != null) {
...
public ModelAndView knowledgetypeadd(ModelMap map,HttpServletRequest request,String type,String aiid){
...
public ModelAndView knowledgetypeedit(ModelMap map,HttpServletRequest request,String type,String aiid){
...
@Menu(type = "xiaoe", subtype = "knowledge")
public ModelAndView batdelete(ModelMap map,HttpServletRequest request,HttpServletResponse response,String[] ids,String type,String aiid){
    if (ids != null && ids.length > 0) {
        Iterable<Topic> topicList = topicRes.findAll(Arrays.asList(ids));
...
@Menu(type = "xiaoe", subtype = "knowledge")
public ModelAndView knowledge(ModelMap map,HttpServletRequest request,String q,String type,String aiid){
    List<KnowledgeType> knowledgeTypeList = knowledgeTypeRes.findByOrgiAndTypeid(super.getOrgi(request), "0");
    map.put("knowledgeTypeList", knowledgeTypeList);
