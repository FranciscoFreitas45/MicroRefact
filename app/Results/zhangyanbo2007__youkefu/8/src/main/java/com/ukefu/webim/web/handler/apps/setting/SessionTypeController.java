...
public ModelAndView add(ModelMap map,HttpServletRequest request,String typeCode){
...
@RequestMapping("/edit")
@Menu(type = "apps", subtype = "sessiontype")
public ModelAndView edit(ModelMap map,HttpServletRequest request,String id,String p,String typeCode){
...
@Menu(type = "apps", subtype = "sessiontype")
public ModelAndView dicitemupdate(ModelMap map,HttpServletRequest request,SessionType ses,String p,String typeCode){
...
@Menu(type = "apps", subtype = "sessiontype")
public ModelAndView dicitemsave(ModelMap map,HttpServletRequest request,SessionType ses,String p,String typeCode){
...
@RequestMapping("/save")
@Menu(type = "apps", subtype = "sessiontype")
public ModelAndView save(ModelMap map,HttpServletRequest request,SessionType ses,String typeCode){
    List<SessionType> sesList = sessionTypeRes.findByCodeOrName(ses.getCode(), ses.getName());
    String msg = null;
    if (sesList.size() == 0) {
        ses.setCtype(typeCode);
...
@Menu(type = "apps", subtype = "sessiontype")
public ModelAndView dicitemadd(ModelMap map,HttpServletRequest request,String id,String p,String typeCode){
    map.addAttribute("sessiontype", sessionTypeRes.findById(id));
    map.addAttribute("p", p);
    map.addAttribute("typeCode", typeCode);
...
@Menu(type = "apps", subtype = "sessiontype")
public ModelAndView dicitembatsave(ModelMap map,HttpServletRequest request,SessionType ses,String content,String p,String typeCode){
...
@Menu(type = "apps", subtype = "sessiontype")
public ModelAndView index(ModelMap map,HttpServletRequest request,String typeCode){
...
@Menu(type = "apps", subtype = "sessiontype")
public ModelAndView update(ModelMap map,HttpServletRequest request,SessionType ses,String p,String typeCode){
    List<SessionType> sesList = sessionTypeRes.findByCodeOrName(ses.getCode(), ses.getName());
    if (sesList.size() == 0 || (sesList.size() == 1 && sesList.get(0).getId().equals(ses.getId()))) {
        SessionType session = sessionTypeRes.findById(ses.getId());
        session.setName(ses.getName());
...
@Menu(type = "apps", subtype = "sessiontype")
public ModelAndView delete(ModelMap map,HttpServletRequest request,String id,String p,String typeCode){
...
@Menu(type = "apps", subtype = "sessiontype")
public ModelAndView dicitem(ModelMap map,HttpServletRequest request,String id,String typeCode){
    map.addAttribute("sessiontype", sessionTypeRes.findById(id));
...
@Menu(type = "apps", subtype = "sessiontype")
public ModelAndView dicitemedit(ModelMap map,HttpServletRequest request,String id,String p,String typeCode){
    map.addAttribute("sessiontype", sessionTypeRes.findById(id));
    map.addAttribute("p", p);
    map.addAttribute("typeCode", typeCode);
...
@Menu(type = "apps", subtype = "sessiontype")
public ModelAndView dicitembatadd(ModelMap map,HttpServletRequest request,String id,String p,String typeCode){
    map.addAttribute("sessiontype", sessionTypeRes.findById(id));
    map.addAttribute("p", p);
    map.addAttribute("typeCode", typeCode);
...
@Menu(type = "apps", subtype = "sessiontype")
public ModelAndView dicitemdelete(ModelMap map,HttpServletRequest request,String id,String p,String typeCode){
    List<SessionType> sesList = sessionTypeRes.findByOrgiAndDicid(super.getOrgi(request), id);
