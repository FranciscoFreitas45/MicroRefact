...
public ModelAndView trace(ModelMap map,HttpServletRequest request,String sessionid){
...
public ModelAndView getSessionType(ModelMap map,HttpServletRequest request,String sesid,String userid,String agentservice,String channel){
    // 文字客服
...
@Menu(type = "service", subtype = "online", admin = false)
public ModelAndView getSessionMemo(ModelMap map,HttpServletRequest request,String sesid,String userid,String agentservice,String channel){
...
@Menu(type = "service", subtype = "online", admin = false)
public ModelAndView saveSessionMemo(ModelMap map,HttpServletRequest request,String sesid,String userid,String agentservice,String channel,String memo){
    AgentService agentService = agentServiceRes.findByIdAndOrgi(agentservice, super.getOrgi(request));
    if (agentService != null) {
...
public ModelAndView index(ModelMap map,HttpServletRequest request,String userid,String agentservice,String channel){
    if (!StringUtils.isBlank(userid)) {
        ...
        if (agentServiceList.getContent().size() > 0) {
            map.put("serviceCount", Integer.valueOf(this.agentServiceRes.countByUseridAndOrgiAndStatus(userid, super.getOrgi(request), UKDataContext.AgentUserStatusEnum.END.toString())));
...
@Menu(type = "service", subtype = "online", admin = false)
public ModelAndView saveSessionType(ModelMap map,HttpServletRequest request,String sesid,String userid,String agentservice,String channel){
    AgentService agentService = agentServiceRes.findByIdAndOrgi(agentservice, super.getOrgi(request));
    if (agentService != null) {
