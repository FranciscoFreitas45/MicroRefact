...
public ModelAndView xiaoeHis(ModelMap map,HttpServletRequest request,String username,String channel,String servicetype,String skill,String agent,String servicetimetype,String begin,String end,String sbegin,String send){
...
public ModelAndView transfersave(ModelMap map,HttpServletRequest request,String id,String agentno,String memo){
...
public ModelAndView leavemsg(ModelMap map,HttpServletRequest request,String id){
    if (!StringUtils.isBlank(id)) {
...
public void aiExpall(ModelMap map,HttpServletResponse response,HttpServletRequest request,String username,String channel,String servicetype,String skill,String agent,String servicetimetype,String begin,String end,String sbegin,String send){
    final String orgi = super.getOrgi(request);
    Page<AgentService> page = agentServiceRes.findAll(new Specification<AgentService>() {
...
@Menu(type = "callcenter", subtype = "callcenter")
public void aiexpall(ModelMap map,HttpServletRequest request,HttpServletResponse response){
    ...
    response.setHeader("content-disposition", "attachment;filename=UCKeFu-AgentService-History-" + new SimpleDateFormat("yyyy-MM-dd").format(new Date()) + ".xls");
...
@Menu(type = "callcenter", subtype = "callcenter")
public void aiExpsearch(ModelMap map,HttpServletResponse response,HttpServletRequest request,String username,String channel,String servicetype,String skill,String agent,String servicetimetype,String begin,String end,String sbegin,String send){
    final String orgi = super.getOrgi(request);
    Page<AgentService> page = agentServiceRes.findAll(new Specification<AgentService>() {
...
public ModelAndView index(ModelMap map,HttpServletRequest request,String username,String channel,String servicetype,String skill,String agent,String servicetimetype,String begin,String end,String sbegin,String send){
    final String orgi = super.getOrgi(request);
    Page<AgentService> page = agentServiceRes.findAll(new Specification<AgentService>() {
...
public ModelAndView currentinvite(ModelMap map,HttpServletRequest request,String id){
    if (!StringUtils.isBlank(id)) {
        AgentService agentService = agentServiceRes.findByIdAndOrgi(id, super.getOrgi(request));
        if (agentService != null) {
...
public ModelAndView clean(ModelMap map,HttpServletRequest request,String id){
...
@Menu(type = "callcenter", subtype = "callcenter")
public void expall(ModelMap map,HttpServletResponse response,HttpServletRequest request,String username,String channel,String servicetype,String skill,String agent,String servicetimetype,String begin,String end,String sbegin,String send){
    final String orgi = super.getOrgi(request);
    Page<AgentService> page = agentServiceRes.findAll(new Specification<AgentService>() {
...
@Menu(type = "callcenter", subtype = "callcenter")
public void aiExpids(ModelMap map,HttpServletRequest request,HttpServletResponse response,String[] ids){
...
public ModelAndView offline(ModelMap map,HttpServletRequest request,String id){
...
public void getAiChatMessageExcel(HttpServletResponse response,List<ChatMessage> chatList){
    ...
    response.setHeader("content-disposition", "attachment;filename=UCKeFu-ChatMessage-Content-" + new SimpleDateFormat("yyyy-MM-dd").format(new Date()) + ".xls");
    ExcelExporterProcess excelProcess = new ExcelExporterProcess(values, table, response.getOutputStream());
    excelProcess.process();
}
...
@Menu(type = "service", subtype = "current", admin = true)
public ModelAndView end(ModelMap map,HttpServletRequest request,String id){
    if (!StringUtils.isBlank(id)) {
        AgentService agentService = agentServiceRes.findByIdAndOrgi(id, super.getOrgi(request));
        if (agentService != null) {
            User user = super.getUser(request);
...
@Menu(type = "callcenter", subtype = "callcenter")
public void chatExpall(ModelMap map,HttpServletRequest request,HttpServletResponse response){
...
public ModelAndView invite(ModelMap map,HttpServletRequest request,String id){
    AgentUser agentUser = agentUserRes.findByIdAndOrgi(id, super.getOrgi(request));
    if (agentUser != null && agentUser.getStatus().equals(UKDataContext.AgentUserStatusEnum.INQUENE.toString())) {
...
@Menu(type = "service", subtype = "current", admin = true)
public ModelAndView trans(ModelMap map,HttpServletRequest request,String id){
    if (!StringUtils.isBlank(id)) {
        AgentService agentService = agentServiceRes.findByIdAndOrgi(id, super.getOrgi(request));
