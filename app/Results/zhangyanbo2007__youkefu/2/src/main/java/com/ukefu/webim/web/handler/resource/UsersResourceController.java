...
public ModelAndView add(ModelMap map,HttpServletRequest request,String q,String id){
    if (q == null) {
        q = "";
    }
...
@Menu(type = "res", subtype = "users")
public ModelAndView organ(ModelMap map,HttpServletRequest request,String q,String ids){
...
public Page<User> getUsers(HttpServletRequest request,String q){
    if (q == null) {
        q = "";
    }
    Page<User> list = null;
...
@Menu(type = "res", subtype = "users")
public ModelAndView bpmusers(ModelMap map,HttpServletRequest request,String q,String id){
    if (q == null) {
        q = "";
    }
    map.addAttribute("usersList", getUsers(request, q));
