...
public void setUsession(String usession){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setUsession"))

.queryParam("usession",usession)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setCalltype(String calltype){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setCalltype"))

.queryParam("calltype",calltype)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setContextid(String contextid){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setContextid"))
