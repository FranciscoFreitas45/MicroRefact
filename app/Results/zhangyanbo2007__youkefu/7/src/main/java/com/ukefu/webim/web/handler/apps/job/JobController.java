...
public ModelAndView save(HttpServletRequest request,JobTask taskinfo,Boolean plantask,String id){
...
public ModelAndView setting(ModelMap map,HttpServletRequest request,String id){
    JobDetail detail = jobRes.findByIdAndOrgi(id, super.getOrgi(request));
