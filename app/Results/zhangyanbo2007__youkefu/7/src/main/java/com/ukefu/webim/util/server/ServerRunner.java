...
public class ServerRunner implements CommandLineRunner{
 ...
 private  SocketIONamespace entIMSocketIONameSpace;

 private  SocketIONamespace aiIMSocketIONameSpace;

 private  SocketIONamespace callCenterSocketIONameSpace;
...
public void run(String args){
    server.start();
    // IMServer 启动成功
    UKDataContext.setIMServerStatus(true);
}
