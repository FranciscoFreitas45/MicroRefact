...
@Menu(type = "notice", subtype = "noticebus")
public ModelAndView checkitem(ModelMap map,HttpServletRequest request,String target,boolean ischecked,String noticeid,String[] targets){
...
@Menu(type = "notice", subtype = "noticebus")
public ModelAndView search(ModelMap map,HttpServletRequest request,String stype,String q,String organ,String noticeid){
    final String orgi = super.getOrgi(request);
...
@Menu(type = "notice", subtype = "noticebus")
public ModelAndView sendlist(ModelMap map,HttpServletRequest request,String id,String organ,String noticeid,String type){
...
@Menu(type = "notice", subtype = "noticebus")
public ModelAndView addsave(ModelMap map,HttpServletRequest request,Notice notice,MultipartFile[] files,String type){
...
@Menu(type = "notice", subtype = "noticebus")
public ModelAndView sendlistsave(ModelMap map,HttpServletRequest request,String noticeid,boolean sysms,boolean sms,boolean mail,String type){
...
@Menu(type = "notice", subtype = "noticebus")
public ModelAndView editsave(ModelMap map,HttpServletRequest request,String id,Notice notice){
...
@Menu(type = "notice", subtype = "noticebus")
public ModelAndView delete(ModelMap map,HttpServletRequest request,String id,String type){
...
@Menu(type = "notice", subtype = "noticebus")
public ModelAndView batdelete(ModelMap map,HttpServletRequest request,String[] ids,String type){
