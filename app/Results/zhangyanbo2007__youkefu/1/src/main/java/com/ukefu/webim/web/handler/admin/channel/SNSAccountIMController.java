...
public ModelAndView save(HttpServletRequest request,SNSAccount snsAccount){
...
@Menu(type = "admin", subtype = "im", access = false, admin = true)
public ModelAndView update(HttpServletRequest request,SNSAccount snsAccount){
...
public ModelAndView delete(ModelMap map,HttpServletRequest request,String id,String confirm){
