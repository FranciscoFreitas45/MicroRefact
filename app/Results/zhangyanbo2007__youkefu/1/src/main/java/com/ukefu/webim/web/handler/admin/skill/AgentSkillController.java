...
@RequestMapping("/save")
@Menu(type = "admin", subtype = "skill")
public ModelAndView save(HttpServletRequest request,Skill skill){
...
@Menu(type = "admin", subtype = "skill")
public ModelAndView index(ModelMap map,HttpServletRequest request,String skill){
...
@Menu(type = "admin", subtype = "skill")
public ModelAndView update(HttpServletRequest request,Skill skill){
...
@Menu(type = "admin", subtype = "skill")
public ModelAndView delete(HttpServletRequest request,Skill skill){
