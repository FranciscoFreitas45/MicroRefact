...
public void setDept(Dept dept){
 deptrequest.setDept(dept,this.deptId);
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/"+ userId).concat("/setDept"))
...
public void setPosition(Position position){
 positionrequest.setPosition(position,this.id);
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/"+ userId).concat("/setPosition"))
