...
public User getUser(Long userId){
 User aux = restTemplate.getForObject("http://12/LoginRecord/{id}/User/getUser",User.class,userId);
return aux;
}


public void setUser(User user,Long userId){
 restTemplate.put("http://12/LoginRecord/{id}/User/setUser",user,userId);
 return ;
}
