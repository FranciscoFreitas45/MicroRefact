...
public Blog() {
    ...
    this.content = content;
    this.keybody = keybody;
}public Blog(Integer tid, String title, String intro, String content, String img, Date time, Integer userid, Integer type, String keybody) {
    super();
    this.tid = tid;
    this.title = title;
    this.intro = intro;
...
public String toString(){
    return "Blog [tid=" + tid + ", title=" + title + ", intro=" + intro + ", content=" + content + ", img=" + img + ", time=" + time + ", userid=" + userid + ", type=" + type + ", keybody=" + keybody + "]";
}
