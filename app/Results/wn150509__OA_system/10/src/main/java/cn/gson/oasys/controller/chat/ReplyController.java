...
public String voteHandle(HttpServletRequest req,Long userId,Model model){
...
public String replyPaging(HttpServletRequest req,Long selecttype,Long selectsort,int page,int size,Long userId,Model model){
...
public String replyDelete(HttpServletRequest req,int page,int size,Long userId,Model model){
    User user = uDao.findOne(userId);
    System.out.println(size);
    Long num = Long.parseLong(req.getParameter("num"));
...
public String reply(HttpServletRequest req,int page,int size,Long userId,Model model){
    System.out.println(size);
    Long num = null;
    Long discussId = Long.parseLong(req.getParameter("replyId"));
    // 用来判断是保存在哪个表
...
public String likeUserLoad(HttpServletRequest req,Model model,Long userId){
    Long replyId = Long.parseLong(req.getParameter("replyId"));
    String module = req.getParameter("module");
