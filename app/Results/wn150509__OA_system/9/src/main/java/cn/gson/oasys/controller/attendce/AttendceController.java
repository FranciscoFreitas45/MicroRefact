...
public void signsortpaging(HttpServletRequest request,Model model,HttpSession session,int page,String baseKey,String type,String status,String time,String icon){
...
public String testdf(HttpServletRequest request,Model model,HttpSession session,int page,String baseKey,String type,String status,String time,String icon){
...
public String test(HttpServletRequest request,Model model,HttpSession session,int page,String baseKey,String type,String status,String time,String icon){
...
public String testdasf(HttpServletRequest request,HttpSession session,int page,String baseKey,String type,String status,String time,String icon,Model model){
...
public void allsortpaging(HttpServletRequest request,HttpSession session,int page,String baseKey,String type,String status,String time,String icon,Model model){
    setSomething(baseKey, type, status, time, icon, model);
    Long userId = Long.parseLong(session.getAttribute("userId") + "");
    List<Long> ids = new ArrayList<>();
...
public String Datag(HttpSession session,Model model,HttpServletRequest request){
    // 首先获取ip
    InetAddress ia = null;
    ia = ia.getLocalHost();
...
public String test2(HttpServletRequest request,Model model,HttpSession session,int page,String baseKey){
...
public String test3(HttpServletRequest request,HttpSession session,int page,String baseKey){
...
public String dsaf(HttpServletRequest request,HttpSession session,int page,String baseKey){
    weektablepaging(request, session, page, baseKey);
...
public String table(HttpServletRequest request,HttpSession session,int page,String baseKey,String type,String status,String time,String icon,Model model){
    allsortpaging(request, session, page, baseKey, type, status, time, icon, model);
...
public String dfshe(HttpServletRequest request,Model model,HttpSession session,int page,String baseKey){
    monthtablepaging(request, model, session, page, baseKey);
