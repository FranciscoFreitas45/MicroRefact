...
public String select(HttpServletRequest request,Long userId,Model model,int page,int size){
    String title = null;
...
public ModelAndView index3(HttpServletRequest req,Long userId,int page,int size){
...
public String index(Model model,Long userId,int page,int size){
    // 通过发布人id找用户
    User tu = udao.findOne(userId);
    // 根据发布人id查询任务
...
public ModelAndView index2(Long userId,int page,int size){
    Pageable pa = new PageRequest(page, size);
...
public String index5(Long userId,Model model,int page,int size){
    Pageable pa = new PageRequest(page, size);
...
public String delete(HttpServletRequest req,Long userId){
    // 得到任务的 id
    String taskid = req.getParameter("id");
    Long ltaskid = Long.parseLong(taskid);
    // 根据任务id找出这条任务
...
public String mydelete(HttpServletRequest req,Long userId){
    // 用户id
    // 得到任务的 id
    String taskid = req.getParameter("id");
    Long ltaskid = Long.parseLong(taskid);
...
public ModelAndView myseetask(HttpServletRequest req,Long userId){
...
public String updatelo(Tasklogger logger,Long userId){
...
public String tasklogger(Tasklogger logger,Long userId){
    User userlist = udao.findOne(userId);
    logger.setCreateTime(new Date());
...
public String addtask(Long userId,HttpServletRequest request){
    User userlist = udao.findOne(userId);
