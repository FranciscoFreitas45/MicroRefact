...
public User getUserId(Long userIdv2){
 User aux = restTemplate.getForObject("http://12/NoticeUserRelation/{id}/User/getUserId",User.class,userIdv2);
return aux;
}


public void setUserId(User userId,Long userIdv2){
 restTemplate.put("http://12/NoticeUserRelation/{id}/User/setUserId",userId,userIdv2);
 return ;
}
