...
public String inform(int page,Long userId,Model model){
...
public String testMess(HttpServletRequest req,NoticesList menu,BindingResult br){
...
public String forwardOther(Long userId,Long noticeId){
...
public String infromList(HttpSession session,HttpServletRequest req,Model model,int page){
    Long userId = Long.parseLong(session.getAttribute("userId") + "");
