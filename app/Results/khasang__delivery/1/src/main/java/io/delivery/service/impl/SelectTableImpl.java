...
public String selectTable(){
    String query = "SELECT id, name, CASE " + " WHEN ((id>=50) and (id<60)) THEN 'fifty'" + " WHEN ((id>=60) and (id<70)) THEN 'sixty'" + " WHEN ((id>=70) and (id<80)) THEN 'seventy'" + " END FROM Users " + " WHERE id > 50";
