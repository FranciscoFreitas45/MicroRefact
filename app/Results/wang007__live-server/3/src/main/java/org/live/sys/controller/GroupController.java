...
@ResponseBody
public ResponseModel<Object> deleteGroupById(String groupId){
    ResponseModel<Object> model = new SimpleResponseModel<Object>();
    try {
...
@ResponseBody
public ResponseModel<Object> findGroupInfoByGroupId(String groupId){
    ResponseModel<Object> model = new SimpleResponseModel<Object>();
    try {
...
@ResponseBody
public ResponseModel<Object> updateGroupisEnable(String groupId){
    ResponseModel<Object> model = new SimpleResponseModel<Object>();
    try {
