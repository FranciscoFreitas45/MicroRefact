...
public void buildGroupList2(List<List<Map<String,Object>>> gLists,List<Map<String,Object>> listMap2){
...
public void buildGroupList(List<List<Map<String,Object>>> gLists,List<Map<String,Object>> listMap2,List<String> xAxis_data){
    for (Map<String, Object> map : listMap2) {
...
public void buildBarOrLineType2Sum(StringBuilder sbWhere,String type1,String type2,SysDbmsChartDimension info,Map<String,Object> map,String tableName){
...
public void buildBarOrLineType3Sum(StringBuilder sbWhere,String type1,String type2,String type3,SysDbmsChartDimension info,Map<String,Object> map,String tableName){
    StringBuilder sql = new StringBuilder();
    Map<String, Object> param = new HashMap<>();
    List<Map<String, Object>> series_data = new ArrayList<>();
...
public void buildBarOrLineType1(StringBuilder sbWhere,String type1,SysDbmsChartDimension info,Map<String,Object> map,String tableName){
    StringBuilder sql = new StringBuilder();
    Map<String, Object> param = new HashMap<>();
...
public void buildBarOrLineType1Sum(StringBuilder sbWhere,String type1,SysDbmsChartDimension info,Map<String,Object> map,String tableName){
    StringBuilder sql = new StringBuilder();
    Map<String, Object> param = new HashMap<>();
...
public void buildBarOrLineType3(StringBuilder sbWhere,String type1,String type2,String type3,SysDbmsChartDimension info,Map<String,Object> map,String tableName){
    StringBuilder sql = new StringBuilder();
    Map<String, Object> param = new HashMap<>();
    List<Map<String, Object>> series_data = new ArrayList<>();
...
public void buildBarOrLineType2(StringBuilder sbWhere,String type1,String type2,SysDbmsChartDimension info,Map<String,Object> map,String tableName){
    StringBuilder sql = new StringBuilder();
    Map<String, Object> param = new HashMap<>();
    List<Map<String, Object>> series_data = new ArrayList<>();
