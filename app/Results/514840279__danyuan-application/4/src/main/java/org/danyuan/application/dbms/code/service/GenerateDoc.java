...
public class GenerateDoc {
 ...
 static  String dataList2;


@SuppressWarnings({ "resource", "deprecation" })
public void generateXls(SysDbmsGenerateCodeInfo sysDbmsGenerateCodeInfo,SysDbmsTabsInfo tabsInfo,List<SysDbmsTabsColsInfo> colsInfos,String username,String pathString) throws IOException{
...
@SuppressWarnings({ "resource", "deprecation" })
public void generateXlsx(SysDbmsGenerateCodeInfo sysDbmsGenerateCodeInfo,SysDbmsTabsInfo tabsInfo,List<SysDbmsTabsColsInfo> colsInfos,String username,String pathString) throws IOException{
    File file = new File(pathString);
...
public void setDataValidationList(int j,int k,int l,int m,String data,XSSFSheet sheet){
    // 设置下拉列表的内容
...
public XSSFSheet copySheet(XSSFSheet sheetFrom,XSSFSheet sheetTo){
    // 初期化
