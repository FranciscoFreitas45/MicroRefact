...
public String uploadFile(String url,File file) throws ClientProtocolException{
...
public String postJson(String url,Map<String,String> map,String encoding) throws ParseException{
    String body = "";
    // 创建httpclient对象
...
public String post(String url,Map<String,String> map,String encoding) throws ParseException{
    String body = "";
    // 创建httpclient对象
    CloseableHttpClient client = HttpClients.createDefault();
    // 创建post方式请求对象
...
public String get(String url,Map<String,String> map,String encoding){
    // 获取连接客户端工具
