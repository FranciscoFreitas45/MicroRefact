...
public class StringUtils {
 ...
 private  CharSet allowedFileName;

 private  CharSet allowedMailAddress;

 private  CharSet allowedPassword;

 private  CharSet alphaNumChar;
...
public String[] getSplitArray(String str){
    String[] strarry = str.replaceAll("[ |~|!|?|，|-|(|)|{|}|`|\\|]|[|/|	]", ",").split(",");
    return strarry;
}


public String toUpcaseFirstChar(String s){
    // 如果s是null或者s=""的情况不考虑
    if (s.length() == 1) {
        s = s.toUpperCase();
    } else {
...
public String digitalUnitDisplay(BigDecimal digital){
...
public String null2Other(String chkVal,String rtnVal){
...
public String[] getSFZH(String SFZH){
...
public String trim(String orgstr){
...
public boolean isAnnualRate(String str){
...
public String converHtml(String str){
    // 判断是否为空或者是空
    if (isNullOrNone(str)) {
        return "";
    }
...
public String genRandomNumByLen(int numLen){
    final int maxNum = 10;
    // 生成的随机数
    int i;
    // 生成的密码的长度
...
public String regexpSJHM(String s){
...
public boolean isAsciiAlphaNumCharOnly(String str){
...
public String getSFZH15(String SFZH18){
...
public String endString(String srcStr,String strdivision){
    return endString(srcStr, strdivision, false);
}


public String getSFZH18(String SFZH15){
...
public String getPeriodDisplayValue(String periodType){
    String str = "";
...
public String genRandomNum(int pwdLen){
...
public String replaceNum(String strNum){
    if (null != strNum) {
...
public boolean isVistaData(String str){
...
public String callWriteXmlString(Document doc,String encoding){
    try {
...
public String regexp_substr(String input,String regexp){
...
public String toInputValue(String str){
    if (null == str) {
        return "";
    } else {
        return str.replace("\"", "&#34;");
...
public boolean isRechargeAmount(String str){
    String regex = "^(\\d{1,5}|100000)0{2}$";
    return match(regex, str);
}


public String substrb(String str,int cutLength){
...
public String null2Empty(String chkVal){
    return null2Other(chkVal, "");
}


public boolean isAllowedMailAddress(String mailAddress){
...
public boolean isSettingNum(String str){
...
public boolean isPermillage(String str){
    // String regex = "^[1-9][0-9]?(\\.\\d)?$";
    // String regex = "^[1-9][0-9]?([.]{1}[0-9]{1,2}){0,1}$";
...
public String replaceStr(String strInput,String strBefore,String strAfter){
...
public long to_number(String str) throws NumberFormatException{
    return Long.parseLong(str);
}


public String getBFB(Object fz,Object fm){
    String str = "0.00%";
...
public boolean isPasswordStrength(String str){
    String regex = "^(?![0-9]+$)(?![a-zA-Z]+$)(?![`~!@#$%^&*()_+=\\\\|{}\\[\\]'\":;,.<>/?-]+$)[`~!@#$%^&*()_+=\\\\|{}\\[\\]'\":;,.<>/?0-9a-zA-Z-]{6,20}$";
    return match(regex, str);
}


public String getUTF8(String string) throws UnsupportedEncodingException{
...
public String genPaymentPassword(){
    return genRandomNum(8);
}


public String getRequestStr(HttpServletRequest request) throws IOException{
...
public boolean isIdCard(String IDStr){
...
public boolean checkIp(String ip,String ipStart,String ipEnd){
    // 将IP地址转化成数字，直接进行比较
...
public String regexpSFZH(String s){
...
public boolean isInArray(String[] arr,String val){
...
public boolean isNullOrNone(String srcStr){
    // 判断源字符串是否为空或者""
...
public String digitToChinese(int str){
    switch(str) {
        case 1:
            return "一";
        case 2:
