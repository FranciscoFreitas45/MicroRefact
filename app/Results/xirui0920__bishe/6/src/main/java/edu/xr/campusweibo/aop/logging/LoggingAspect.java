package edu.xr.campusweibo.aop.logging;
...
@Pointcut("within(edu.xr.campusweibo.repository..*) || within(edu.xr.campusweibo.service..*) || within(edu.xr.campusweibo.web.rest..*)")
