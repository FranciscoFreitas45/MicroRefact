...
public void setProduct(Product product,Integer id){
 restTemplate.put("http://3/Store/{id}/Product/setProduct",product,id);
 return ;
}


public Product getProduct(Integer id){
 Product aux = restTemplate.getForObject("http://3/Store/{id}/Product/getProduct",Product.class,id);
return aux;
}
