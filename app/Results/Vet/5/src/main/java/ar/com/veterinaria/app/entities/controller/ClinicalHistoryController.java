...
@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful retrieval of Breed List", response = ClinicalHistory.class), @ApiResponse(code = 500, message = "Internal server error") })
...
public ResponseEntity<ClinicalHistory> getById(int id){
    try {
...
@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful retrieval of ClinicalHistory List", response = ClinicalHistory.class), @ApiResponse(code = 500, message = "Internal server error") })
public ResponseEntity<ClinicalHistory> create(ClinicalHistory clinicalHistory){
    try {
...
@ApiResponses({ @ApiResponse(code = 200, message = "OK"), @ApiResponse(code = 403, message = "Operation is forbidden"), @ApiResponse(code = 500, message = "Server error") })
public ResponseEntity<ClinicalHistory> update(int id,ClinicalHistory clinicalHistory){
    try {
        clinicalHistoryService.isValidInputData(clinicalHistory);
