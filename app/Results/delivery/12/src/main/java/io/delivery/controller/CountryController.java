...
@ResponseBody
public CountryInfoContainer getCountryByCurrency(String currencyName){
...
@ResponseBody
public CountryInfoContainer getCurrencyByCountry(String country){
    CountryInfoContainer countryInfoContainer = new CountryInfoContainer();
...
@ResponseBody
public CountryInfoContainer getCountyByCountryCode(String code){
...
@ResponseBody
public CountryInfoContainer getCountryByCurrencyCode(String currencyCode){
    CountryInfoContainer countryInfoContainer = new CountryInfoContainer();
