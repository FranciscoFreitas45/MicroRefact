...
public class FileUtils {
 ...
 public  String DENIED_FILE_EXT;


public boolean mkDirs(String dirName){
...
public void main(String[] args){
    ...
    // copyFile("h:\\xmlbean.txt", "h:\\test2.txt");
    String url = "http://www.baidu.com";
    String toFile = "e:/xmlbean.html";
    url = "http://www.baidu.com/img/baidu_logo.gif";
    toFile = "e:/xmlbean.gif";
    // url =
    // "http://localhost:8080/mis/docCommon/downloadByAttachmentId.do?attachmentId=1591&secondDir=";
    // toFile = "e:/xmlbean.mht";
    // ImageUtils.getUrlFile(url,null);
    FileUtils.getUrlFile(url, toFile);
}
...
public boolean checkFileExt(String fileName){
    ...
    if (!StringHelper.isEmpty(fileExt)) {
        return ("," + DENIED_FILE_EXT + ",").indexOf("," + fileExt.toLowerCase() + ",") == -1;
    }
    return true;
}
