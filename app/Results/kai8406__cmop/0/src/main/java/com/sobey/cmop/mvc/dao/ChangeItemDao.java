...
public List<ChangeItem> findByChangeId(Integer changeId)
;

public List<ChangeItem> findByChangeIdAndFieldNameOrderByIdDesc(Integer changeId,String fieldName)
;
