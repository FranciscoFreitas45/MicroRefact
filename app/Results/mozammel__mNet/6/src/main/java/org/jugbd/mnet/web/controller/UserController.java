...
public String save(User user,BindingResult result,RedirectAttributes redirectAttrs){
    if (result.hasErrors()) {
        return "user/create";
    }
...
public String update(User user,BindingResult result,RedirectAttributes redirectAttrs){
