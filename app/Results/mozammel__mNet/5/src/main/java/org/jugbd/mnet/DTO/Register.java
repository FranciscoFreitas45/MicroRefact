...
public void setPictureInformation(PictureInformation pictureInformation){
 pictureinformationrequest.setPictureInformation(pictureInformation,this.id);
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/"+ id).concat("/setPictureInformation"))

.queryParam("pictureInformation",pictureInformation)
;
