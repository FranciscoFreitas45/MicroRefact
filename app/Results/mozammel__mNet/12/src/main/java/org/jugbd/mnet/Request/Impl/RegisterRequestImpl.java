...
public void setRegister(Register register,Long id){
 restTemplate.put("http://3/LifeStyle/{id}/Register/setRegister",register,id);
 return ;
}


public Register getRegister(Long id){
 Register aux = restTemplate.getForObject("http://3/LifeStyle/{id}/Register/getRegister",Register.class,id);
return aux;
}
