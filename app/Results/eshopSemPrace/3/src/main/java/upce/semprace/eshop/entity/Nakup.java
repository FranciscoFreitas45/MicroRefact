...
public void setUzivatel(Uzivatel uzivatel){
 uzivatelrequest.setUzivatel(uzivatel,this.uzivatel_id);
}
...
public void setDoprava(Doprava doprava){
 dopravarequest.setDoprava(doprava,this.doprava_id);
}



public Doprava getDoprava(){
  this.doprava = dopravarequest.getDoprava(this.doprava_id);
return this.doprava;
}


public Platba getPlatba(){
  this.platba = platbarequest.getPlatba(this.platba_id);
return this.platba;
}


public Uzivatel getUzivatel(){
  this.uzivatel = uzivatelrequest.getUzivatel(this.uzivatel_id);
...
public void setPlatba(Platba platba){
 platbarequest.setPlatba(platba,this.platba_id);
}
