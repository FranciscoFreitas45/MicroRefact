...
@Column(name = "nakoupenaPolozka_id")
 private Long nakoupenaPolozka_id;
...
public void setNakoupenaPolozka(NakoupenaPolozka nakoupenaPolozka){
 nakoupenapolozkarequest.setNakoupenaPolozka(nakoupenaPolozka,this.nakoupenaPolozka_id);
}
...
public NakoupenaPolozka getNakoupenaPolozka(){
  this.nakoupenaPolozka = nakoupenapolozkarequest.getNakoupenaPolozka(this.nakoupenaPolozka_id);
