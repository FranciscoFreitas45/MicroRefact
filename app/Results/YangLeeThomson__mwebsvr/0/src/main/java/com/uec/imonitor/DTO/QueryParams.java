...
public void setAggsParams(AggsTermParams aggsParams){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setAggsParams"))

.queryParam("aggsParams",aggsParams)
;
...
public void setHistogramParams(AggsHistogramParams histogramParams){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setHistogramParams"))

.queryParam("histogramParams",histogramParams)
;
restTemplate.put(builder.toUriString(),null);
}
