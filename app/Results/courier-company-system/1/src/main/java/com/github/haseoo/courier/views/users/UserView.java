...
public UserView of(UserData userData){
    return UserView.builder().id(userData.getId()).active(userData.getActive()).username(userData.getUserName()).userType(userData.getUserType()).build();
}
