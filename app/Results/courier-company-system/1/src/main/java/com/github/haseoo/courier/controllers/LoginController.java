...
@PostMapping
public ResponseEntity<Object> login(LoginCommandData loginCommandData){
    return new ResponseEntity<>(UserLoginView.of(userService.getByUsername(loginCommandData.getUserName()), userService.getJwt(loginCommandData)), OK);
}
