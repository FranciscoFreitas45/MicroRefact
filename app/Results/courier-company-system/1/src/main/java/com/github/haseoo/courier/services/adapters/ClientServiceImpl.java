...
public void verifyResource(Long id,UserDetailsImpl userDetails){
...
public List<ClientData> getList(){
    return clientRepository.getList().stream().map(ClientData::of).collect(Collectors.toList());
}


public boolean isUserClient(UserDetailsImpl userDetails){
