...
import com.github.haseoo.courier.security.Constants.HOME_URL;
@Component
...
public void onAuthenticationSuccess(HttpServletRequest request,HttpServletResponse response,Authentication authentication){
    ...
    String redirectionUrl = UriComponentsBuilder.fromUriString(HOME_URL).queryParam("auth_token", token).build().toUriString();
