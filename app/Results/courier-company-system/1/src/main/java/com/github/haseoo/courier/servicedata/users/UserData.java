...
public UserData of(UserModel userModel){
    return UserData.builder().id(userModel.getId()).userName(userModel.getUserName()).active(userModel.getActive()).password(userModel.getPassword()).userType(UserUtils.getUserType(userModel)).build();
}
