...
@JsonCreator
public ParcelTypeCommandEditData(@JsonProperty(value = "name") String name, @JsonProperty(value = "description") String description, @JsonProperty(value = "price") BigDecimal price, @JsonProperty(value = "isActive") Boolean active) {
    this.name = name;
