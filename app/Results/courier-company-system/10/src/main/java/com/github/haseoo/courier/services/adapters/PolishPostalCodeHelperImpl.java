...
public boolean readApiResponse(HttpURLConnection con,Predicate<Stream<String>> check){
...
public URL getApiUrl(String postalCode){
...
public HttpURLConnection prepareConnection(URL url){
    ...
    con.setRequestProperty(POSTAL_CODE_SERVICE_HTTP_METHOD_HEADER_FILED_NAME, POSTAL_CODE_SERVICE_HTTP_METHOD_MEDIA_TYPE);
    return con;
}
