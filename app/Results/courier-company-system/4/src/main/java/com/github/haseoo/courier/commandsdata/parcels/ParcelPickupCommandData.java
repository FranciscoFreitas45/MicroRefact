...
@JsonCreator
public ParcelPickupCommandData(@JsonProperty(value = "parcelsIds", required = true) Long parcelsId, @JsonProperty(value = "wasPaid", defaultValue = "false") boolean wasPaid) {
