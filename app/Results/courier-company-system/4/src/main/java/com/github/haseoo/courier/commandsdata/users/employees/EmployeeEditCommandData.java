...
@JsonCreator
public EmployeeEditCommandData(@JsonProperty(value = "employeeType", required = true) EmployeeType employeeType, @JsonProperty(value = "password") char[] password, @JsonProperty(value = "name") String name, @JsonProperty(value = "surname") String surname, @JsonProperty(value = "phoneNumber") String phoneNumber, @JsonProperty(value = "pesel") String pesel) {
    super(password);
