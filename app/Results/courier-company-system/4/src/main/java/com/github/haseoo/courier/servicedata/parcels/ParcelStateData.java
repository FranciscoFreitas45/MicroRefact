...
public ParcelStateData of(ParcelStateRecord parcelStateRecord){
    return ParcelStateData.builder().state(parcelStateRecord.getState()).changeDate(parcelStateRecord.getChangeDate()).parcel(ParcelData.ofWithoutStates(parcelStateRecord.getParcel())).magazine(((parcelStateRecord.getMagazine() != null) ? MagazineData.ofWithoutLists(parcelStateRecord.getMagazine()) : null)).courierData(((parcelStateRecord.getCourier() != null) ? CourierData.ofWithoutList(parcelStateRecord.getCourier()) : null)).build();
}
