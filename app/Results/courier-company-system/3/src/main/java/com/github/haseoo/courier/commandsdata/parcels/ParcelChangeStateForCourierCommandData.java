...
@JsonCreator
public ParcelChangeStateForCourierCommandData(@JsonProperty(value = "newState", required = true) ParcelStateType newState, @JsonProperty(value = "courierId", required = true) Long courierId, @JsonProperty(value = "wasPaid", defaultValue = "false") boolean wasPaid) {
