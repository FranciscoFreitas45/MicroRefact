...
public ParcelAddData of(ParcelCommandAddData addData){
    return ParcelAddData.builder().parcelTypeId(addData.getParcelTypeId()).deliveryAddress(AddressOperationData.of(addData.getDeliveryAddress())).senderAddress(AddressOperationData.of(addData.getSenderAddress())).parcelFee(addData.getParcelFee()).senderId(addData.getSenderId()).receiverContactData(ReceiverInfoOperationData.of(addData.getReceiverContactData())).priority(addData.getPriority()).build();
}
