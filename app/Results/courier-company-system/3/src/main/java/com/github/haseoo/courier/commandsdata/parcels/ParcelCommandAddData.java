...
@JsonCreator
public ParcelCommandAddData(@JsonProperty(value = "parcelTypeId", required = true) Long parcelTypeId, @JsonProperty(value = "deliveryAddress", required = true) AddressCommandData deliveryAddress, @JsonProperty(value = "senderAddress", required = true) AddressCommandData senderAddress, @JsonProperty(value = "parcelFee", required = true) BigDecimal parcelFee, @JsonProperty(value = "senderId", required = true) Long senderId, @JsonProperty(value = "receiverContactData", required = true) ReceiverInfoCommandData receiverContactData, @JsonProperty(value = "priority", required = true) Boolean priority) {
