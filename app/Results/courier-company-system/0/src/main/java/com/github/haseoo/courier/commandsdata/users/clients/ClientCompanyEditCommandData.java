...
@JsonCreator
public ClientCompanyEditCommandData(@JsonProperty(value = "password") char[] password, @JsonProperty(value = "emailAddress") String emailAddress, @JsonProperty(value = "phoneNumber") String phoneNumber, @JsonProperty(value = "companyName") String companyName, @JsonProperty(value = "representativeName") String representativeName, @JsonProperty(value = "representativeSurname") String representativeSurname, @JsonProperty(value = "representativeEmailAddress") String representativeEmailAddress, @JsonProperty(value = "representativePhoneNumber") String representativePhoneNumber) {
    super(password);
