...
public void setTotalScore(Long totalScore){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setTotalScore"))

.queryParam("totalScore",totalScore)
;
...
public void setScoreCount(Long scoreCount){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setScoreCount"))

.queryParam("scoreCount",scoreCount)
;
restTemplate.put(builder.toUriString(),null);
}
