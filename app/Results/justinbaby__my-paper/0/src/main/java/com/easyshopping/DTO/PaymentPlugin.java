...
public BigDecimal calculateAmount(BigDecimal amount){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/calculateAmount"))
...
public boolean verifyNotify(String sn,NotifyMethod notifyMethod,HttpServletRequest request)
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/verifyNotify"))

.queryParam("sn",sn)
.queryParam("notifyMethod",notifyMethod)
