...
import com.easyshopping.DTO.Coupon;
...
@ResponseBody
public Map<String,Object> calculateAmount(String paymentPluginId,String sn){
    Map<String, Object> data = new HashMap<String, Object>();
    Order order = orderService.findBySn(sn);
...
@ResponseBody
public Message create(String cartToken,Long receiverId,Long paymentMethodId,Long shippingMethodId,String code,Boolean isInvoice,String invoiceTitle,Boolean useBalance,String memo){
    Cart cart = cartService.getCurrent();
    if (cart == null || cart.isEmpty()) {
...
@ResponseBody
public Map<String,Object> calculate(Long paymentMethodId,Long shippingMethodId,String code,Boolean isInvoice,String invoiceTitle,Boolean useBalance,String memo){
    Map<String, Object> data = new HashMap<String, Object>();
    Cart cart = cartService.getCurrent();
    if (cart == null || cart.isEmpty()) {
