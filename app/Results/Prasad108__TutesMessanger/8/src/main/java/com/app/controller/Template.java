...
public String login(String error,String logout,Login l,HttpSession session,Model model,RedirectAttributes redirectAttributes){
...
public String logout(String error,String logout,HttpSession session,Model model){
