...
public String editTeacher(Model model,Student student1,Student student2){
...
public String Schedule(Model model,Student student){
...
public String ViewInstitueStructure(Model model,Student student){
...
public String changeSPassword(Student student,HttpServletRequest request,Model model){
...
public String changeTUsername(Student student,HttpServletRequest request,Model model){
