...
public void setSelectedAttributesOrder(String selectedAttributesOrder){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setSelectedAttributesOrder"))

.queryParam("selectedAttributesOrder",selectedAttributesOrder)
;
