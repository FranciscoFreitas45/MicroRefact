...
public void setInvited(Date invited){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setInvited"))

.queryParam("invited",invited)
;
...
public void setReminded(Date reminded){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setReminded"))

.queryParam("reminded",reminded)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setAnswers(int answers){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setAnswers"))
