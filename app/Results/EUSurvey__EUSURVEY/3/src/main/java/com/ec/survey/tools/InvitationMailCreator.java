...
public String insertDisclaimer(Survey survey,String body){
    // disclaimer
...
public String replaceAttributePlaceholders(String body,Attendee attendee){
...
public void createAndSendInvitation(ParticipationGroup participationGroup,Attendee attendee,String senderAddress,String sendername,String reply,String subject,Survey survey,String text1,String text2,String mailtemplate){
