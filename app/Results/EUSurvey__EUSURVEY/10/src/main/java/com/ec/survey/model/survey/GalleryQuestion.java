...
public boolean differsFrom(Element element){
    ...
    if (columns != null && !columns.equals(gallery.columns))
        return true;
    if (limit != null && !limit.equals(gallery.limit))
        return true;
    if (selection != gallery.selection)
        return true;
    for (File file : files) {
        boolean found = false;
...
public GalleryQuestion copy(String fileDir){
