...
public RankingItem copy(String fileDir){
...
public boolean differsFrom(Element other){
    return !getTitle().equals(other.getTitle()) || !getOriginalTitle().equals(other.getOriginalTitle()) || !getShortname().equals(other.getShortname()) || !getUniqueId().equals(other.getUniqueId());
}
