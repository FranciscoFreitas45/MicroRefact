...
public Object clean(Session session,Object obj,Map<Class,Map<Object,Object>> visitedObjects){
    Object newObj;
    Object value = null;
    ...
    if (obj == null)
        return (null);
    if ((obj instanceof Boolean) || (obj instanceof Number) || (obj.getClass().isEnum()) || (obj instanceof Character) || (obj instanceof String) || (obj instanceof Blob) || (obj instanceof InputStream))
        return (obj);
    ...
    if (obj instanceof Object[]) {
        ...
        length = array.length;
        for (index = 0; index < length; index++) array[index] = clean(session, array[index], visitedObjects);
        return (array);
    }
    if (obj instanceof Collection) {
        collection = createCollection((Collection) obj);
        if (Hibernate.isInitialized(obj)) {
            for (Object member : (Collection) obj) collection.add(clean(session, member, visitedObjects));
        }
        return (collection);
    }
...
@SuppressWarnings("rawtypes")
public Collection createCollection(Collection obj){
