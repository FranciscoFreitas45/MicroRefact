...
import com.ec.survey.DTO.FileService;
import com.ec.survey.DTO.File;
import com.ec.survey.DTO.Survey;
import com.ec.survey.DTO.TranslationService;
import com.ec.survey.DTO.Translations;
import com.ec.survey.DTO.AnswerExplanationService;
...
import com.ec.survey.DTO.AnswerService;
...
public void retrieveFromParameterMap(Map<String,String[]> parameterMap,String key,List<String> destinationList,boolean doFilter){
...
public double getBiggestImageWidth(String html){
    if (html == null)
        return 0;
    double w = 0;
    try {
...
public GalleryQuestion getGallery(Map<String,String[]> parameterMap,Element currentElement,String id,FileService fileService,ServletContext servletContext,boolean log220,Map<String,Integer> fileIDsByUID){
    GalleryQuestion gallery;
    String oldValues = "";
    String newValues = "";
    if (currentElement == null) {
        gallery = new GalleryQuestion(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public FreeTextQuestion getFreeText(Map<String,String[]> parameterMap,Element currentElement,String id,ServletContext servletContext,boolean log220){
    String oldValues = "";
    String newValues = "";
    FreeTextQuestion freetext;
    if (currentElement == null) {
        freetext = new FreeTextQuestion(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public void replace(Survey survey,String search,String replace){
...
public int getInteger(Map<String,String[]> parameterMap,String name,String id,int defaultvalue){
    try {
...
public Download getDownload(Map<String,String[]> parameterMap,Element currentElement,String id,FileService fileService,ServletContext servletContext,boolean log220,Map<String,Integer> fileIDsByUID){
    Download download;
    String oldValues = "";
    String newValues = "";
    if (currentElement == null) {
        download = new Download(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public Element parseElement(HttpServletRequest request,FileService fileService,String id,Survey survey,Map<Integer,Element> elementsById,HashMap<PossibleAnswer,String> dependencies,HashMap<Matrix,HashMap<Integer,String>> matrixDependencies,ServletContext servletContext,boolean log220,Map<String,Integer> fileIDsByUID){
    ...
    if (type.equalsIgnoreCase("section")) {
        ...
        element = getMatrix(parameterMap, currentElement, id, elementsById, dependenciesForAnswers, matrixDependencies, servletContext, log220 && currentElement != null);
    } else if (type.equalsIgnoreCase("table")) {
        element = getTable(parameterMap, currentElement, id, elementsById, servletContext, log220 && currentElement != null);
        ...
        element = getRuler(parameterMap, currentElement, id, servletContext, log220 && currentElement != null);
    } else if (type.equalsIgnoreCase("gallery")) {
        element = getGallery(parameterMap, currentElement, id, fileService, servletContext, log220 && currentElement != null, fileIDsByUID);
    } else if (type.equalsIgnoreCase("upload")) {
        element = getUpload(parameterMap, currentElement, id, servletContext, log220 && currentElement != null);
    } else if (type.equalsIgnoreCase("download")) {
        element = getDownload(parameterMap, currentElement, id, fileService, servletContext, log220 && currentElement != null, fileIDsByUID);
        ...
        element = getFreeText(parameterMap, currentElement, id, servletContext, log220 && currentElement != null);
    } else if (type.equalsIgnoreCase("regex")) {
        element = getRegEx(parameterMap, currentElement, id, servletContext, log220 && currentElement != null);
    } else if (type.equalsIgnoreCase(Constants.EMAIL)) {
        element = getEmail(parameterMap, currentElement, id, servletContext, log220 && currentElement != null);
    } else if (type.equalsIgnoreCase("number")) {
        element = getNumber(parameterMap, currentElement, id, servletContext, log220 && currentElement != null);
    } else if (type.equalsIgnoreCase("date")) {
        element = getDate(parameterMap, currentElement, id, servletContext, log220 && currentElement != null);
    } else if (type.equalsIgnoreCase("time")) {
        element = getTime(parameterMap, currentElement, id, servletContext, log220 && currentElement != null);
        ...
        element = getRating(parameterMap, currentElement, id, servletContext, log220 && currentElement != null, questions, shortnamesForQuestions, uidsForQuestions, optionalsForQuestions);
        ...
        if (single) {
            element = getSingleChoice(parameterMap, currentElement, survey, id, answers, originalAnswers, dependenciesForAnswers, dependencies, shortnamesForAnswers, correctForAnswers, pointsForAnswers, feedbackForAnswers, servletContext, log220);
        } else {
            element = getMultipleChoice(parameterMap, currentElement, survey, id, answers, originalAnswers, dependenciesForAnswers, dependencies, shortnamesForAnswers, correctForAnswers, pointsForAnswers, feedbackForAnswers, servletContext, log220);
        }
...
public void synchronizeSurvey(Survey survey,String languageCode,TranslationService translationService,Language language,boolean setSurvey){
    if (language != null) {
...
public ScoringItem getScoringItem(Map<String,String[]> parameterMap,Question element,String id,ServletContext servletContext){
...
public Section getSection(Map<String,String[]> parameterMap,Element currentElement,Survey survey,String id,ServletContext servletContext,boolean log220){
    Section section;
    if (currentElement == null) {
        section = new Section(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public Matrix getMatrix(Map<String,String[]> parameterMap,Element currentElement,String id,Map<Integer,Element> elementsById,String[] dependenciesForAnswers,HashMap<Matrix,HashMap<Integer,String>> matrixDependencies,ServletContext servletContext,boolean log220){
    String oldValues = "";
    String newValues = "";
    ...
    Matrix matrix;
    if (currentElement == null) {
        matrix = new Matrix(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public void recreateDelphiExplanationUploadedFiles(AnswerSet answerSet,Survey survey,FileService fileService,AnswerExplanationService answerExplanationService){
...
public Survey createTranslatedSurvey(int surveyId,String lang,SurveyService surveyService,TranslationService translationService,boolean setSurvey){
...
public void parseParameterMapForRankingitems(Map<String,String[]> parameterMap,String id,List<String> rankingItemTitles,List<String> rankingItemOriginalTitles,List<String> rankingItemShortNames,List<String> rankingItemUids){
...
public String getAnswerTitle(Survey survey,Answer answer,boolean publicationMode){
...
public RegExQuestion getRegEx(Map<String,String[]> parameterMap,Element currentElement,String id,ServletContext servletContext,boolean log220){
    String oldValues = "";
    String newValues = "";
    RegExQuestion regex;
    if (currentElement == null) {
        regex = new RegExQuestion(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public boolean isDeactivatedOrEndDateExceeded(Survey survey,SurveyService surveyService){
    boolean bln = false;
...
public Text getText(Map<String,String[]> parameterMap,Element currentElement,String id,ServletContext servletContext,boolean log220){
    String oldValues = "";
    String newValues = "";
    Text text;
    if (currentElement == null) {
        text = new Text(getString(parameterMap, "text", id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public AnswerSet parseAnswerSet(HttpServletRequest request,Survey survey,String uniqueCode,boolean update,String languageCode,User user,FileService fileService){
    ...
    if (!survey.isAnonymous()) {
        ...
        if (request.getHeader("X-Forwarded-For") != null && !request.getHeader("X-Forwarded-For").equalsIgnoreCase("0.0.0.0"))
            ...
            if (key.contains("|")) {
                ...
                if (question != null) {
                    if (question instanceof Upload) {
                        ...
                        java.io.File directory = new java.io.File(rootfolder.getPath() + Constants.PATH_DELIMITER + uniqueCode + Constants.PATH_DELIMITER + question.getId());
                        if (directory.exists()) {
                            // create File items
                            Answer answer = new Answer();
                            answer.setAnswerSet(answerSet);
                        ...
                        for (String value : values) {
                            if (value.isEmpty() || value.equalsIgnoreCase("false") || (question instanceof DateQuestion && value.equalsIgnoreCase("DD/MM/YYYY")) || (question instanceof TimeQuestion && value.equalsIgnoreCase("HH:mm:ss"))) {
                                continue;
                            }
...
public Table getTable(Map<String,String[]> parameterMap,Element currentElement,String id,Map<Integer,Element> elementsById,ServletContext servletContext,boolean log220){
    String oldValues = "";
    String newValues = "";
    StringBuilder oldLabels = new StringBuilder();
    StringBuilder newLabels = new StringBuilder();
    Table table;
    if (currentElement == null) {
        table = new Table(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public void recreateUploadedFiles(AnswerSet answerSet,Survey survey,FileService fileService,AnswerExplanationService answerExplanationService){
...
public AnswerSet parseAndMergeAnswerSet(HttpServletRequest request,Survey survey,String uniqueCode,AnswerSet answerSet,String languageCode,User user,FileService fileService){
    ...
    AnswerSet parsedAnswerSet = parseAnswerSet(request, survey, uniqueCode, true, languageCode, user, fileService);
...
public EmailQuestion getEmail(Map<String,String[]> parameterMap,Element currentElement,String id,ServletContext servletContext,boolean log220){
    EmailQuestion email;
    String oldValues = "";
    String newValues = "";
    if (currentElement == null) {
        email = new EmailQuestion(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public Confirmation getConfirmation(Map<String,String[]> parameterMap,Element currentElement,Survey survey,String id,FileService fileService,ServletContext servletContext,boolean log220){
    Confirmation confirmation;
    String oldValues = "";
    String newValues = "";
    if (currentElement == null) {
        confirmation = new Confirmation(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public Image getImage(Map<String,String[]> parameterMap,Element currentElement,String id,ServletContext servletContext,boolean log220){
    Image image;
    String oldValues = "";
    String newValues = "";
    if (currentElement == null) {
...
public void gatherExplanationUploadsForQuestion(Survey survey,Question question,String uniqueCode,AnswerSet answerSet,AnswerSet.ExplanationData explanationData,FileService fileService){
    // find temporary directory
    java.io.File rootfolder = fileService.getSurveyExplanationUploadsFolder(survey.getUniqueId(), false);
    java.io.File directory = new java.io.File(rootfolder.getPath() + Constants.PATH_DELIMITER + uniqueCode + Constants.PATH_DELIMITER + question.getUniqueId());
    if (directory.exists()) {
...
public RatingQuestion getRating(Map<String,String[]> parameterMap,Element currentElement,String id,ServletContext servletContext,boolean log220,String[] questions,String[] shortnamesForQuestions,String[] uidsForQuestions,String[] optionalsForQuestions){
    ...
    if (currentElement == null) {
        rating = new RatingQuestion(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public SingleChoiceQuestion getSingleChoice(Map<String,String[]> parameterMap,Element currentElement,Survey survey,String id,String[] answers,String[] originalAnswers,String[] dependenciesForAnswers,HashMap<PossibleAnswer,String> dependencies,String[] shortnamesForAnswers,String[] correctForAnswers,String[] pointsForAnswers,String[] feedbackForAnswers,ServletContext servletContext,boolean log220){
    String oldValues = "";
    String newValues = "";
    ...
    if (!(currentElement instanceof SingleChoiceQuestion)) {
        singlechoice = new SingleChoiceQuestion(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public TimeQuestion getTime(Map<String,String[]> parameterMap,Element currentElement,String id,ServletContext servletContext,boolean log220){
    TimeQuestion time;
    String oldValues = "";
    String newValues = "";
    if (currentElement == null) {
        time = new TimeQuestion(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public Double getDouble(Map<String,String[]> parameterMap,String name,String id){
    try {
        if (parameterMap.get(name + id) != null) {
            String value = parameterMap.get(name + id)[0];
            if (value.length() > 0)
...
public Survey parseSurvey(HttpServletRequest request,SurveyService surveyService,FileService fileService,ServletContext servletContext,boolean log217,boolean log220,Map<String,Integer> fileIDsByUID){
    ...
    if (idsAsString.trim().length() > 0) {
        for (int i = 0; i < ids.length; i++) {
            ...
            if (!id.equalsIgnoreCase("undefined")) {
                Element element = parseElement(request, fileService, id, survey, elementsById, dependencies, matrixDependencies, servletContext, log220, fileIDsByUID);
                if (element != null) {
...
public AnswerSet parseAndMergeDelphiAnswerSet(HttpServletRequest request,Survey survey,String uniqueCode,AnswerSet answerSet,String languageCode,User user,FileService fileService,Element question){
    AnswerSet parsedAnswerSet = parseAnswerSet(request, survey, uniqueCode, true, languageCode, user, fileService);
...
public void recreateUploadedAnswerFiles(AnswerSet answerSet,Survey survey,FileService fileService){
...
public NumberQuestion getNumber(Map<String,String[]> parameterMap,Element currentElement,String id,ServletContext servletContext,boolean log220){
    NumberQuestion number;
    String oldValues = "";
    String newValues = "";
    if (currentElement == null) {
        number = new NumberQuestion(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public Ruler getRuler(Map<String,String[]> parameterMap,Element currentElement,String id,ServletContext servletContext,boolean log220){
    Ruler ruler;
    String oldValues = "";
    String newValues = "";
    if (currentElement == null) {
...
public Date getDate(Map<String,String[]> parameterMap,String name,String id){
    try {
        if (parameterMap.get(name + id) != null) {
            String value = parameterMap.get(name + id)[0];
            if (value.length() > 0)
...
public boolean getBoolean(Map<String,String[]> parameterMap,String name,String id){
    try {
        if (parameterMap.get(name + id) != null) {
            String value = parameterMap.get(name + id)[0];
            if (value.length() > 0)
...
public Map<Element,String> validateAnswerSet(AnswerSet answerSet,AnswerService answerService,Set<String> invisibleElements,MessageSource resources,Locale locale,String draftid,HttpServletRequest request,boolean skipDraftCreation,User user,FileService fileService,List<Element> elements){
    ...
    if (!skipDraftCreation && result.size() > 0) {
        ...
        if (draft != null) {
            SurveyHelper.parseAndMergeAnswerSet(request, answerSet.getSurvey(), answerSet.getUniqueCode(), draft.getAnswerSet(), answerSet.getLanguageCode(), user, fileService);
            // this also sets the ISDRAFT flag of the answers inside the
...
public boolean isMaxContributionReached(Survey survey,AnswerService answerService){
...
public MultipleChoiceQuestion getMultipleChoice(Map<String,String[]> parameterMap,Element currentElement,Survey survey,String id,String[] answers,String[] originalAnswers,String[] dependenciesForAnswers,HashMap<PossibleAnswer,String> dependencies,String[] shortnamesForAnswers,String[] correctForAnswers,String[] pointsForAnswers,String[] feedbackForAnswers,ServletContext servletContext,boolean log220){
    String oldValues = "";
    String newValues = "";
    String choicetype = parameterMap.get("choicetype" + id)[0];
    MultipleChoiceQuestion multiplechoice;
    if (!(currentElement instanceof MultipleChoiceQuestion)) {
        multiplechoice = new MultipleChoiceQuestion(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public boolean validateElement(Element element,AnswerSet answerSet,Map<Element,List<Element>> dependencies,Map<Element,String> result,AnswerService answerService,Set<String> invisibleElements,MessageSource resources,Locale locale,Element parentElement,HttpServletRequest request,Draft draft){
    try {
        List<Answer> answers;
        Matrix parent = null;
        ...
        if (element instanceof Question) {
            ...
            if (parent == null ? question.getIsDependent() : question.getIsDependentMatrixQuestion()) {
                        ...
                        if (trigger instanceof Matrix) {
                            ...
                            for (DependencyItem candidate : m.getDependentElements()) {
                                ...
                                if (dependentElementUniqueIds.contains(question.getUniqueId()) || (parent != null && dependentElementUniqueIds.contains(parent.getUniqueId()))) {
                                    ...
                                    if ((answerSet.getMatrixAnswer(matrixQuestion.getId(), matrixAnswer.getId()) != null || answerSet.getMatrixAnswer(matrixQuestion.getUniqueId(), matrixAnswer.getUniqueId()) != null) && !invisibleElements.contains(matrixQuestion.getUniqueId())) {
                                        found = true;
                                    } else {
                                        missing = true;
                                    }
                            ...
                            if (trigger instanceof PossibleAnswer) {
                                ...
                                for (Answer answer : answerSet.getAnswers(possibleAnswer.getQuestionId(), answerSet.getSurvey().getElementsById().get(possibleAnswer.getQuestionId()).getUniqueId())) {
                                    if ((answer.getPossibleAnswerId().equals(trigger.getId()) || (answer.getPossibleAnswerUniqueId() != null && answer.getPossibleAnswerUniqueId().equals(trigger.getUniqueId()))) && !invisibleElements.contains(answer.getQuestionUniqueId())) {
                                        found = true;
                                        paFound = true;
                                    }
                                }
                ...
                if (!(element instanceof Matrix) && !(element instanceof RatingQuestion) && !question.getOptional() && answers.isEmpty() && (parentElement == null || !invisibleElements.contains(parentElement.getUniqueId()))) {
                    result.put(element, resources.getMessage("validation.required", null, "This field is required.", locale));
                }
            }
            if (element instanceof FreeTextQuestion) {
                ...
                if (answerSet.getSurvey().getRegistrationForm() && question.getAttributeName().equalsIgnoreCase(Constants.EMAIL) && !MailService.isValidEmailAddress(answer)) {
                ...
                if (freeTextQuestion.getIsUnique()) {
                    ...
                    if (existing > 0)
                        result.put(element, resources.getMessage("validation.notUnique", null, "This input already exists. Please try another entry.", locale));
                }
                if (freeTextQuestion.getIsPassword() && freeTextQuestion.getSurvey().getShortname().equalsIgnoreCase("NewSelfRegistrationSurvey") && answer.length() > 0 && answer != null && !answer.equals("********") && Tools.isPasswordWeak(answer)) {
            ...
            if (element instanceof MultipleChoiceQuestion) {
                ...
                if (multipleChoiceQuestion.getMaxChoices() < answers.size() && multipleChoiceQuestion.getMaxChoices() > 0 && !answers.isEmpty()) {
...
public RankingQuestion getRankingQuestion(Map<String,String[]> parameterMap,Element currentElement,String id,List<String> rankingItemTitles,List<String> rankingItemOriginalTitles,List<String> rankingItemShortNames,List<String> rankingItemUids,ServletContext servletContext,boolean log220){
    String oldValues = "";
    String newValues = "";
...
public void calcTableWidths(Survey survey,Form f){
    ...
    for (Element element : survey.getElementsRecursive()) {
        if (bf != null && (element instanceof MatrixOrTable || element instanceof GalleryQuestion)) {
            ...
            if (w > 595.0) {
                // NOTE: A4 = 595 pt x 842 pt ; Letter = 612 pt
                if (w <= 842) {
                    w = 842;
                    element.setPDFWidth(w);
                }
...
public String getString(Map<String,String[]> parameterMap,String name,String id,ServletContext servletContext,boolean escape){
    String result = null;
    try {
        if (parameterMap.get(name + id) != null) {
...
public Upload getUpload(Map<String,String[]> parameterMap,Element currentElement,String id,ServletContext servletContext,boolean log220){
    Upload upload;
    String oldValues = "";
    String newValues = "";
    if (currentElement == null) {
        upload = new Upload(getString(parameterMap, "text", id, servletContext), getString(parameterMap, Constants.SHORTNAME, id, servletContext), getString(parameterMap, "uid", id, servletContext));
    } else {
...
public String[] getStrings(Map<String,String[]> parameterMap,String name,String id,ServletContext servletContext){
    String[] result = null;
    try {
        if (parameterMap.get(name + id) != null) {
...
public void checkFiles(java.io.File directory,java.io.File folder,List<File> files){
