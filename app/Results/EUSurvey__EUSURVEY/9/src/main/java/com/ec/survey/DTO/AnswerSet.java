...
public void setEcfProfileUid(String ecfProfileUid){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setEcfProfileUid"))
...
public void setEcfTotalScore(Integer ecfTotalScore){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setEcfTotalScore"))

.queryParam("ecfTotalScore",ecfTotalScore)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setEcfTotalGap(Integer ecfTotalGap){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setEcfTotalGap"))

.queryParam("ecfTotalGap",ecfTotalGap)
;
restTemplate.put(builder.toUriString(),null);
}
