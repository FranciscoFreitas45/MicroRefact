...
import java.net.URL;
import com.ec.survey.DTO.LdapService;
...
public String getXmlTagValue(String xml,String tag){
...
public void readData(User user,LdapService ldapService){
    try {
...
public String getSourceContents(String urlToRead){
