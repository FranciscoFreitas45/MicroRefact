...
@ResponseBody
public String undoDelete(HttpServletRequest request){
...
public ModelAndView unbanuser(String userId,HttpServletRequest request,Model model){
...
public ModelAndView banuser(String userId,String emailText,HttpServletRequest request,Model model){
...
public ModelAndView deleteUser(HttpServletRequest request,Model model,Locale locale){
    try {
...
public ModelAndView updateUser(HttpServletRequest request,Model model,Locale locale){
...
public ModelAndView createUser(HttpServletRequest request,Model model,Locale locale){
...
@PostMapping
public ModelAndView usersPOST(HttpServletRequest request,Model model,Locale locale){
