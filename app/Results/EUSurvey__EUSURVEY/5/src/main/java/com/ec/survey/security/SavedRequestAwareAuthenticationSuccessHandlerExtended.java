...
public boolean isAjax(String url,SavedRequest request){
    if (url != null && (url.contains("checkNew") || url.contains("/messages") || url.contains("/dashboard/") || url.toLowerCase().contains("json") || url.toLowerCase().contains("ajax"))) {
        return true;
    }
