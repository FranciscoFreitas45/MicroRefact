...
public void setDepartmentNumber(String departmentNumber){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setDepartmentNumber"))

.queryParam("departmentNumber",departmentNumber)
;
...
public void setEcMoniker(String ecMoniker){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setEcMoniker"))

.queryParam("ecMoniker",ecMoniker)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setUserLDAPGroups(Set<String> userLDAPGroups){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setUserLDAPGroups"))

.queryParam("userLDAPGroups",userLDAPGroups)
;
restTemplate.put(builder.toUriString(),null);
}
