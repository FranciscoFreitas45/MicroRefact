...
public java.io.File createPublishedAnswerPDF(AnswerSet answerSet){
...
public java.io.File createAllIndividualResultsPDF(Survey survey,ResultFilter filter){
    java.io.File target = null;
...
public java.io.File createStatisticsPDF(Survey survey,String exportId){
    String shortname = survey.getShortname();
...
public String createDraftAnswerPDF(String code,String email){
...
public java.io.File createChartsPDF(Survey survey,String exportId){
    String shortname = survey.getShortname();
...
public java.io.File createStatisticsQuizPDF(Survey survey,String exportId){
    String shortname = survey.getShortname();
...
public java.io.File createQuizPDF(AnswerSet answerSet){
