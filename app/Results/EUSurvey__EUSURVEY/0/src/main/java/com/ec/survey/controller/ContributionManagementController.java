...
@ResponseBody
public List<ContributionSearchResult> contributionsearchJSON(HttpServletRequest request){
    try {
...
@ResponseBody
public String resetcontribution(Locale locale,HttpServletRequest request){
...
public ModelAndView contributionsearch(HttpServletRequest request,Model model){
...
public ModelAndView contributionsearchPOST(HttpServletRequest request,Model model){
