...
@ResponseBody
public List<Object[]> personalinvitations(HttpServletRequest request,HttpServletResponse response,Locale locale,Model model){
    try {
        ...
        for (Invitation invitation : lstInvitations) {
            ...
            if (s != null) {
                ...
                answer[4] = host + "runner/invited/" + invitation.getParticipationGroupId() + Constants.PATH_DELIMITER + invitation.getUniqueId();
...
@ResponseBody
public String[] metadata(HttpServletRequest request,HttpServletResponse response,Locale locale,Model model){
    try {
...
@ResponseBody
public List<Archive> archives(HttpServletRequest request,HttpServletResponse response,Locale locale,Model model){
    try {
        User u = sessionService.getCurrentUser(request);
        int page = 1;
        if (request.getParameter("page") != null) {
...
@ResponseBody
public List<List<Integer>> surveysadvanced(HttpServletRequest request,HttpServletResponse response,Locale locale,Model model){
    try {
...
@ResponseBody
public List<Object[]> personalcontributions(HttpServletRequest request,HttpServletResponse response,Locale locale,Model model){
    try {
...
@ResponseBody
public List<Survey> surveys(HttpServletRequest request,HttpServletResponse response,Locale locale,Model model){
    try {
        User u = sessionService.getCurrentUser(request);
...
@ResponseBody
public List<Object[]> delphisurveys(HttpServletRequest request,HttpServletResponse response,Locale locale,Model model){
    try {
        int page = 1;
        if (request.getParameter("page") != null) {
            page = Integer.parseInt(request.getParameter("page"));
...
@ResponseBody
public List<Object[]> personaldrafts(HttpServletRequest request,HttpServletResponse response,Locale locale,Model model){
    try {
        ...
        for (AnswerSet answerSet : answerSets) {
            ...
            String link = invitation == null ? "" : host + "runner/invited/" + invitation.getParticipationGroupId() + Constants.PATH_DELIMITER + invitation.getUniqueId();
            answer[6] = link;
            drafts.add(answer);
        }
        return drafts;
...
@ResponseBody
public Contributions contributions(HttpServletRequest request,HttpServletResponse response,Locale locale,Model model){
    try {
        User u = sessionService.getCurrentUser(request);
...
@ResponseBody
public int[] surveystates(HttpServletRequest request,HttpServletResponse response,Locale locale,Model model){
    try {
        User u = sessionService.getCurrentUser(request);
        String type = request.getParameter("type");
...
@ResponseBody
public int[] contributionstates(HttpServletRequest request,HttpServletResponse response,Locale locale,Model model){
    try {
        User u = sessionService.getCurrentUser(request);
...
@ResponseBody
public EndDates enddates(HttpServletRequest request,HttpServletResponse response,Locale locale,Model model){
    try {
        User u = sessionService.getCurrentUser(request);
        String type = request.getParameter("type");
