...
@ResponseBody
public List<Survey> surveysjson(HttpServletRequest request){
...
@RequestMapping()
public ModelAndView surveys(HttpServletRequest request){
    ...
    if (request.getParameter("itemsPerPage") != null)
        ConversionTools.getInt(request.getParameter("itemsPerPage"), 10);
...
@ResponseBody
public Boolean shortnameexistsjson(HttpServletRequest request){
