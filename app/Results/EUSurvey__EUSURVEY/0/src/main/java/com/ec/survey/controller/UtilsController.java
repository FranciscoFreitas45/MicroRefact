...
@ResponseBody
public String getConfigValue(String key,HttpServletRequest request){
    String result = "";
...
@ResponseBody
public Map<String,String> getListOfCountries(HttpServletRequest request){
...
@ResponseBody
public Map<String,String> getListOfAgencies(HttpServletRequest request){
    Locale locale = new Locale(request.getParameter("lang"));
...
@ResponseBody
public Map<String,String> getListOfUNCountries(HttpServletRequest request){
    Locale locale = new Locale(request.getParameter("lang"));
    Map<String, String> countryList = new HashMap<>();
...
@ResponseBody
public Map<String,String> getListOfDGs(HttpServletRequest request){
    Locale locale = new Locale(request.getParameter("lang"));
...
@ResponseBody
public Map<String,String> getListOfLanguages(HttpServletRequest request){
    Locale locale = new Locale(request.getParameter("lang"));
