...
public class Form {
 ...
 private  Map<Element,String> validation;
 ...
 private  Set<String> passwordQuestions;
...
public String getValidationMessage(Element element){
    try {
        for (Entry<Element, String> entry : validation.entrySet()) {
            if (entry.getKey() != null && element != null && !(entry.getKey() instanceof DraftIDElement) && entry.getKey().getId().equals(element.getId()))
...
public String getQuestionTitle(Element question){
    ...
    for (Element element : survey.getElements()) {
        ...
        if (element instanceof Question && !(element instanceof Text) && !(element instanceof Image) && !(element instanceof Confirmation)) {
            counter++;
...
public String getInternalMessage(String key,Object[] args){
    String locale = "en";
    if (language != null) {
...
public String getSectionNumbering(Section section){
...
public void setWcagCompliance(boolean b){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setWcagCompliance"))
...
public void setValidation(Map<Element,String> validation){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setValidation"))
...
public boolean translationIsValid(String lang){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/translationIsValid"))
...
public void setForPDF(boolean forPDF){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setForPDF"))

.queryParam("forPDF",forPDF)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setResources(MessageSource resources){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setResources"))
...
public void setUploadItem(UploadItem uploadItem){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setUploadItem"))

.queryParam("uploadItem",uploadItem)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setStartHour(int startHour){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setStartHour"))

.queryParam("startHour",startHour)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setEndHour(int endHour){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setEndHour"))

.queryParam("endHour",endHour)
;
restTemplate.put(builder.toUriString(),null);
}
...
public void setPublicationMode(boolean publicationMode){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setPublicationMode"))

.queryParam("publicationMode",publicationMode)
;
restTemplate.put(builder.toUriString(),null);
}
