...
public void checkValueSizes(Activity activity){
...
public String getHQL(ActivityFilter filter,Map<String,Object> params){
    ...
    if (filter.getProperty() != null) {
        switch(filter.getProperty()) {
            ...
            case "BackgroundDocument":
                hql += " AND (logID = 205 OR logID = 206)";
                break;
            case "Captcha":
                hql += " AND logID = 118";
                break;
            ...
            case "EscapePage":
                ...
                break;
            case "Export":
                hql += " AND (logID = 310 OR logID = 311)";
                break;
            case "ExportCharts":
                hql += " AND logID = 309";
                break;
            ...
            case "Password":
                ...
                break;
            case "PendingChanges":
                hql += " AND (logID = 107 OR logID = 108)";
                break;
            case "PivotLanguage":
                hql += " AND logID = 208";
                break;
            ...
            case "StartDate":
                ...
                break;
            case "State":
                hql += " AND (logID = 105 OR logID = 106)";
                break;
            case "SurveyElement":
                hql += " AND (logID = 218 OR logID = 219 OR logID = 220)";
                break;
            case "Title":
                hql += " AND logID = 207";
                break;
            case "Token/Contacts/Department":
                hql += " AND logID > 500 AND logID < 506";
                break;
            case "Translation":
                hql += " AND (logID > 220 AND logID < 225) OR logID = 227 OR logID = 228";
                break;
            case "UsefulLink":
                hql += " AND (logID = 203 OR logID = 204)";
                break;
            case "DeleteColumn":
                hql += " AND (logID = 315)";
                break;
    ...
    if (filter.getEvent() != null) {
        switch(filter.getEvent()) {
            ...
            case "Saved":
                ...
                break;
            case "Sent":
                hql += " AND (logID = 506 OR logID = 701)";
                break;
            case "Started":
