...
public String getProperty(){
    ...
    if (logID == 109)
        return "Alias";
    if (logID == 110)
        return "EndNotificationState";
    if (logID == 111)
        return "EndNotificationValue";
    if (logID == 112)
        return "EndNotificationReach";
    if (logID == 113)
    ...
    if (logID == 214)
        return "Skin";
    if (logID == 215)
        return "AutoNumberingSections";
    if (logID == 216)
        return "AutoNumberingQuestions";
    if (logID == 217)
        return "ElementOrder";
    if (logID < 221)
    ...
    if (logID == 228)
        return TRANSLATION;
    if (logID == 301)
        return "PublishIndividual";
    if (logID == 302)
        return "PublishCharts";
    if (logID == 303)
        return "PublishStatistics";
    if (logID == 304)
        return "PublicSearch";
    if (logID == 305)
        return "PublishQuestionSelection";
    if (logID == 306)
        return "PublishAnswerSelection";
    if (logID == 307)
    ...
    if (logID == 313)
        return "PublishUploadedElements";
    if (logID == 314)
        return "ExportUploadedElements";
    if (logID == 315)
        return "DeleteColumn";
    if (logID < 312)
        return "Export";
    if (logID < 407)
        return "n/a";
    if (logID < 506)
        return type != null ? type : "Token/Contacts/Department";
    if (logID == 506)
        return "Invitations";
    if (logID == 507)
        return "Invitations";
