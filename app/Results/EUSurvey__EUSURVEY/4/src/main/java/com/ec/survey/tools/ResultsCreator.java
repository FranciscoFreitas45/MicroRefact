...
@Scope("prototype")
public class ResultsCreator implements BeanFactoryAware,Runnable{
...
public void run(){
    try {
        ...
        for (Integer answerSetId : uniqueCodesById.keySet()) {
            ...
            if ((webserviceTask.getExportType() == null || webserviceTask.getExportType().equals(0) || webserviceTask.getExportType().equals(2) || (webserviceTask.getExportType().equals(3) && webserviceTask.getFileTypes() != null && webserviceTask.getFileTypes().contains("p"))) && invalidCounter < 3) {
            ...
            if ((webserviceTask.getExportType() != null && !webserviceTask.getExportType().equals(3)) || (webserviceTask.getFileTypes() != null && webserviceTask.getFileTypes().contains("u"))) {
                ...
                for (File uploadedFile : uploadedFiles) {
                    ...
                    os.putArchiveEntry(new ZipArchiveEntry(uniqueCode + "/Uploaded Files/" + folderName + Constants.PATH_DELIMITER + uploadedFile.getName()));
