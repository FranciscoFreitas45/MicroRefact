...
public String retrieveExplanationWithFilesFromReportingAnswer(String cellContent,String answerSetUid,String questionUid,FilesByTypes<String,String> explanationFilesToExport){
    String explanation;
    String filesPart = "";
...
public String retrieveExplanationWithFilesFromAnswerSetAndExistingFiles(AnswerSet answerSet,Map<Integer,Map<String,String>> explanations,String questionUid,FilesByTypes<Integer,String> explanationFilesOfSurvey,FilesByTypes<String,String> explanationFilesToExport){
    String explanation = "";
