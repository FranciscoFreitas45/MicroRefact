...
public ModelAndView configureComplexity(Map<String,String> allRequestParams,HttpServletRequest request,Model model,Locale locale){
    ModelAndView m = null;
    try {
        ...
        m.addObject(Constants.ERROR, resources.getMessage("validation.invalidNumber", null, "This value is not a valid number", locale));
    }
    return m;
}
...
public ModelAndView configureTrustIndicator(HttpServletRequest request,Locale locale){
...
public ModelAndView getSystemMessages(HttpServletRequest request,boolean runnermode){
...
public ModelAndView configureMessage(String active,String autodeactivate,String autodeactivatetime,String time,String type,String text,String criticality,HttpServletRequest request,Model model,Locale locale){
    Message message = systemService.getMessage();
    try {
        ...
        ModelAndView m = new ModelAndView("administration/system", Constants.MESSAGE, message);
        m.addObject(Constants.ERROR, resources.getMessage("validation.invalidDate", null, "This value is not a valid date", locale));
        return m;
    }
}
...
public ModelAndView configureBanUsers(HttpServletRequest request,Locale locale){
...
@ResponseBody
public Map<String,Integer> getComplexityDefinition(HttpServletRequest request){
...
public ModelAndView configureLogging(String enabled,HttpServletRequest request,Locale locale){
...
@ResponseBody
public Message getSystemMessage(HttpServletRequest request){
...
public ModelAndView configureReports(HttpServletRequest request,Locale locale){
