...
@Value("${host.executing.task:@null}")
 public  String hostExecutingTask;

 private  Date lastDeleteAnswerPDFExecuted;


// wait for 10 seconds between calls
@Scheduled(fixedDelay = 10000)
public void doToDosSchedule(){
...
public boolean isHost2ExecuteTask(){
...
public void migrateReportingSchedule(){
    ...
    try {
        ...
        if (start == null || start.length() == 0 || time == null || time.length() == 0)
            return;
