...
@ResponseBody
public String[] getLoginsJSON(HttpServletRequest request){
...
@ResponseBody
public String[] participantsSearch(HttpServletRequest request,HttpServletResponse response){
...
@ResponseBody
public String[] getECASLoginsJSON(HttpServletRequest request){
    String query = request.getParameter("term");
...
@ResponseBody
public String[] getDepartmentsJSON(HttpServletRequest request){
    String query = request.getParameter("term");
