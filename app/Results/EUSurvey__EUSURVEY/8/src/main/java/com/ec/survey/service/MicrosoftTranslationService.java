...
@Value("${microsoft.translation.client.secret}")
...
public String[] translate(String[] sourceTexts,String sourceLanguage,String targetLangauge){
    ...
    try {
        ...
        throw new MessageException("Error during translation source lang " + sourceLanguage + " target lang " + targetLangauge + " text to translate " + Arrays.toString(sourceTexts));
    }
}
