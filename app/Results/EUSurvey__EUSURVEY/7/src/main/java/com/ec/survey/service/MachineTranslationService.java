...
public void translateTranlations(Integer sourceTranslationsId,String targetLanguage,User user,List<Integer> targetIDs){
...
public String buildDeliveryURLFromRequest(Request request){
    String result = "";
...
public Map<String,Integer> getMap(List<Translation> translationsList){
...
public void translateTranlationsWithMicrosoft(Integer sourceTranslationsId,List<Integer> targetIDs){
    Translations sourceTranslations = translationService.getTranslations(sourceTranslationsId);
    List<Translation> translationsList = sourceTranslations.getTranslations();
    String sourceLanguage = translationsList.get(0).getLanguage();
...
public String getTranslatedText(Response response){
...
public void updateTranslation(Response response){
