...
public void setLanguageCode(String languageCode){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/setLanguageCode"))
...
public void addAnswer(Answer answer){
  ...
  UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(url.concat("/addAnswer"))
