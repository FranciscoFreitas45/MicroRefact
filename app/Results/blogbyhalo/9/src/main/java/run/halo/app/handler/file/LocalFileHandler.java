...
public boolean generateThumbnail(BufferedImage originalImage,Path thumbPath,String extension){
...
public void checkWorkDir(){
    ...
    // Check file type
    if (!Files.isDirectory(workPath) || !Files.isReadable(workPath) || !Files.isWritable(workPath)) {
