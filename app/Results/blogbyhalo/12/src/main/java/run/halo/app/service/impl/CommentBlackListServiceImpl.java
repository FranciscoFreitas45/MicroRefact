...
public class CommentBlackListServiceImpl extends AbstractCrudService<CommentBlackList, Long>implements CommentBlackListService{
 ...
 private  CommentBlackListRepository commentBlackListRepository;
...
public void update(LocalDateTime localDateTime,CommentBlackList blackList,Integer banTime){
...
public Date getBanTime(LocalDateTime localDateTime,Integer banTime){
