package run.halo.app.service.impl;
 import run.halo.app.model.support.HaloConst.DATABASE_PRODUCT_NAME;
...
public LoginPreCheckDTO getUserEnv(String username){
    ...
    boolean useMFA = true;
    try {
        final User user = Validator.isEmail(username) ? userService.getByEmailOfNonNull(username) : userService.getByUsernameOfNonNull(username);
