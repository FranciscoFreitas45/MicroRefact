...
public Page<JournalWithCmtCountDTO> pageBy(Pageable pageable,JournalQuery journalQuery){
...
public JournalDTO createBy(JournalParam journalParam){
...
public JournalDTO deleteBy(Integer journalId){
...
public List<JournalWithCmtCountDTO> pageLatest(int top){
