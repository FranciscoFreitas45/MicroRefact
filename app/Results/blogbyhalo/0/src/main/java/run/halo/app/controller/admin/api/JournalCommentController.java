...
public Page<JournalCommentWithJournalVO> pageBy(Pageable pageable,CommentQuery commentQuery){
...
public List<JournalCommentWithJournalVO> listLatest(int top,CommentStatus status){
...
public Page<BaseCommentVO> listCommentTree(Integer journalId,int page,Sort sort){
...
public BaseCommentDTO createCommentBy(JournalCommentParam journalCommentParam){
...
public BaseCommentDTO deleteBy(Long commentId){
