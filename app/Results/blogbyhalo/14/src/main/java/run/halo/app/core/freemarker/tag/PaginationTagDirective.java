    ...
    if (params.containsKey(HaloConst.METHOD_KEY)) {
        ...
        switch(method) {
            case "index":
                ...
                break;
            case "archives":
                nextPageFullPath.append(URL_SEPARATOR).append(optionService.getArchivesPrefix());
                prevPageFullPath.append(URL_SEPARATOR).append(optionService.getArchivesPrefix());
                nextPageFullPath.append("/page/").append(page + 2).append(pathSuffix);
                if (page == 1) {
                ...
                fullPath.append(URL_SEPARATOR).append(optionService.getArchivesPrefix());
                fullPath.append("/page/");
                for (int current : rainbow) {
                    RainbowPage rainbowPage = new RainbowPage();
                    rainbowPage.setPage(current);
            ...
            case "tagPosts":
                ...
                nextPageFullPath.append(URL_SEPARATOR).append(optionService.getTagsPrefix()).append(URL_SEPARATOR).append(tagSlug);
                prevPageFullPath.append(URL_SEPARATOR).append(optionService.getTagsPrefix()).append(URL_SEPARATOR).append(tagSlug);
                nextPageFullPath.append("/page/").append(page + 2).append(pathSuffix);
                if (page == 1) {
                    prevPageFullPath.append(pathSuffix);
                } else {
                ...
                fullPath.append(URL_SEPARATOR).append(optionService.getTagsPrefix()).append(URL_SEPARATOR).append(tagSlug);
                fullPath.append("/page/");
                for (int current : rainbow) {
                    RainbowPage rainbowPage = new RainbowPage();
                    rainbowPage.setPage(current);
            ...
            case "categoryPosts":
                ...
                nextPageFullPath.append(URL_SEPARATOR).append(optionService.getCategoriesPrefix()).append(URL_SEPARATOR).append(categorySlug);
                prevPageFullPath.append(URL_SEPARATOR).append(optionService.getCategoriesPrefix()).append(URL_SEPARATOR).append(categorySlug);
                nextPageFullPath.append("/page/").append(page + 2).append(pathSuffix);
                if (page == 1) {
                    prevPageFullPath.append(pathSuffix);
                } else {
                ...
                fullPath.append(URL_SEPARATOR).append(optionService.getCategoriesPrefix()).append(URL_SEPARATOR).append(categorySlug);
                fullPath.append("/page/");
                for (int current : rainbow) {
                    RainbowPage rainbowPage = new RainbowPage();
                    rainbowPage.setPage(current);
                ...
                break;
            case "photos":
                nextPageFullPath.append(URL_SEPARATOR).append(optionService.getPhotosPrefix());
                prevPageFullPath.append(URL_SEPARATOR).append(optionService.getPhotosPrefix());
                nextPageFullPath.append("/page/").append(page + 2).append(pathSuffix);
                if (page == 1) {
                    prevPageFullPath.append(pathSuffix);
                } else {
                ...
                fullPath.append(URL_SEPARATOR).append(optionService.getPhotosPrefix());
                fullPath.append("/page/");
                for (int current : rainbow) {
                    RainbowPage rainbowPage = new RainbowPage();
                    rainbowPage.setPage(current);
                ...
                break;
            case "journals":
                nextPageFullPath.append(URL_SEPARATOR).append(optionService.getJournalsPrefix());
                prevPageFullPath.append(URL_SEPARATOR).append(optionService.getJournalsPrefix());
                nextPageFullPath.append("/page/").append(page + 2).append(pathSuffix);
                if (page == 1) {
                    prevPageFullPath.append(pathSuffix);
                } else {
                ...
                fullPath.append(URL_SEPARATOR).append(optionService.getJournalsPrefix());
                fullPath.append("/page/");
                for (int current : rainbow) {
                    RainbowPage rainbowPage = new RainbowPage();
                    rainbowPage.setPage(current);
