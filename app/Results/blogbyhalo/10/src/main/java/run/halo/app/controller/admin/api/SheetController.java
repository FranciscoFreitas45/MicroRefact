...
import run.halo.app.DTO.SheetParam;
@RestController
...
public SheetController(SheetService sheetService, AbstractStringCacheStore cacheStore, OptionService optionService) {
...
public String preview(Integer sheetId){
...
public SheetDetailVO createBy(SheetParam sheetParam,Boolean autoSave){
...
public SheetDetailVO updateBy(Integer sheetId,SheetParam sheetParam,Boolean autoSave){
...
@ApiOperation("Updates a sheet")
public void updateStatusBy(Integer sheetId,PostStatus status){
    Sheet sheet = sheetService.getById(sheetId);
    // Set status
...
public SheetDetailVO getBy(Integer sheetId){
    Sheet sheet = sheetService.getById(sheetId);
    return sheetService.convertToDetailVo(sheet);
}
...
public SheetDetailVO deleteBy(Integer sheetId){
...
public BasePostDetailDTO updateDraftBy(Integer sheetId,PostContentParam contentParam){
