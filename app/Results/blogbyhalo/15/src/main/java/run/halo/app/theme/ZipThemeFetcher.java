package run.halo.app.theme;
 import run.halo.app.utils.FileUtils.unzip;
...
public ZipThemeFetcher() {
    this.httpClient = HttpClient.newBuilder().followRedirects(HttpClient.Redirect.ALWAYS).connectTimeout(Duration.ofMinutes(5)).build();
}
@Override
