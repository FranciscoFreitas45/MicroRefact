...
public class DefaultErrorViewResolver implements ErrorViewResolver{
 ...
 private  Map<Series,String> SERIES_VIEWS;
...
public ModelAndView resolve(String viewName,Map<String,Object> model){
    var errorViewName = this.themeService.render(viewName);
    var provider = this.templateAvailabilityProviders.getProvider(errorViewName, this.applicationContext);
    if (provider != null) {
