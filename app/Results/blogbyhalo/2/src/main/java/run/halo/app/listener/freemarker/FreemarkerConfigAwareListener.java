package run.halo.app.listener.freemarker;
 import run.halo.app.model.support.HaloConst.OPTIONS_CACHE_KEY;
...
public FreemarkerConfigAwareListener(OptionService optionService, Configuration configuration, ThemeService themeService, ThemeSettingService themeSettingService, UserService userService, AbstractStringCacheStore cacheStore) throws TemplateModelException {
