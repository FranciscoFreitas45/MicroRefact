...
public List<CategoryWithPostCountDTO> listCategoryWithPostCountDto(Sort sort,boolean queryEncryptCategory){
    ...
    return categories.stream().map(category -> {
        ...
        fullPath.append(URL_SEPARATOR).append(optionService.getCategoriesPrefix()).append(URL_SEPARATOR).append(category.getSlug()).append(optionService.getPathSuffix());
