...
public String saveApply(ApplyOutPut applyOutPut,BindingResult bindingResult,HttpServletRequest request,ModelMap modelMap){
...
public String getNotAllowed(ApplyOutPut applyOutPut,int pagenum,ModelMap modelMap,HttpServletRequest request){
...
public String ensureApply(int id,HttpServletRequest request,ModelMap modelMap,HttpSession session){
...
public String doSearch(ApplyOutPut outPut,ModelMap modelMap,HttpServletRequest request,Integer pagenum){
