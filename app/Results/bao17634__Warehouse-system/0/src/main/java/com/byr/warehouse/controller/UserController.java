package com.byr.warehouse.controller;
 import com.byr.warehouse.Service.IndexService;
import com.byr.warehouse.Service.LogService;
import com.byr.warehouse.dao;
...
import com.byr.warehouse.util.EncrypeUtil;
...
@Autowired
 private DaliyComputeShedule reportShedule;
...
public String upPwd(String oldPassword,String newPassword,String rePassword,ModelMap modelMap,HttpSession session){
...
public String UserLogin(User user,ModelMap modelMap,HttpServletRequest request){
    String page = "index";
    int size = 0;
    List<User> userList = userRepository.findUserByusername(user.getUsername());
    if (// 此用户不存在
