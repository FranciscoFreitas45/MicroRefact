...
public EntrepotStatus copyEntrepot(EntrepotStatus status){
...
public String changeStatus(Long id,int goodProducts,int badProducts,String goodPosition,String badPosition){
